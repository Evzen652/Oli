...
const POOL: Array<{ question: string; correct: string; hint: string; level: number }> = [
  ...
  { question: "4 + 4 + 4 = 4 × ?", correct: "3", hint: "Spočítej čtyřky v příkladu: 4 + 4 + 4 — kolik jich je?", level: 1 },
  { question: "6 + 6 + 6 + 6 = 6 × ?", correct: "4", hint: "Spočítej šestky v příkladu: 6 + 6 + 6 + 6 — kolik jich je?", level: 1 },
  { question: "10 + 10 = 10 × ?", correct: "2", hint: "Spočítej desítky v příkladu: 10 + 10 — kolik jich je?", level: 1 },
  { question: "7 + 7 + 7 = 7 × ?", correct: "3", hint: "Spočítej sedmičky v příkladu: 7 + 7 + 7 — kolik jich je?", level: 1 },
  ...
  { question: "6 × 2 = ?", correct: "12", hint: "Vynásobit 2 = přičti číslo k sobě: 6 + 6 = ?", level: 2 },
  { question: "2 × 4 = ?", correct: "8", hint: "Vynásobit 2 = přičti číslo k sobě: 4 + 4 = ?", level: 2 },
  { question: "7 × 2 = ?", correct: "14", hint: "Vynásobit 2 = přičti číslo k sobě: 7 + 7 = ?", level: 2 },
  ...
  { question: "Kolik je 2 × 9?", correct: "18", hint: "Vynásobit 2 = přičti číslo k sobě: 9 + 9 = ?", level: 3 },
  { question: "Kolik je 6 × 3?", correct: "18", hint: "6 + 6 + 6 = ?", level: 3 },
  { question: "Kolik je 5 × 5?", correct: "25", hint: "5 + 5 + 5 + 5 + 5 = ?", level: 3 },
  { question: "Kolik je 7 × 3?", correct: "21", hint: "7 + 7 + 7 = ?", level: 3 },
  { question: "Kolik je 4 × 5?", correct: "20", hint: "4 + 4 + 4 + 4 + 4 = ?", level: 3 },
];
