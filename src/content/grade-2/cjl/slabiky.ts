...
const POOL_L3: PoolItem[] = [
  ...
  { question: "Kde slovo 'sluníčko' rozdělíme na slabiky?", correct: "slu-níč-ko", distractors: ["s-lu-níčko", "slun-íč-ko"], emoji: "☀️", hint: "Hledej samohlásky U, Í, O — kde udělat předěly?", solution: "Slovo 'sluníčko' se dělí na 'slu-níč-ko' — souhláska před samohláskou patří k další slabice (samohlásky U, Í, O tvoří tři slabiky)." },
