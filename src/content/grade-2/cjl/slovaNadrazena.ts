...
const POOL: PoolItem[] = [
  ...
  // Identifikace nadřazeného slova (hypernyma)
  ...
  { question: "Jaké je nadřazené slovo pro 'léto', 'zima', 'jaro'?", correct: "Roční období", distractors: ["Měsíc", "Den"], emoji: "🌸", hint: "Co mají léto, zima a jaro společného — pod jakou skupinu patří?", solution: "Nadřazené slovo pro 'léto', 'zima' a 'jaro' je 'roční období' — jsou to roční období." },
  { question: "Jaké je nadřazené slovo pro 'leden', 'únor', 'březen'?", correct: "Měsíc", distractors: ["Den v týdnu", "Hodina"], emoji: "📆", hint: "Co mají leden, únor a březen společného — pod jakou skupinu patří?", solution: "Nadřazené slovo pro 'leden', 'únor' a 'březen' je 'měsíc' — jsou to měsíce v roce." },
  // Identifikace podřazeného slova (hyponima)
  ...
  { question: "Co je podřazené slovo ke slovu 'zvíře'?", correct: "pes", distractors: ["domácí mazlíček (obecně)", "živočich"], emoji: "🐕", hint: "Podřazené slovo je konkrétnější — je to konkrétní druh zvířete.", solution: "Podřazené slovo ke 'zvíře' je 'pes' — pes je konkrétní druh zvířete a patří pod skupinu 'zvíře'." },
];
