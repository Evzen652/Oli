...
const POOL: PoolItem[] = [
  ...
  { question: "Které slovo znamená podobně jako 'dívka'?", correct: "holka", distractors: ["chlapec", "žena"], emoji: "👧", hint: "Dívku v třídě nazýváme dvěma slovy — jedno formální, druhé hovorové.", solution: "'Dívka' a 'holka' jsou souznačná slova (synonyma) — znamenají totéž, jen jedno je formálnější." },
  ...
  { question: "Které slovo znamená podobně jako 'auto'?", correct: "vůz", distractors: ["vlak", "kolo"], emoji: "🚗", hint: "Auto máme v garáži — jiné, trochu starší slovo pro auto je...", solution: "'Auto' a 'vůz' jsou souznačná slova (synonyma) — označují totéž dopravní prostředky." },
