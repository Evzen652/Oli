...
const POOL_L1: PoolItem[] = [
  { question: "Kdo napsal nebo vymyslel příběh v knize?", correct: "Spisovatel nebo autor", distractors: ["Ilustrátor, který maluje", "Knihovník v knihovně"], emoji: "✍️", hint: "Někdo příběh vymyslel a napsal — kdo je zodpovědný za text v knize?", solution: "Příběh v knize napsal spisovatel (nebo autor) — je to člověk, který text vymyslel a zapsal." },
  ...
  { question: "Jak nazýváme ženu, která píše knihy?", correct: "Autorka nebo spisovatelka", distractors: ["Ilustrátorka, která kreslí", "Čtenářka, která knihy čte"], emoji: "✍️", hint: "Žena, která vymýšlí a píše příběhy do knih — jak se jí říká?", solution: "Žena, která píše knihy, je autorka nebo spisovatelka — ona příběh vymyslela a zapsala." },
  { question: "Jak se nazývá člověk, který pracuje v knihovně?", correct: "Knihovník nebo knihovnice", distractors: ["Spisovatel, který píše", "Ilustrátor, který maluje"], emoji: "🏛️", hint: "V knihovně nám pomáhá zaměstnanec — jak se mu říká?", solution: "Člověk, který pracuje v knihovně, je knihovník nebo knihovnice — pomáhá nám najít knihy a půjčit si je." },
...
const POOL_L2: PoolItem[] = [
  ...
  { question: "Kde v knize najdeme jméno autora?", correct: "Na titulní straně nebo obálce", distractors: ["Na záložce", "Na zadní straně"], emoji: "📖", hint: "Jméno autora je spolu s názvem díla hned na začátku knihy — zkus se podívat na dvou různých místech vepředu.", solution: "Jméno autora najdeme na titulní straně nebo obálce — je tam spolu s názvem díla." },
  ...
  { question: "Co je kapitola v knize?", correct: "Část příběhu nebo textu s názvem", distractors: ["Jméno autora na obálce", "Obrázek nakreslený v knize"], emoji: "📑", hint: "Dlouhý příběh je rozdělený do menších celků — jak se jim říká?", solution: "Kapitola je část příběhu nebo textu s názvem — dlouhé knihy jsou rozděleny do kapitol, aby se lépe četly." },
  { question: "Proč knize nevytrháváme stránky?", correct: "Abychom ji nepoškodili pro další čtenáře", distractors: ["Protože je kniha těžká na nošení", "Protože jsou stránky mokré"], emoji: "📚", hint: "Knihy si půjčujeme — po nás si ji půjčí jiní. Co je proto správné?", solution: "Stránky nevytrháváme, abychom knihu nepoškodili — po nás si ji půjčí další čtenáři a potřebují ji celou." },
...
const POOL_L3: PoolItem[] = [
  ...
  { question: "Co je encyklopedie?", correct: "Kniha, která vysvětluje různá témata a fakta", distractors: ["Sbírka kouzelných pohádek", "Sbírka krásných veršovaných básní"], emoji: "📕", hint: "Encyklopedie je tlustá kniha — hledáme v ní odpovědi na otázky o světě, přírodě nebo historii.", solution: "Encyklopedie je kniha, která vysvětluje různá témata a fakta — hledáme v ní informace o světě, přírodě nebo historii." },
