...
const POOL: TrueFalseItem[] = [
  ...
  { question: "Na jaře raší listí. Je to pravda?", correct: true, emoji: "🌱", hint: "Stromy jsou v zimě holé — co se stane, když se na jaře oteplí?", solution: "Ano! Stromy jsou přes zimu holé. Když se na jaře oteplí, ze špičky větví vyrůstají malé pupenky a z nich se rozvinují listy." },
