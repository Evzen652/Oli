...
const POOL: { q: string; a: string; opts: string[]; e: string }[] = [
  ...
  { q: "Jaký je rozdíl mezi reprodukcí a opisem?", a: "Reprodukce = vlastními slovy, opis = doslova stejně", opts: ["Žádný rozdíl, jsou to synonyma", "Reprodukce = vlastními slovy, opis = doslova stejně", "Opis je vždycky mnohem kratší", "Reprodukce se dělá vždy doslova"], e: "Při opisu přepisuješ text přesně tak, jak je napsán. Při reprodukci ho vyprávíš svými vlastními slovy — to je mnohem důležitější dovednost, protože ukáže, zda jsi textu rozuměl." },
  { q: "Po přečtení textu si nejdříve odpovíme na otázky:", a: "Kdo? Co se stalo? Kde? Kdy? Jak to dopadlo?", opts: ["Jak dlouhý je text celkem?", "Kdo? Co se stalo? Kde? Kdy? Jak to dopadlo?", "Kolik slov má text dohromady?", "Kdo přesně text napsal a kdy?"], e: "Otázky Kdo? Co? Kde? Kdy? Jak to dopadlo? nám pomůžou zachytit všechny důležité části příběhu. Délka textu ani jméno autora nám k převyprávění nepomůžou." },
];
