...
const POOL: { q: string; a: string; opts: string[]; e: string }[] = [
  // B
  { q: "Doplň: 'Na farmě žil velký b_k.'", a: "byk", opts: ["byk", "bik", "býk", "bik"], e: "'Byk' je vyjmenované slovo po B, proto píšeme Y. Byk je samec krávy — pamatuj si ho jako zvíře ze seznamu vyjmenovaných slov." },
  ...
  { q: "Které slovo PATŘÍ mezi vyjmenovaná po B?", a: "kobyla", opts: ["kobyla", "kabela", "kabel", "kabát"], e: "'Kobyla' je příbuzné k vyjmenovanému slovu 'kobyla', které je přímo v seznamu vyjmenovaných slov po B. Ostatní slova (kabela, kabel, kabát) vyjmenovaná nejsou." },
  { q: "Doplň: 'Kůň nebo kobyla? Kobyla je samice a b_k je samec.'", a: "byk", opts: ["byk", "bik", "buc", "buc"], e: "'Byk' je vyjmenované slovo po B — samec krávy nebo bizon. Proto píšeme Y, ne I." },
  // L
  ...
  { q: "Doplň: 'Na obloze se bl_skalo.'", a: "blýskalo", opts: ["blýskalo", "bliskalo", "blyskalo", "bliskalo"], e: "'Blýskat' je příbuzné k vyjmenovanému slovu 'blýskat se' po L, proto píšeme Ý. Blýskání je záblesk světla — třeba při bouřce." },
  // M
  ...
  { q: "Které slovo PATŘÍ mezi vyjmenovaná po M?", a: "myslet", opts: ["myslet", "mislet", "mistr", "místy"], e: "'Myslet' je vyjmenované slovo po M — nebo přinejmenším příbuzné slovu 'mysl'. 'Mistr' a 'místy' nejsou vyjmenovaná a píší se s I." },
  { q: "Doplň: 'Celý den jsme se m_lili, kde je cesta.'", a: "mýlili", opts: ["mýlili", "milili", "mylili", "milili"], e: "'Mýlit se' je vyjmenované slovo po M, proto píšeme Ý. Mýlit se znamená dělat chyby nebo se plést." },
  // P
  ...
  { q: "Doplň: 'Brambory jsou v p_tli.'", a: "pytli", opts: ["pytli", "pitli", "pytlí", "pitlí"], e: "'Pytel' je vyjmenované slovo po P, proto píšeme Y. V pytli (= v pytlíku, v pytli) taky píšeme Y, protože jde o stejné slovo." },
  ...
  { q: "Doplň: 'Po obědě byl s_tý.'", a: "sytý", opts: ["sytý", "sitý", "sytí", "sitý"], e: "'Sytý' je vyjmenované slovo po S, proto píšeme Y. Sytý znamená, že jsi najedl a máš plné břicho." },
  ...
  { q: "Doplň: 'S_rový sýr není zralý.'", a: "Syrový", opts: ["Syrový", "Sirový", "Syrovi", "Sirovi"], e: "'Syrový' je příbuzné k vyjmenovanému slovu 'syrový' po S, proto píšeme Y. Syrový znamená čerstvý a nezpracovaný — jako syrové mléko." },
  // V
  ...
  { q: "Doplň: 'Má špatný zv_k vstávat pozdě.'", a: "zvyk", opts: ["zvyk", "zvik", "zvík", "zvik"], e: "'Zvyk' je příbuzné k vyjmenovanému slovu 'zvyknout' po V, proto píšeme Y. Zvyk je něco, co děláme pravidelně a automaticky." },
  ...
  { q: "Které slovo PATŘÍ mezi vyjmenovaná po Z?", a: "nazývat", opts: ["nazývat", "nazívat", "nazvat", "naziivat"], e: "'Nazývat' je příbuzné k vyjmenovanému slovu 'název' nebo 'zvát' po Z, proto píšeme Ý. Nazývat něco znamená pojmenovat to." },
];
