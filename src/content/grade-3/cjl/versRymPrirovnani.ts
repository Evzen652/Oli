...
const POOL: { q: string; a: string; opts: string[]; e: string }[] = [
  ...
  { q: "Doplň přirovnání: 'Silný jako ___'", a: "medvěd / byk / lev", opts: ["medvěd / byk / lev", "myška / pero", "voda / vzduch", "žlutý / hezký"], e: "Medvěd, byk a lev jsou zvířata známá svojí velkou silou. Myška ani pero silná nejsou a 'žlutý' nebo 'hezký' vůbec nejsou zvířata ani věci." },
  ...
  { q: "Co se rýmuje se slovem 'zima'?", a: "prima / lima / klima", opts: ["prima", "jaro", "teplo", "déšť"], e: "'Zima' a 'prima' obě končí na '-ima', takže se rýmují. Jaro, teplo ani déšť takové zakončení nemají — nezní podobně jako 'zima'." },
  ...
  { q: "Najdi rým: 'Skákal pes přes oves, přes zelenou ___'", a: "louku (rým: oves – louku nepasuje, správně: oves–oves nebo les–ves)", opts: ["louku", "trávu", "zahradu", "cestu"], e: "V této říkance se původně rýmuje 'oves' s dalším slovem zakončeným podobně. Slovo 'louka' se v básničce tradičně doplňuje, i když rým není dokonalý — jde o lidovou říkanku." },
  { q: "Přirovnání: 'Tichý jako ___'", a: "myška / voda v rybníce", opts: ["myška", "pes", "vítr", "hrom"], e: "Myška je známá tím, že se pohybuje velmi tiše a skoro ji není slyšet. Proto říkáme 'tichý jako myška'. Pes, vítr ani hrom nejsou tiché věci." },
  { q: "Co se rýmuje: máma – ___?", a: "táta / dáma / láma", opts: ["táta / dáma", "bratr", "sestra", "dítě"], e: "'Máma' a 'dáma' obě končí na '-áma', takže se rýmují. Bratr, sestra ani dítě nemají zakončení podobné slovu 'máma'." },
