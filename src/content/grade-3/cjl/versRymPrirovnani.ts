...
const POOL_L2: Uloha[] = [
  ...
  {
    q: "Které slovo se rýmuje se slovem „kámen“?",
    a: "plamen",
    w: [
      ["skála", "„Skála“ je kameni blízká významem, ale její konec zní jinak."],
      ["kamínek", "„Kamínek“ je zdrobnělina zadaného slova, končí ale jinak."],
      ["kamna", "„Kamna“ mají skoro stejný začátek, konec slova jim ale vychází jinak."],
    ],
    h: [
      "Dvě možnosti se od zadaného slova odvozují a jedna je mu blízká významem. Rozhoduj podle konce.",
    ...
    e: "Obě slova končí na -amen, takže si jejich konce přesně odpovídají. Zdrobnělina ani příbuzné slovo rým netvoří.",
  },
  {
...
const POOL_L3: Uloha[] = [
  ...
  },
  {
    ...
    a: "kameny",
    w: [
      ["plamen", "„Plamen“ končí na -amen stejně jako dvě další slova, do skupiny tedy patří."],
      ["pramen", "„Pramen“ končí na -amen stejně jako dvě další slova, takže do skupiny patří."],
      ["kámen", "„Kámen“ končí na -amen stejně jako dvě další slova, takže do skupiny patří."],
    ],
    h: [
      "Jedno ze slov je množné číslo a přibylo mu na konci zakončení navíc. Zkontroluj poslední slabiky.",
    ...
    e: "Tři slova končí na -amen a rýmují se. Jedno z nich je v množném čísle, takže má na konci slabiku navíc a shodný konec mu chybí.",
  },
  {
    q: "Doplň slovo tak, aby se rýmovalo a zároveň dávalo smysl: „V krbu hoří jasný plamen, / na stole leží těžký ___.“",
    a: "kámen",
    w: [
      ["pramen", "„Pramen“ se sice rýmuje, jenže pramen na stole ležet nemůže — chybí mu smysl."],
      ["balvan", "„Balvan“ by na stole těžký být mohl, jenže se s prvním veršem nerýmuje."],
      ["papír", "„Papír“ se nerýmuje a navíc není těžký, takže neplatí ani jedna podmínka."],
    ],
    h: [
    ...
    e: "Rým i smysl musí platit zároveň. Slovo se rýmuje s koncem prvního verše a zároveň dává smysl, protože takhle těžká věc na stole opravdu ležet může.",
  },
  {
