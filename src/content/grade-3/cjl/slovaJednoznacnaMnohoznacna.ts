...
const POOL_L3_EXTRA: QA[] = [
  ...
  { q: "Co znamená přenesený výraz 'mít páky' na někoho?", a: "mít prostředky, jak něco ovlivnit nebo někoho přimět", opts: ["mít prostředky, jak něco ovlivnit nebo někoho přimět", "mít v rukou dřevěné páky", "být silný ve sportu", "mít nářadí"], e: "'Mít páky' je obrazný výraz — znamená mít prostředky, kterými můžeš něco ovlivnit. Není to o skutečných pákách." },
