...
const POOL: QA[] = [
  ...
  { q: "Co je příklad mnohoznačného slova s významem 'část obličeje' i 'nos lodi'?", a: "nos", opts: ["nos", "oko", "ústa", "hlava"], e: "Slovo 'nos' může znamenat část obličeje (čicháme jím) i přední část lodi. Přední část lodě vypadá trochu jako nos, a tak jsme ji pojmenovali stejně — to je typické pro mnohoznačná slova." },
