...
const POOL: { q: string; a: string; opts: string[]; e: string }[] = [
  ...
  { q: "Co patří k úpravě textu?", a: "Okraje, odstavce a nadpis", opts: ["Jen délka celého textu", "Okraje, odstavce a nadpis", "Jen barva inkoustu", "Jen velikost písma"], e: "Úprava textu zahrnuje více věcí najednou — nadpis nám řekne, o čem text je, okraje dělají text přehledným, odstavce oddělují myšlenky a mezery oddělují slova od sebe." },
  { q: "Kdy děláme nový odstavec?", a: "Když začínáme novou myšlenku", opts: ["Po každé jedné větě", "Když začínáme novou myšlenku", "Nikdy, píšeme v kuse", "Po každém jednom slově"], e: "Odstavec je jako 'skupinka' vět, které patří k sobě. Když chceme říct něco nového a jiného, začneme nový odstavec, aby čtenář věděl, že téma se mění." },
  ...
  { q: "Jak ukončujeme větu?", a: "Tečkou nebo otazníkem", opts: ["Čárkou uprostřed", "Tečkou nebo otazníkem", "Středníkem", "Ničím, jen mezerou"], e: "Tečka, otazník nebo vykřičník jsou 'stop značky' — říkají čtenáři, že věta skončila. Otazník píšeme, když se ptáme, vykřičník, když chceme zdůraznit, a tečku ve všech ostatních větách." },
  { q: "Jaký okraj necháváme při psaní?", a: "Zleva i zprava", opts: ["Jen zprava", "Zleva i zprava", "Žádný okraj", "Jen nahoře"], e: "Okraje jsou prázdné místo kolem textu, které text 'orámují'. Díky nim text nevypadá zmačkaně a učitel tam také může psát poznámky nebo opravy." },
  ...
  { q: "Jak opravíme chybné slovo v textu?", a: "Přeškrtneme a napíšeme znovu", opts: ["Celou stránku přepíšeme", "Přeškrtneme a napíšeme znovu", "Necháme to tak, jak je", "Zamažeme to celé propiskou"], e: "Jedna čára přes chybné slovo je správný způsob opravy — chyba zůstane čitelná (učitel vidí, co tam bylo) a správné slovo je hned vedle. Přepisovat celou stránku kvůli jedné chybě by bylo zbytečné a zdlouhavé." },
];
...
function gen(level: number): PracticeTask[] {
  return shuffle(POOL).slice(0, 16).map(({ q, a, opts, e }) => ({
    ...
    hints: ["Zeptej se, jestli se v takovém textu čtenář snadno vyzná.", "Nejde jen o jednotlivá písmena — všímej si i toho, jak je celá stránka rozvržená: co je nahoře, kde se text láme na nový úsek a kolik volného místa zbývá po stranách."],
    explanation: e,
  }));
}
