...
const POOL: { q: string; a: string; opts: string[]; e: string }[] = [
  ...
  { q: "Vyber správnou spojku: '___ přijde tatínek, půjdeme na výlet.'", a: "Když", opts: ["Když", "Ale", "Nebo", "Proto"], e: "Spojka 'když' vyjadřuje podmínku nebo čas — výlet se stane tehdy, jestliže přijde tatínek. Říká nám, za jaké situace se něco stane." },
