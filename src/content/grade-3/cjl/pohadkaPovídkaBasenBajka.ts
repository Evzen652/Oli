...
const POOL_L1: QA[] = [
  ...
  { q: "Jak typicky začíná pohádka?", a: "Bylo nebylo... / Za sedmero horami...", opts: ["Bylo nebylo... / Za sedmero horami...", "Jednoho večera jsem šel domů...", "Dnes ráno...", "V přírodě žijí..."], e: "Pohádky začínají zvláštními frázemi jako 'Bylo nebylo' nebo 'Za sedmero horami', které nám hned říkají: tohle je vymyšlený příběh z dávných časů." },
...
const POOL_L2: QA[] = [
  ...
  { q: "Čím se liší pohádka od povídky?", a: "Pohádka má nadpřirozené bytosti, povídka je ze skutečného života", opts: ["Pohádka má nadpřirozené bytosti, povídka je ze skutečného života", "Pohádka je kratší", "Povídka má rýmy", "Žádný rozdíl"], e: "Rozdíl je v tom, jestli se příběh mohl opravdu stát. V pohádce jsou kouzelné předměty, víly, draci. V povídce se děje jen to, co je reálně možné." },
  ...
  { q: "Jaký literární žánr je 'Červená Karkulka'?", a: "Pohádka", opts: ["Pohádka", "Bajka", "Povídka", "Báseň"], e: "Červená Karkulka je pohádka — mluvící vlk, který předstírá, že je babička, je typický nadpřirozený pohádkový prvek." },
...
const POOL_L3: QA[] = [
  ...
  { q: "Kniha vypráví o skutečné rodině, která se stěhuje do nového města — bez kouzel, beze zvířat, co mluví. Jaký žánr?", a: "Povídka", opts: ["Povídka", "Pohádka", "Bajka", "Báseň"], e: "Stěhování rodiny bez kouzel a mluvících zvířat je reálná situace — takový příběh patří mezi povídky." },
