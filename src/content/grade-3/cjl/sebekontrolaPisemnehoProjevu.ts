...
const POOL: { q: string; a: string; opts: string[]; e: string }[] = [
  { q: "Co kontrolujeme při sebekontrole písemného projevu?", a: "Pravopis, obsah, srozumitelnost a úpravu", opts: ["Jen velká písmena na začátku vět", "Pravopis, obsah, srozumitelnost a úpravu", "Jen interpunkci, tečky a čárky", "Jen délku textu, ne jeho obsah"], e: "Při sebekontrole si musíme všímat všeho — jestli jsou slova správně napsaná, jestli text dává smysl, jestli ho druhý pochopí, a také jestli je hezky upravený. Kontrola jen jedné věci nestačí." },
  ...
  { q: "Co uděláš, když najdeš chybu ve svém textu?", a: "Opravím ji — přeškrtnu a napíšu správně", opts: ["Smažu celou stránku a napíšu ji znovu", "Opravím ji — přeškrtnu a napíšu správně", "Nechám ji tak, jak je, a jedu dál", "Požádám kamaráda, ať to opraví za mě"], e: "Chybu přeškrtneme jednou rovnou čarou a nad ni (nebo vedle) napíšeme správné slovo. Mazání celé stránky by bylo zbytečná práce, a nechávat chyby by text zhoršilo." },
  ...
  { q: "Na co se zaměřím při kontrole vlastního textu?", a: "Velká písmena, interpunkce, pravopis slov", opts: ["Jen na téma textu, ne na chyby", "Velká písmena, interpunkce, pravopis slov", "Jen na délku jednotlivých vět", "Jen na celkový počet slov v textu"], e: "Při kontrole si hlídáme tři hlavní věci: velká písmena na začátku vět a u jmen, správné tečky a čárky (interpunkce) a správný pravopis slov. Počet slov ani délka vět nám chyby neodhalí." },
  ...
  { q: "Co znamená 'číst text nahlas'?", a: "Pomáhá odhalit chyby, které přehlédneme při tichém čtení", opts: ["Je to úplně zbytečné, chyby to neodhalí", "Pomáhá odhalit chyby, které přehlédneme při tichém čtení", "Je to užitečné jen pro malé děti, ne pro nás", "Pomáhá jen zlepšit výslovnost, chyby ne"], e: "Když čteme nahlas, ucho zachytí to, co oko přeskočilo — třeba chybějící slovo nebo divně znějící větu. Je to skvělý trik, který pomáhá i dospělým." },
