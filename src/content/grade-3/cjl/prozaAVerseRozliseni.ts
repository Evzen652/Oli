...
const POOL_L1: QA[] = [
  ...
  { q: "Báseň se skládá z:", a: "veršů (řádků), které tvoří strofy", opts: ["veršů (řádků), které tvoří strofy", "vět a odstavců", "dialogů", "kapitol"], e: "Báseň je poskládaná z veršů, tedy krátkých řádků, a skupiny veršů tvoří strofy. Věty a odstavce patří naopak k próze." },
  { q: "Próza se skládá z:", a: "vět, které tvoří odstavce", opts: ["vět, které tvoří odstavce", "veršů a rýmů", "strof", "jen nadpisů"], e: "Próza je poskládaná z vět, které se seskupují do odstavců. Verše, rýmy a strofy patří k básním, ne k próze." },
];
...
const POOL_L2: QA[] = [
  ...
  { q: "Ukázka: 'Šel jsem lesem, potkal jsem lišku. Utekla mi rychle pryč.' Je to:", a: "Próza (souvislé věty)", opts: ["Próza (souvislé věty)", "Báseň", "Verš", "Strofa"], e: "Věty jdou souvisle za sebou a nemají rým ani krátké verše — to jsou znaky prózy." },
  { q: "Ukázka: 'Slunce svítí, ptáci pějí, / celý den se s námi smějí.' Je to:", a: "Báseň (verše, rým: pějí/smějí)", opts: ["Báseň (verše, rým: pějí/smějí)", "Próza", "Popis", "Dopis"], e: "Text má krátké řádky a slova 'pějí' a 'smějí' se rýmují (obě končí na '-ějí') — to jsou verše, tedy báseň." },
];
...
const POOL_L3: QA[] = [
  ...
  { q: "Porovnej: A) 'V lese roste starý strom, vedle stojí malý dům.' (jedna souvislá věta) B) 'V lese roste starý strom, / vedle stojí malý dům.' (dva krátké verše s rýmem). Co platí?", a: "B je báseň (krátké verše, rým), A je próza (souvislá věta)", opts: ["B je báseň (krátké verše, rým), A je próza (souvislá věta)", "Oba texty jsou próza", "Oba texty jsou báseň", "A je báseň, B je próza"], e: "Stejný obsah lze napsat jako souvislou větu (próza) nebo rozdělit na krátké rýmované verše (báseň) — rozhoduje zápis a rým, ne obsah." },
  { q: "Proč je pohádka próza, i když v ní může být řeč postav (dialog)?", a: "Protože je psaná v souvislých větách a odstavcích, ne v rýmovaných verších", opts: ["Protože je psaná v souvislých větách a odstavcích, ne v rýmovaných verších", "Protože dialog je vždy báseň", "Protože pohádky nemají postavy", "Protože pohádky nejsou psané"], e: "Přítomnost dialogu (přímé řeči) sama o sobě žánr nemění — pohádka zůstává prózou, protože je zapsaná ve větách a odstavcích, ne v rýmovaných krátkých verších." },
