...
const POOL: { q: string; a: string; opts: string[] }[] = [
  ...
  { q: "Jak zapisujeme přímou řeč?", a: "Do uvozovek: „Co děláš?" zeptal se Pavel.", opts: ["Do uvozovek: „Co děláš?" zeptal se Pavel.", "Bez uvozovek, prostě do textu", "Do závorek", "Kurzívou bez uvozovek"] },
  ...
  { q: "Věta: „Pojď si hrát!" řekla Anička. — Kde jsou uvozovky?", a: "Kolem přímé řeči: „Pojď si hrát!"", opts: ["Kolem přímé řeči: „Pojď si hrát!"", "Kolem jména Anička", "Kolem slova řekla", "Nejsou potřeba"] },
...
export const DIALOGPRAVIDLA: TopicMetadata[] = [
  {
    ...
    generator: gen,
    helpTemplate: {
      hint: "Dialog: neskáčeme do řeči, nasloucháme, zdravíme. Přímá řeč: „slova" + kdo řekl.",
      steps: ["Pozdrav.", "Neskáčeme do řeči.", "Přímou řeč dáme do uvozovek „ ".", "Na závěr se rozloučíme."],
      commonMistake: "Zapomenutí uvozovek: 'Pojď! řekla.' → správně: „Pojď!" řekla.",
      example: "„Jak se jmenuješ?" zeptala se učitelka. Tomáš odpověděl: „Jmenuji se Tomáš Novák."",
    },
  },
];
