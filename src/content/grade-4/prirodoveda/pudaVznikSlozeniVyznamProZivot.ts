...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Jaká barva půdy ukazuje na vysoký obsah humusu?", correctAnswer: "Tmavá až černá", options: ["Světle žlutá až béžová", "Tmavá až černá", "Bílá jako vápno", "Červená jako cihla"] },
  { question: "Co jsou minerální částice půdy?", correctAnswer: "Písek, jíl, štěrk a kamínky", options: ["Odumřelé listy a větvičky", "Písek, jíl, štěrk a kamínky", "Kořeny stromů v půdě", "Organismy žijící v půdě"] },
...
const POOL_L2: PracticeTask[] = [
  { question: "Jaké jsou složky půdy?", correctAnswer: "Minerály, humus, voda, vzduch", options: ["Jen písek a hlína dohromady", "Minerály, humus, voda, vzduch", "Jen humus a voda v půdě", "Horniny, voda a vzduch"] },
  { question: "Jak se liší písčitá a jílovitá půda?", correctAnswer: "Písčitá propouští, jílovitá drží", options: ["Jílovitá propouští, písčitá drží", "Písčitá propouští, jílovitá drží", "Liší se jen svou barvou", "Písčitá je úrodnější"] },
  ...
  { question: "Proč má černozem nejlepší vlastnosti pro zemědělství?", correctAnswer: "Obsahuje nejvíce humusu", options: ["Je nejlehčí a dobře se orá", "Obsahuje nejvíce humusu", "Obsahuje nejvíc písku", "Voda jí protéká nejrychleji"] },
  { question: "Co je orná vrstva půdy (humusový horizont)?", correctAnswer: "Svrchní vrstva bohatá na humus", options: ["Vrstva kamenů pod povrchem", "Svrchní vrstva bohatá na humus", "Hlubinná hornina pod půdou", "Spodní vrstva s vodou"] },
  ...
  { question: "Jakou funkci má kořenové vlášení v půdě?", correctAnswer: "Zvětšuje plochu pro příjem vody", options: ["Kotví rostlinu v půdě", "Zvětšuje plochu pro příjem vody", "Dodává kyslík do půdy", "Chrání kořen před škůdci"] },
...
const POOL_L3: PracticeTask[] = [
  ...
  { question: "Jak mohou mikroorganismy v půdě napomáhat výživě rostlin?", correctAnswer: "Rozkládají organiku na minerály", options: ["Přenášejí živiny z listů", "Rozkládají organiku na minerály", "Vyrábějí glukózu pro kořeny", "Chrání kořeny před škůdci"] },
  { question: "Co je mykorhiza a jak prospívá rostlinám?", correctAnswer: "Soužití houby s kořeny rostliny", options: ["Houba poškozující kořeny", "Soužití houby s kořeny rostliny", "Zvláštní půdní horizont", "Ochranná vrstva proti suchu"] },
  ...
  { question: "Jaký je rozdíl mezi organickým a minerálním hnojením půdy?", correctAnswer: "Organické zlepší půdu, minerální rychle živí", options: ["Minerální zlepší půdu, organické rychle živí", "Organické zlepší půdu, minerální rychle živí", "Jen minerální je ekologické", "Obě metody jsou totožné"] },
  ...
  { question: "Co je bioindikátor kvality půdy?", correctAnswer: "Organismus ukazující stav půdy", options: ["Chemický test pH půdy", "Organismus ukazující stav půdy", "Měřicí přístroj vlhkosti", "Rostlina rostoucí na kamení"] },
