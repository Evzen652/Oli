...
const POOL_L2: PracticeTask[] = [
  ...
  { question: "Jak se liší NP od CHKO?", correctAnswer: "NP: přísněji chráněn, minimum lidského zasahování. CHKO: kulturní krajina s ochranou, zemědělství povoleno.", options: ["CHKO je prý ve všech ohledech chráněna přísněji než NP", "NP: přísněji chráněn, minimum lidského zasahování. CHKO: kulturní krajina s ochranou, zemědělství povoleno.", "V NP prý může být zemědělství, v CHKO to naopak nikdy nejde", "NP a CHKO jsou ve skutečnosti totéž, liší se jen velikostí"] },
  ...
  { question: "Co je rak říční a proč je ohrožen?", correctAnswer: "Původní rak v ČR — ohrožen rakovým morem a vytlačením americkým rakem – invazivní druh", options: ["Invazivní druh raka pocházející z Asie, šířící se v ČR", "Původní rak v ČR — ohrožen rakovým morem a vytlačením americkým rakem – invazivní druh", "Druh ryby žijící výhradně v horských tocích", "Ohrožen prý pouze znečištěním vody v tocích"] },
