...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Co musíš jako první říct při tísňovém volání?", correctAnswer: "KDE se to stalo — přesná adresa nebo popis místa", options: ["Nejdřív řekneš své celé jméno", "KDE se to stalo — přesná adresa nebo popis místa", "Nejdřív řekneš, kolik je ti přesně let", "Nejdřív řekneš, co přesně potřebuješ"] },
  ...
  { question: "Co uděláš při silném krvácení z rány?", correctAnswer: "Přitlačíš tlakovým obvazem — přímý tlak na ránu, zvedneš končetinu", options: ["Osprchujíš celou ránu proudem studené vody", "Přitlačíš tlakovým obvazem — přímý tlak na ránu, zvedneš končetinu", "Necháš krvácení, ať se zastaví úplně samo", "Přiložíš kostku ledu přímo na otevřenou ránu"] },
  ...
  { question: "Co uděláš při dušení (uvíznutí sousta)?", correctAnswer: "Heimlichův manévr — 5 úderů do zad, pak tlak pod hrudník – pro dospělé", options: ["Vléváš postiženému hodně vody přímo do úst", "Heimlichův manévr — 5 úderů do zad, pak tlak pod hrudník – pro dospělé", "Dáš postiženému hned ulehnout na záda a čekáš", "Čekáš potichu, až sousto vyjde úplně samo"] },
];

const POOL_L2: PracticeTask[] = [
  { question: "Co všechno musíš říci dispečerovi při tísňovém volání?", correctAnswer: "KDE – adresa , CO se stalo, KOLIK postižených, jejich STAV, TVOJE jméno a telefon", options: ["Jen kde a co se stalo, nic dalšího už není potřeba", "KDE – adresa , CO se stalo, KOLIK postižených, jejich STAV, TVOJE jméno a telefon", "Jen adresu a jméno, na víc se dispečer neptá", "Jen počet zraněných a telefonní číslo, víc ne"] },
  ...
  { question: "Jak se chovat při výbuchu a požáru v budově?", correctAnswer: "Uniknout nejbližším východem, nepoužívat výtah, zůstat nízko – kouř stoupá nahoru , volat 112/150", options: ["Schovat se do výtahu a tiše čekat, až přijde pomoc", "Uniknout nejbližším východem, nepoužívat výtah, zůstat nízko – kouř stoupá nahoru , volat 112/150", "Otevřít všechna okna a volat o pomoc jen přes okno", "Hasit požár úplně sám, bez volání jakýchkoli záchranářů"] },
  ...
  { question: "Co je primární průzkum (ABCDE) při záchranné akci?", correctAnswer: "A-airway (průchodnost dýchacích cest), B-breathing (dýchání), C-circulation (oběh), D-disability (vědomí), E-exposure – viditelná zranění", options: ["Jen kontrola vědomí postiženého a okamžité zavolání na linku 155, nic víc", "A-airway (průchodnost dýchacích cest), B-breathing (dýchání), C-circulation (oběh), D-disability (vědomí), E-exposure – viditelná zranění", "Kontrola krvácení a zlomenin, kterou provádíme vždy jako úplně první krok", "Primární průzkum smí provádět výhradně vyškolení záchranáři, nikdy laik"] },
];
...
const POOL_L3: PracticeTask[] = [
  ...
  { question: "Co je tourniquet (škrtidlo) a kdy se používá?", correctAnswer: "Páska utažená nad ránou k zastavení tepenného krvácení — použití jen při masivním, jinak nezastavitelném krvácení", options: ["Obvaz určený na drobné rány místo běžného tlakového obvazu", "Páska utažená nad ránou k zastavení tepenného krvácení — použití jen při masivním, jinak nezastavitelném krvácení", "Elastická bandáž, kterou používáme k prevenci otoků po úrazu", "Škrtidlo se nikdy nepoužívá, protože vždy jen způsobuje další poranění"] },
  ...
  { question: "Jak se liší tepenné a žilní krvácení a jak se s každým zachází?", correctAnswer: "Tepenné: jasně červená, rytmické tryskání — škrtidlo + urgentní záchranáři. Žilní: tmavší, rovnoměrné — tlakový obvaz.", options: ["Oba typy krvácení se léčí naprosto identicky — vždy jen tlakový obvaz.", "Tepenné: jasně červená, rytmické tryskání — škrtidlo + urgentní záchranáři. Žilní: tmavší, rovnoměrné — tlakový obvaz.", "Žilní krvácení je prý vždy o dost nebezpečnější než to tepenné.", "Tepenné krvácení se vždy zastaví samo, stačí jen počkat a nezasahovat."] },
  { question: "Co je hypotermie a jak první pomoci?", correctAnswer: "Nebezpečné podchlazení těla — suchým oblečením, horkým nápojem, izotermickou fólií, 155", options: ["Přehřátí neboli úpal — chladíme ho studenou vodou", "Nebezpečné podchlazení těla — suchým oblečením, horkým nápojem, izotermickou fólií, 155", "Jen lehký chlad, který nemá žádné závažné příznaky", "Hypotermie se řeší masáží svalů a pohybem pro zahřátí"] },
