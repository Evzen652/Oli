...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Co jsou kroupy?", correctAnswer: "Kuličky ledu padající z mraků", options: ["Druh hustého deště", "Kuličky ledu padající z mraků", "Zmrzlá hustá mlha", "Jiná forma sněhových vloček"] },
];
...
const POOL_L2: PracticeTask[] = [
  ...
  { question: "Jakou vlastnost má voda jako rozpouštědlo?", correctAnswer: "Rozpouští nejvíc látek v přírodě", options: ["Nerozpouští vůbec nic", "Rozpouští nejvíc látek v přírodě", "Rozpouští jenom sůl", "Rozpouští jenom cukr"] },
  ...
  { question: "Co je mlha?", correctAnswer: "Oblak u zemského povrchu", options: ["Zmrzlá voda na zemi", "Oblak u zemského povrchu", "Vodní pára pod zemí", "Druh velmi jemného deště"] },
  { question: "Co se s vodou stane hned po výparu?", correctAnswer: "Pára stoupá a mění se v oblaka", options: ["Voda hned prší zpátky", "Pára stoupá a mění se v oblaka", "Voda tuhne rovnou na led", "Voda z přírody úplně zmizí"] },
...
const POOL_L3: PracticeTask[] = [
  ...
  { question: "Jak dlouho trvá jeden koloběh vody?", correctAnswer: "Dny až týdny podle počasí", options: ["Přesně dvacet čtyři hodin", "Dny až týdny podle počasí", "Přesně jeden celý rok", "Přesně jednu hodinu"] },
  { question: "Co způsobuje vznik rosy na trávě v noci?", correctAnswer: "Chladný povrch srazí vodní páru", options: ["Drobný déšť padající v noci", "Chladný povrch srazí vodní páru", "Voda vytékající z půdy", "Tání ranního sněhu"] },
  ...
  { question: "Co jsou ledovce a jak přispívají ke koloběhu vody?", correctAnswer: "Zásobárny pevné vody, které tají", options: ["Pevné oblaky ležící na zemi", "Zásobárny pevné vody, které tají", "Voda bez skupenství", "Zásobárny plynu v horách"] },
  { question: "Jaký je rozdíl mezi rosou a jinovatkou?", correctAnswer: "Rosa je z kapek, jinovatka z ledu", options: ["Jinovatka je jen hustší rosa", "Rosa je z kapek, jinovatka z ledu", "Rosa je zimní, jinovatka letní", "Žádný rozdíl, jsou to synonyma"] },
