...
const POOL_L1: PracticeTask[] = [
  { question: "Co je Slunce?", correctAnswer: "Hvězda ve středu soustavy", options: ["Planeta podobná Zemi", "Hvězda ve středu soustavy", "Měsíc obíhající Zemi", "Velký kámen ve vesmíru"] },
  ...
  { question: "Na které planetě žijeme?", correctAnswer: "Země", options: ["Mars", "Země", "Venuše", "Jupiter"] },
  ...
  { question: "Která planeta má prstence?", correctAnswer: "Saturn", options: ["Jupiter", "Saturn", "Mars", "Neptun"] },
  ...
  { question: "Co je fotosyntéza?", correctAnswer: "Výroba cukru ze světla", options: ["Dýchání rostlin kyslíkem", "Výroba cukru ze světla", "Přijímání vody kořeny", "Odpaření vody z listů"] },
...
const POOL_L2: PracticeTask[] = [
  ...
  { question: "Proč je v létě teplo a v zimě zima?", correctAnswer: "V létě dopadají paprsky strměji", options: ["V létě je Země blíže ke Slunci", "V létě dopadají paprsky strměji", "V zimě rotuje Země pomaleji", "V létě je den kratší než v zimě"] },
  { question: "Co je sluneční energie a jak ji lidé využívají?", correctAnswer: "Energie vyzařovaná Sluncem", options: ["Teplo z nitra Země", "Energie vyzařovaná Sluncem", "Energie větru způsobená Sluncem", "Energie z kosmické stanice"] },
  { question: "Co je astronomická jednotka (AU)?", correctAnswer: "Vzdálenost Země od Slunce", options: ["Délka světelného roku", "Vzdálenost Země od Slunce", "Velikost Slunce v kilometrech", "Vzdálenost Měsíce od Země"] },
  ...
  { question: "Co je atmosféra Slunce (korona)?", correctAnswer: "Vnější obal Slunce", options: ["Vrstva vesmíru kolem Slunce", "Vnější obal Slunce", "Vzduchový obal jako u Země", "Magnetické pole Slunce"] },
  { question: "Proč Merkur nemá atmosféru?", correctAnswer: "Je blízko Slunci a málo hmotný", options: ["Je příliš malý na jakoukoli atmosféru", "Je blízko Slunci a málo hmotný", "Merkur atmosféru má, jen ji nevidíme", "Atmosféru nemá žádná planeta"] },
  { question: "Co je letní slunovrat?", correctAnswer: "Nejdelší den v roce", options: ["Nejkratší den v roce", "Nejdelší den v roce", "Den, kdy je Země nejblíže Slunci", "Den, kdy je den a noc stejně dlouhý"] },
  ...
  { question: "Proč je Mars zvaný Rudá planeta?", correctAnswer: "Povrch pokrývá rezavý prach", options: ["Mars září červeně jako hvězda", "Povrch pokrývá rezavý prach", "Atmosféra Marsu je červená", "Mars je pokryt sopečnou lávou"] },
];
...
const POOL_L3: PracticeTask[] = [
  ...
  { question: "Co jsou asteroidy a kde se nacházejí?", correctAnswer: "Skalní tělesa mezi Marsem a Jupiterem", options: ["Malé planety mimo naši soustavu", "Skalní tělesa mezi Marsem a Jupiterem", "Kusy odlomené od Měsíce", "Meteority v atmosféře Země"] },
  ...
  { question: "Jak vznikají zatmění Slunce?", correctAnswer: "Měsíc se dostane mezi Zemi a Slunce", options: ["Země se dostane mezi Slunce a Měsíc", "Měsíc se dostane mezi Zemi a Slunce", "Slunce přejde za Měsícem", "Slunce se zatmí samo"] },
  { question: "Co je sluneční vítr?", correctAnswer: "Proud částic ze Slunce", options: ["Vítr způsobený gravitací Slunce", "Proud částic ze Slunce", "Infračervené záření Slunce", "Pohyb vzduchu na Zemi"] },
  ...
  { question: "Proč planety obíhají Slunce po elipse, ne po kruhu?", correctAnswer: "Působí gravitace a počáteční pohyb", options: ["Slunce planety odpuzuje", "Působí gravitace a počáteční pohyb", "Kruhová dráha je nemožná", "Planety mění dráhu každý rok"] },
