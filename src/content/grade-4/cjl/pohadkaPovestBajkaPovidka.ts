...
const POOL_L2: QA[] = [
  ...
  { q: "Povídka se od románu liší:", a: "Je kratší a soustředí se na jeden příběh nebo moment", opts: ["Je kratší a soustředí se na jeden příběh nebo moment", "Je delší a podrobnější", "Má více postav", "Je vždy pro děti"], e: "Povídka je krátká a vypráví obvykle jeden příběh nebo okamžik, kdežto román je delší a má více dějů a postav. Není to tedy delší útvar a není určená jen dětem.", hints: [
