...
const POOL_L3: QA[] = [
  ...
  { q: "Text: 'Šampionát vyhrálo Japonsko. Zápas trval 90 minut. Diváci byli nadšení.' Kdybys psal krátkou zprávu do novin, kterou informaci bys VYNECHAL jako první?", a: "'Diváci byli nadšení.' (subjektivní dojem, ne klíčové fakty o výsledku)", opts: ["'Diváci byli nadšení.' (subjektivní dojem, ne klíčové fakty o výsledku)", "'Šampionát vyhrálo Japonsko.'", "'Zápas trval 90 minut.'", "Nevynechal bych nic"], e: "Krátká zpráva potřebuje hlavně fakta o výsledku — dojem diváků je subjektivní a nejméně podstatný, proto by šel vynechat jako první." },
  ...
  { q: "Text má 5 vět. Chceš napsat shrnutí na 1 větu. Jak vybereš, co do shrnutí patří?", a: "Vyberu informaci, která spojuje/shrnuje smysl většiny ostatních vět", opts: ["Vyberu informaci, která spojuje/shrnuje smysl většiny ostatních vět", "Zkopíruji první větu", "Zkopíruji poslední větu", "Vyberu nejdelší větu"], e: "Dobré shrnutí zachycuje to, co spojuje smysl celého textu — ne nutně první, poslední nebo nejdelší větu." },
