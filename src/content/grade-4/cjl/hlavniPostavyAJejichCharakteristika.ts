...
const POOL_L3: QA[] = [
  ...
  { q: "V příběhu bojuje hrdina s drakem, který mu brání dostat se ke kouzelnému meči. Kdo je antagonista?", a: "Drak (překáží hrdinovi, brání mu v cíli)", opts: ["Drak (překáží hrdinovi, brání mu v cíli)", "Hrdina", "Kouzelný meč", "Vypravěč"], e: "Antagonista je ten, kdo hlavní postavě stojí v cestě — v tomto příběhu je to drak, který brání hrdinovi dosáhnout jeho cíle." },
  ...
  { q: "Autor popisuje postavu takto: 'Vysoký muž s šedivým plnovousem, hluboký hlas, vždy klidný a moudrý.' Které části popisu jsou fyzické a které psychické?", a: "Fyzické: vysoký, šedivý plnovous, hluboký hlas. Psychické: klidný, moudrý.", opts: ["Fyzické: vysoký, šedivý plnovous, hluboký hlas. Psychické: klidný, moudrý.", "Vše je fyzické", "Vše je psychické", "Nedá se to rozdělit"], e: "Vzhled a hlas jsou fyzické vlastnosti (co vidíme a slyšíme), kdežto klid a moudrost popisují povahu — to jsou vlastnosti psychické." },
  { q: "V pohádce je čarodějnice vylíčena jen jako 'zlá a lstivá' bez dalšího vysvětlení. V realistické povídce by taková postava byla spíš:", a: "Příliš jednoduchá — povídka obvykle potřebuje komplexnější, uvěřitelnější postavy", opts: ["Příliš jednoduchá — povídka obvykle potřebuje komplexnější, uvěřitelnější postavy", "Naprosto typická pro povídku", "Nemožná v žádném žánru", "Vždy hlavní postavou"], e: "Pohádkové postavy bývají jednoduché (jasně dobré nebo zlé), ale povídka o reálném životě potřebuje uvěřitelnější, komplexnější postavy." },
  { q: "Protagonista v příběhu chce najít ztraceného psa. Antagonistou může být:", a: "Cokoliv, co mu v hledání brání — třeba bouřka, zlý soused nebo vlastní strach", opts: ["Cokoliv, co mu v hledání brání — třeba bouřka, zlý soused nebo vlastní strach", "Jen jiná osoba", "Jen zvíře", "Antagonista tu není potřeba"], e: "Antagonista nemusí být jen zlá osoba — může to být i překážka nebo vlastní slabost, hlavně že hrdinovi brání v dosažení cíle." },
  { q: "Přečti: 'Filip se nikdy nechlubil svými úspěchy, i když vyhrál soutěž.' Jaká vlastnost z toho vyplývá?", a: "Skromnost (nepřímá charakteristika z jednání)", opts: ["Skromnost (nepřímá charakteristika z jednání)", "Pýcha", "Lenost", "Fyzická síla"], e: "Z toho, že se Filip nechlubí ani po vítězství, poznáme jeho skromnost — vlastnost vyplývá z jednání, ne z přímého tvrzení." },
  { q: "Ve dvou větách o stejné postavě: 'Petr je odvážný.' a 'Petr vběhl do hořícího domu, aby zachránil kočku.' Který způsob charakteristiky lépe ukáže čtenáři, jaký Petr skutečně je, a proč?", a: "Druhá věta (nepřímá) — čin je přesvědčivější a živější než pouhé tvrzení", opts: ["Druhá věta (nepřímá) — čin je přesvědčivější a živější než pouhé tvrzení", "První věta (přímá) — je kratší", "Obě věty jsou úplně stejně silné", "Ani jedna věta o Petrovi nic neříká"], e: "Konkrétní čin (běh do hořícího domu) čtenáře přesvědčí mnohem víc než pouhé tvrzení 'je odvážný' — nepřímá charakteristika je živější." },
  { q: "Vedlejší postava v příběhu pomáhá hlavnímu hrdinovi radou, ale sama se do děje moc nezapojuje. Jakou roli plní?", a: "Doplňuje příběh a podporuje hlavní postavu, aniž by byla sama ve středu děje", opts: ["Doplňuje příběh a podporuje hlavní postavu, aniž by byla sama ve středu děje", "Je to ve skutečnosti hlavní postava", "Je to vždy antagonista", "Nemá v příběhu žádný smysl"], e: "Vedlejší postavy podporují hlavní postavu a doplňují děj, ale příběh se netočí kolem nich — proto zůstávají vedlejší, ne hlavní." },
];
