...
const POOL_L1: QA[] = [
  ...
  { q: "Jaká je technika rychlého hledání informací v textu?", a: "Přeletíme text očima a hledáme klíčová slova", opts: ["Přeletíme text očima a hledáme klíčová slova", "Čteme každé slovo od začátku", "Čteme jen poslední větu", "Přečteme text pozpátku"], e: "Při rychlém hledání nemusíme číst slovo po slově — jen přejedeme očima text a všímáme si klíčových slov. Číst vše od začátku by trvalo zbytečně dlouho.", hints: [
    "Rychlé hledání neznamená přečíst úplně všechno slovo po slově — přemýšlej, čeho konkrétního se očima 'chytáš', když text jen přeletíš.",
  ...
  { q: "Jak najdeme hlavní myšlenku textu?", a: "Ptáme se: O čem celý text je? Co chce autor říct?", opts: ["Ptáme se: O čem celý text je? Co chce autor říct?", "Přečteme jen první větu", "Spočítáme odstavce", "Hledáme nejdelší větu"], e: "Hlavní myšlenku najdeme tak, že přemýšlíme o celém textu a ptáme se, co nám tím autor chce sdělit. První věta ani nejdelší věta hlavní myšlenku samy o sobě prozradit nemusí.", hints: [
    "Počítání odstavců ani hledání nejdelší věty ti hlavní myšlenku nedá — potřebuješ přemýšlet o obsahu, ne o formě textu.",
  ...
  { q: "Při letmém prohlížení textu (skimming) získáváme:", a: "celkový přehled o tématu a struktuře textu", opts: ["celkový přehled o tématu a struktuře textu", "každý detail textu", "přesný přepis textu", "pravopisné chyby"], e: "Skimming je letmé pročtení, při kterém zjistíme, o čem text zhruba je a jak je uspořádaný. Nejde o zapamatování každého detailu — na to bychom museli číst pomalu a důkladně.", hints: [
    "Letmé prohlížení je RYCHLÉ — nemáš čas zaznamenat každé slovo ani chybu, tak co si z něj asi odneseš?",
...
const POOL_L2: QA[] = [
  ...
  { q: "Jak vytvoříme myšlenkovou mapu textu?", a: "Hlavní téma uprostřed + klíčová slova v paprscích", opts: ["Hlavní téma uprostřed + klíčová slova v paprscích", "Napíšeme text celý znovu", "Seřadíme věty abecedně", "Vypíšeme jen slovesa"], e: "Myšlenková mapa má uprostřed hlavní téma a od něj se paprskovitě rozbíhají klíčová slova, takže přehledně ukáže, co spolu souvisí. Opsání celého textu ani řazení vět podle abecedy mapou není.", hints: [
  ...
  { q: "Přečteme rychle nadpisy a první věty odstavců. To nám dá:", a: "celkový přehled o obsahu textu", opts: ["celkový přehled o obsahu textu", "detailní znalost každé věty", "přesnou odpověď na každou otázku", "seznam klíčových slov"], e: "Nadpisy a úvodní věty odstavců shrnují, o čem jednotlivé části jsou, takže z nich rychle získáme celkový přehled. Pro znalost každého detailu bychom museli text přečíst celý a pomalu.", hints: [
    "Přečetl/a jsi jen zlomek textu (nadpisy a první věty), ne celý text — může ti to dát znalost KAŽDÉ věty, nebo jen hrubou představu?",
...
const POOL_L3: QA[] = [
  { q: "Text má 3 odstavce: 1) o příčinách odlesňování, 2) o dopadu na zvířata, 3) o možných řešeních. Jaká je hlavní myšlenka CELÉHO textu?", a: "Odlesňování má vážné dopady a je potřeba ho řešit (spojuje všechny 3 odstavce)", opts: ["Odlesňování má vážné dopady a je potřeba ho řešit (spojuje všechny 3 odstavce)", "Jen příčiny odlesňování", "Jen dopad na zvířata", "Jen možná řešení"], e: "Hlavní myšlenka musí zahrnout smysl všech odstavců, ne jen jednoho — proto spojuje příčiny, dopady i řešení do jedné myšlenky." },
  ...
  { q: "Použil jsi scanning a našel jsi rok '1989' v textu o historii. Co dalšího musíš udělat, aby to byla platná odpověď na otázku 'Kdy padla železná opona?'", a: "Ověřit, že věta s rokem 1989 se skutečně týká pádu železné opony, ne jiné události", opts: ["Ověřit, že věta s rokem 1989 se skutečně týká pádu železné opony, ne jiné události", "Nic, stačí najít jakýkoli rok", "Musím přečíst celý text znovu od začátku", "Musím hledat jiné číslo"], e: "Nalezení čísla nestačí — musíme ověřit, že věta s ním se opravdu týká otázky, kterou jsme si položili, jinak by odpověď mohla být špatná." },
  { q: "Ve dvou různých textech se objevuje stejné klíčové slovo 'motor'. V jednom textu je téma auta, ve druhém lidské tělo. Co z toho plyne?", a: "Stejné klíčové slovo může patřit k různým tématům — záleží na kontextu celého textu", opts: ["Stejné klíčové slovo může patřit k různým tématům — záleží na kontextu celého textu", "Slovo 'motor' patří vždy jen k autům", "Oba texty musí být o stejném tématu", "Klíčová slova nikdy nemají víc významů"], e: "Jedno slovo může mít různý smysl v různém kontextu ('motor' auta vs. přeneseně o srdci) — proto se vždy díváme na celý text, ne jen na jedno slovo." },
  ...
  { q: "Proč je důležité po přečtení celého textu hlavní myšlenku SHRNOUT vlastními slovy, a ne jen opsat jednu větu z textu?", a: "Vlastní shrnutí ukazuje, že jsme textu opravdu porozuměli, ne že jsme jen našli podobnou větu", opts: ["Vlastní shrnutí ukazuje, že jsme textu opravdu porozuměli, ne že jsme jen našli podobnou větu", "Opsaná věta je vždy špatně", "Vlastní slova jsou vždy delší", "Není to důležité, obojí je stejné"], e: "Vlastní formulace nutí přemýšlet o smyslu celého textu, kdežto opsaná věta může být jen náhodně podobná, aniž bychom textu skutečně rozuměli." },
];
