...
const POOL_L1: QA[] = [
  { q: "Co je téma ve vlastním textu?", a: "Základní myšlenka příběhu", opts: ["Jak dlouhý bude text", "Základní myšlenka příběhu", "Kde text nakonec vyjde", "Kdo text napsal"], e: "Téma je to hlavní, o čem příběh vypráví — jeho základní myšlenka. Délka textu, jméno autora ani místo vydání nám neřeknou, o čem text vlastně je." },
  { q: "Co je motiv v textu?", a: "Opakující se prvek v textu", opts: ["Jméno autora knihy", "Opakující se prvek v textu", "Pravopis použitý v textu", "Celková délka textu"], e: "Motiv je prvek, který se v textu vrací a propojuje ho — třeba voda, cesta nebo přátelství. Délka, jméno autora ani pravopis o obsahu příběhu nic nevypovídají." },
  ...
  { q: "Co je styl autora?", a: "Způsob, jakým autor píše", opts: ["Jméno autora knihy", "Způsob, jakým autor píše", "Celková délka textu", "Hlavní téma textu"], e: "Styl je to, jak autor píše — jaká slova volí, jak dlouhé tvoří věty a jakým tónem mluví. Není to téma (o čem píše) ani jeho jméno, ale jeho osobitý způsob psaní." },
  { q: "Čím text oživíme?", a: "Přídavnými jmény, přímou řečí, živým popisem", opts: ["Přídavnými jmény, přímou řečí, živým popisem", "Mnoha daty a čísly", "Jen podstatnými jmény", "Bez jakýchkoli přívlastků"], e: "Text ožije, když přidáme přídavná jména, přímou řeč postav a živý popis — čtenář si pak vše lépe představí. Spousta čísel nebo holá podstatná jména bez přívlastků naopak text ochudí." },
  {
    ...
    hints: [
      "Téma říká, o čem text je. Motiv je něco, co se v textu vrací.",
      "Osnova je jako kostra příběhu — rozvrhne, co bude na začátku, uprostřed a na konci, ještě než začneš psát.",
      "Text oživíme: přídavná jména, přímá řeč, konkrétní detaily",
    ],
  },
  ...
  { q: "Co je přídavné jméno a proč ho používat v textu?", a: "Zpřesňuje popis věci", opts: ["Vyjadřuje místo děje", "Zpřesňuje popis věci", "Vyjadřuje probíhající děj", "Nahrazuje podstatné jméno"], e: "Přídavné jméno popisuje vlastnost a zpřesňuje představu — 'starý dům' řekne víc než pouhý 'dům'. Děj vyjadřuje sloveso, proto přídavné jméno není od toho, aby nahrazovalo podstatné jméno." },
  { q: "Co je přímá řeč v příběhu a proč ji použít?", a: "Slova postav, oživují text", opts: ["Shrnutí celého příběhu", "Slova postav, oživují text", "Komentář autora k ději", "Popis prostředí příběhu"], e: "Přímá řeč jsou slova, která postavy přímo říkají — text tak ožije a poznáme z ní jejich povahu. Popis prostředí nebo komentář autora nám postavu nenechá promluvit vlastními slovy." },
  ...
  { q: "Co je revize textu?", a: "Čtení a opravování hotového", opts: ["Vydání textu tiskem", "Čtení a opravování hotového", "Čtení textu spolužákovi", "První psaní bez oprav"], e: "Revize je závěrečné pročtení hotového textu, při kterém opravíme obsah, styl i pravopis. Není to první psaní ani vydání — je to krok, kdy text vylepšujeme, než ho dáme číst ostatním." },
...
const POOL_L2: QA[] = [
  ...
  { q: "Jak psát dialog (přímou řeč) správně?", a: "Uvozovky, čárka, uvozovací věta", opts: ["Bez uvozovek jako prostý text", "Uvozovky, čárka, uvozovací věta", "Jen tučným písmem", "V kulaté závorce"], e: "Přímou řeč píšeme do uvozovek a po ní následuje čárka a uvozovací věta malým písmenem (řekl, zeptala se). Bez uvozovek, jen tučně nebo v závorce by čtenář nepoznal, že jde o slova postavy." },
  ...
  { q: "Co znamená obrat 'Petr běží jako vítr.'?", a: "srovnání se slovem jako", opts: ["citát z jiné knihy", "srovnání se slovem jako", "přejmenování bez slova jako", "faktická informace"], e: "Přirovnání spojuje dvě věci slůvkem 'jako' a tím něco zdůrazní — 'běží jako vítr' znamená velmi rychle. Bez 'jako' by šlo o metaforu, ne o přirovnání." },
  ...
  { q: "Jak obohatit text synonymy?", a: "Nahradíme slovo jiným", opts: ["Přidáme překlad slova", "Nahradíme slovo jiným", "Slovo úplně vypustíme", "Slovo dvakrát zopakujeme"], e: "Synonyma jsou slova s podobným významem — když se nějaké slovo často opakuje, nahradíme ho jiným a text zní pestřeji. Zdvojení nebo vypuštění slova text nevylepší." },
  { q: "Co je kompozice textu?", a: "Celková stavba textu", opts: ["Délka textu v počtu slov", "Celková stavba textu", "Téma a hlavní motiv", "Pravopis a interpunkce"], e: "Kompozice je stavba textu — jak na sebe navazují úvod, zápletka, vyvrcholení a závěr. Není to počet slov ani pravopis, ale uspořádání jednotlivých částí do celku." },
  ...
  { q: "Jak prodloužit krátký příběh?", a: "Přidat popis nebo scénu", opts: ["Přidat seznam slov", "Přidat popis nebo scénu", "Opakovat první odstavec", "Napsat závěr ještě jednou"], e: "Příběh smysluplně prodloužíme tak, že přidáme popis prostředí, další scénu nebo novou postavu — děj se tím rozvine. Opakování odstavce nebo seznam slov text jen uměle natáhnou, ale nic mu nepřinesou." },
  { q: "Co je rytmus textu?", a: "Střídání krátkých a dlouhých vět", opts: ["Hlavní téma celého textu", "Střídání krátkých a dlouhých vět", "Použité přídavné jméno", "Počet slov v textu"], e: "Rytmus vzniká střídáním krátkých a dlouhých vět, které řídí tempo čtení — krátké věty zrychlí, dlouhé zpomalí. Není to počet slov ani téma, ale to, jak text 'plyne'." },
  { q: "Jaký typ textu napíše 4. třída nejčastěji?", a: "Vypravování a popis", opts: ["Filozofická esej", "Vypravování a popis", "Odborný článek", "Dramatický monolog"], e: "Ve 4. třídě se učíme hlavně vypravování a popis — to jsou texty přiměřené našemu věku. Odborný článek, esej nebo dramatický monolog jsou náročné útvary pro starší žáky." },
];
