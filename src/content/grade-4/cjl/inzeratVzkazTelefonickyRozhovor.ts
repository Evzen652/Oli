...
const POOL_L1: QA[] = [
  ...
  { q: "Jaký je účel inzerátu?", a: "nabídka nebo poptávka", opts: ["shrnovat celý příběh", "nabídka nebo poptávka", "psát soukromé zprávy", "opisovat literaturu"], e: "Inzerát píšeme, když chceme něco prodat (nabídka) nebo naopak něco sehnat (poptávka). Soukromé zprávy ani převyprávění příběhu sem nepatří, ty mají jiný účel." },
  ...
  { q: "Jak začíná telefonní hovor?", a: "Představíme se a pozdravíme", opts: ["Pozdravíme a počkáme", "Představíme se a pozdravíme", "Rovnou řekneme věc hovoru", "Řekneme jen své jméno"], e: "Na začátku hovoru pozdravíme a hned se představíme, aby druhý hned věděl, kdo volá. Kdybys začal rovnou věcí nebo jen mlčel, byl by druhý zmatený." },
  ...
  { q: "V inzerátu slova:", a: "jsou stručná a heslovitá", opts: ["jsou vždy v angličtině", "jsou stručná a heslovitá", "jsou dlouhá a podrobná", "jsou básní nebo rýmem"], e: "Inzerát se má přečíst rychle, proto v něm píšeme jen to nejdůležitější heslovitě, bez zbytečných slov. Dlouhé věty, rýmy ani cizí jazyk čtenáře jen zdrží." },
  ...
  { q: "Kde se inzeráty nejčastěji zveřejňují?", a: "v novinách a na internetu", opts: ["jen osobně na ulici", "v novinách a na internetu", "jen v tištěných knihách", "jen telefonicky domluvou"], e: "Inzerát chceme ukázat co nejvíce lidem, proto ho dáváme tam, kde ho mnoho lidí uvidí — do novin, na internet nebo na nástěnku. V knize ani jen osobně by ho skoro nikdo nenašel." },
...
const POOL_L2: QA[] = [
  ...
  { q: "Inzerát: 'Hledám štěně. Tel. 777 111 222.' — jaký typ?", a: "poptávkový, někdo hledá", opts: ["oznamovací sdělení", "poptávkový, někdo hledá", "inzerát není správný", "nabídkový, někdo prodává"], e: "Slovo 'hledám' znamená, že něco sháníš, a to je vždy poptávka. Kdyby tam stálo 'prodám' nebo 'nabízím', šlo by o inzerát nabídkový." },
  ...
  { q: "Vzkaz 'Jdu ke kamarádovi' — co chybí?", a: "kdo, komu a kdy zpět", opts: ["jen dnešní datum", "kdo, komu a kdy zpět", "nechybí vůbec nic", "jen podpis dole"], e: "Vzkaz říká jen co, ale neprozradí, kdo ho píše, komu je určen ani kdy se pisatel vrátí. Chybí tedy hned několik důležitých údajů, ne pouze podpis." },
  ...
  { q: "Inzerát o ztracené věci musí obsahovat:", a: "popis věci, místo, kontakt", opts: ["jen cenu ztracené věci", "popis věci, místo, kontakt", "jen jméno majitele", "jen fotku té věci"], e: "Aby ti ztracenou věc někdo vrátil, musí podle popisu a místa poznat, že jde o tu pravou, a mít kontakt, kam se ozvat. Samotné jméno majitele ani cena k tomu nestačí." },
  { q: "Vzkaz zanecháme, když:", a: "když adresát není doma", opts: ["když chceme psát dopis", "když adresát není doma", "když píšeme inzerát", "když právě telefonujeme"], e: "Vzkaz je náhrada za osobní sdělení pro chvíli, kdy adresát není přítomen. Když ho zastihneš po telefonu nebo mu píšeš dopis, vzkaz nepotřebuješ." },
  { q: "Telefonní hovor — jak správně odmítáme neznámé hovory?", a: "zdvořile a stručně", opts: ["zeptáme se, kdo volá", "zdvořile a stručně", "jen mlčky zavěsíme", "hovor vůbec nezvedneme"], e: "I když hovor odmítáš, zůstaneš slušný a krátce vysvětlíš, že jde o omyl. Zavěsit beze slova nebo nevrle se ptát 'kdo jste' působí hrubě." },
  { q: "Inzerát 'Prodám kolo: stáří 2 roky, funkční brzdy, nosnost 80 kg, barva červená.' — jaký druh informací uvádí?", a: "konkrétní technické údaje", opts: ["příliš obecné informace", "konkrétní technické údaje", "nepotřebné osobní informace", "jen cena bez popisu"], e: "Inzerát uvádí přesné údaje o kole (stáří, brzdy, nosnost, barvu), podle kterých si zájemce udělá jasnou představu. To je přesně to, co dobrý inzerát má obsahovat." },
  { q: "Vzkazem nahrazujeme:", a: "osobní sdělení v nepřítomnosti", opts: ["inzerát v novinách", "osobní sdělení v nepřítomnosti", "celý telefonní hovor", "celý soukromý dopis"], e: "Vzkaz zastupuje to, co bychom řekli osobně, kdyby tam adresát byl. Nenahrazuje dopis, telefonát ani inzerát, ty slouží k jiným účelům." },
  { q: "Příklad správné struktury telefonního hovoru:", a: "Pozdrav, jméno, věc, rozloučení", opts: ["Dobrý den. ... zavěsím.", "Pozdrav, jméno, věc, rozloučení", "Haló? Co chcete? Čau.", "Objednávka. Číslo 5. Díky."], e: "Tento hovor má všechny části ve správném pořadí: pozdrav, představení, věc hovoru i rozloučení. Ostatní možnosti jsou nezdvořilé nebo některou důležitou část vynechávají." },
];
...
function gen(level: number): PracticeTask[] {
  ...
  return selected.map(({ q, a, opts, e }) => ({
    ...
    hints: [
      ...
      "Vzkaz musí říct, kdo ho píše, komu, co sděluje a kdy — a musí být čitelný a stručný, aby ho příjemce zvládl přečíst na první pohled.",
      "Telefonní hovor má pevné pořadí. Zamysli se, čím musí každý slušný hovor začít a čím naopak skončit.",
    ],
    explanation: e,
  }));
}
