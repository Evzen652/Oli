...
const POOL_L1: QA[] = [
  ...
  { q: "Co je přímá řeč?", a: "doslovná slova postavy v uvozovkách", opts: ["komentář vypravěče k ději", "doslovná slova postavy v uvozovkách", "myšlenky autora knihy", "popis chování postavy"], e: "Přímá řeč je přesné znění toho, co postava řekla, a píše se do uvozovek. Popis chování ani komentář vypravěče nejsou doslovná slova postavy, proto se do uvozovek nedávají." },
  { q: "Vzor zápisu uvozovací věty za přímou řečí:", a: "dolní+horní uvozovky + čárka + uvozovací věta malým", opts: ["dolní+horní uvozovky + čárka + uvozovací věta malým", "uvozovky + tečka + uvozovací věta velkým", "uvozovky bez čárky + uvozovací věta malým", "uvozovací věta na začátku + uvozovky na konci"] , e: "Když uvozovací věta stojí za přímou řečí, oddělíme ji čárkou a začneme malým písmenem (např. 'Přijdu,' řekl). Tečka a velké písmeno by větu ukončily, a čárka se vynechat nesmí.", hints: [
    "To, co postava řekla, a krátký dodatek, kdo mluvil (třeba 'řekl Petr'), patří ke stejné větě — vyprávění pokračuje dál, nezačíná nová věta.",
    "Když věta pokračuje a nekončí tečkou, rozmysli si dvě věci najednou: jaké interpunkční znaménko na to místo patří a jakým písmenem — velkým, nebo malým — pak začneš pokračovat.",
  ] },
  ...
  { q: "Co píšeme v úvodu vypravování?", a: "kde, kdy a kdo", opts: ["čím příběh vyvrcholí", "kde, kdy a kdo", "co autor chtěl říct", "jak příběh skončí"], e: "Úvod čtenáři představí místo, čas a postavy, aby věděl, kde a s kým se příběh děje. Vyvrcholení i konec by úvod prozradily moc brzy a do úvodu nepatří." },
];
...
const POOL_L2: QA[] = [
  ...
  { q: "Přímá řeč uprostřed věty (Petr řekl: Pojď, a odešel) — co je správně?", a: "Ano — uvozovací věta, dvojtečka, přímá řeč s čárkou", opts: ["Ano — uvozovací věta, dvojtečka, přímá řeč s čárkou", "Ne — chybí vykřičník", "Ne — chybí druhé záhlaví", "Ne — přímá řeč se nepíše s čárkou"] , e: "Když uvozovací věta stojí před přímou řečí, oddělíme ji dvojtečkou a přímou řeč dáme do uvozovek. Vykřičník není povinný a čárka se v přímé řeči klidně použít může.", hints: [
    "Vykřičník ani druhé záhlaví nejsou u zápisu rozhovoru povinné — hledej, co v ukázce naopak chybí, nebo je v pořádku.",
    "Ta krátká věta, co uvádí, kdo mluví, tu stojí PŘED slovy postavy — jaké znaménko za ni tedy patří, a smí za slovy postavy zůstat čárka?",
  ] },
  ...
  { q: "Příklad závěru vypravování o výletě:", a: "Večer jsme se vrátili domů.", opts: ["Stáli jsme na vrcholu.", "Večer jsme se vrátili domů.", "Náhle se ztratil batoh.", "Vydali jsme se na výlet."], e: "Závěr říká, jak to dopadlo — návrat domů příběh uzavírá. Ztracený batoh je zápletka a stání na vrcholu vyvrcholení, ty napětí teprve stupňují, ne uklidňují." },
  { q: "Jak zvýraznit přímou řeč v textu?", a: "uvozovky a uvozovací věta (řekl, zavolal, odpověděl)", opts: ["uvozovky a uvozovací věta (řekl, zavolal, odpověděl)", "jen uvozovky bez uvozovací věty", "jen tučné písmo", "kurzívou a podtržením"], e: "Přímou řeč poznáme podle uvozovek a uvozovací věty, která říká, kdo a jak promluvil (řekl, zavolal). Tučné písmo ani podtržení se k označení přímé řeči nepoužívají.", hints: [
    "Grafické zvýraznění (tučně, kurzívou, podtržením) se v psaném textu na přímou řeč nepoužívá — čeština má na to vlastní pravopisný způsob.",
    "Ten způsob spojuje dvě věci dohromady: dvojici znamének, která obklopují doslovná slova postavy, a krátkou přidanou větu, jež čtenáři prozradí, kdo vlastně mluvil.",
  ] },
  { q: "Co dělá vypravování zajímavějším?", a: "přídavná jména, přímá řeč, napětí", opts: ["jen suchá fakta bez děje", "přídavná jména, přímá řeč, napětí", "jen krátké holé věty", "co nejvíce postav najednou"], e: "Příběh ožije, když použijeme barvitá přídavná jména, přímou řeč postav a vystavíme napětí. Hromada postav nebo jen suchá fakta bez děje čtenáře naopak nudí.", hints: [
    "Přemýšlej, co dělá vyprávění ŽIVÉ — víc postav samo o sobě děj nezpestří a suchý výčet faktů čtenáře spíš unaví.",
    "Zajímavé vyprávění popisuje barvitě, nechává postavy mluvit vlastními slovy a buduje napětí — hledej možnost, která kombinuje víc takových prostředků najednou.",
  ] },
  ...
  { q: "Jaký typ věty používáme v úvodu vypravování?", a: "oznamovací", opts: ["zvolací", "oznamovací", "rozkazovací", "tázací"], e: "V úvodu klidně oznamujeme, kde, kdy a kdo — proto používáme věty oznamovací. Rozkazy, otázky nebo zvolání se hodí spíš dovnitř děje a do přímé řeči postav." },
  ...
  { q: "Jaká slova vyjadřují časovou posloupnost?", a: "nejprve, pak, potom, nakonec, mezitím, zatímco, dříve", opts: ["nejprve, pak, potom, nakonec, mezitím, zatímco, dříve", "napravo, nalevo, nahoře, dole", "hodný, zlý, veselý, smutný", "protože, přestože, ačkoliv, aby"], e: "Časovou posloupnost vyjadřují slova o čase — nejprve, pak, nakonec, zatímco. Slova napravo a nahoře označují místo, hodný a zlý vlastnosti a protože, aby spojují věty podle příčiny či účelu.", hints: [
    "Zeptej se u každé skupiny: odpovídá na 'kdy?', na 'kde?', na 'jaký je?', nebo spojuje věty podle příčiny?",
    "Jen jedna ze čtyř nabízených skupin odpovídá na otázku 'kdy?' — právě ta popisuje pořadí, ve kterém děje šly po sobě v čase.",
  ] },
  { q: "V osnově vypravování je jako druhý bod:", a: "zápletka", opts: ["úvod", "zápletka", "vyvrcholení", "závěr"], e: "Hned po úvodu přichází jako druhý bod zápletka, ve které se objeví problém a rozjede se děj. Úvod je první, vyvrcholení třetí a závěr poslední." },
  { q: "Kdo je vypravěč?", a: "ten, kdo vypráví příběh", opts: ["hlavní postava příběhu", "ten, kdo vypráví příběh", "čtenář, který to čte", "autor knihy jako člověk"], e: "Vypravěč je hlas, který nám příběh vypráví — může být jednou z postav, nebo stát mimo děj. Není to totéž co skutečný autor knihy ani jako čtenář, který příběh čte." },
];
...
function gen(level: number): PracticeTask[] {
  ...
  return selected.map(({ q, a, opts, e, hints }) => ({
    ...
    hints: hints ?? [
      "Sleduj plynutí času — od okamžiku, kdy ještě nic nezačalo, až po chvíli, kdy je všechno vyřešené.",
      "Napřed se čtenář musí dozvědět, kde a s kým vlastně je. Teprve potom se může něco pokazit, vyhrotit až na samou hranici a nakonec zase urovnat.",
      "U zápisu řeči postavy si hlídej, že uvozovky obklopují právě a jen ta slova, která postava opravdu nahlas vyslovila, a že se od zbytku věty vždycky oddělují čárkou.",
    ],
    explanation: e,
  }));
}
