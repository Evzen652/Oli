...
const POOL_L1: QA[] = [
  ...
  { q: "Jak se správně zapisuje přímá řeč? (Petr říká: Přijdu brzy.)", a: "dolní+horní uvozovky: Přijdu brzy, řekl Petr.", opts: ["dolní+horní uvozovky: Přijdu brzy, řekl Petr.", "jednoduché apostrofy bez uvozovací věty", "pomlčka bez uvozovek", "tečka + velké písmeno uvozovací věty"] },
  ...
  { q: "Vzor zápisu uvozovací věty za přímou řečí:", a: "dolní+horní uvozovky + čárka + uvozovací věta malým", opts: ["dolní+horní uvozovky + čárka + uvozovací věta malým", "uvozovky + tečka + uvozovací věta velkým", "uvozovky bez čárky + uvozovací věta malým", "uvozovací věta na začátku + uvozovky na konci"] },
...
const POOL_L2: QA[] = [
  ...
  { q: "Přímá řeč uprostřed věty (Petr řekl: Pojď, a odešel) — co je správně?", a: "Ano — uvozovací věta, dvojtečka, přímá řeč s čárkou", opts: ["Ano — uvozovací věta, dvojtečka, přímá řeč s čárkou", "Ne — chybí vykřičník", "Ne — chybí druhé záhlaví", "Ne — přímá řeč se nepíše s čárkou"] },
  ...
  { q: "Příklad správné přímé řeči s uvozovací větou na začátku:", a: "uvozovací věta + dvojtečka + uvozovky + obsah", opts: ["uvozovací věta + dvojtečka + uvozovky + obsah", "uvozovky bez uvozovací věty", "uvozovací věta + obsah bez uvozovek", "obsah bez uvozovek i věty"] },
