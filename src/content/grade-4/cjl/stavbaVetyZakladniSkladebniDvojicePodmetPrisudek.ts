...
const POOL_L1: QA[] = [
  ...
  { q: "Na co se ptáme na podmět?", a: "Kdo? Co?", opts: ["Kdo? Co?", "Co dělá?", "Kde? Kdy?", "Jaký? Jaká?"], e: "Na podmět se ptáme otázkou KDO? nebo CO?, protože hledáme původce děje. Otázka 'Co dělá?' patří k přísudku a 'Kde? Kdy?' k příslovečnému určení.", hints: [
    ...
    "Ze čtyř nabízených možností postupně vyřaď tu, která se ptá na činnost — ta patří k přísudku — a pak i tu, která se ptá na místo nebo na čas. Zbyde ti právě jedna.",
  ] },
  { q: "Na co se ptáme na přísudek?", a: "Co dělá? Co je?", opts: ["Co dělá? Co je?", "Kdo? Co?", "Kde? Kdy?", "Čí? Jaký?"], e: "Na přísudek se ptáme CO DĚLÁ? nebo CO JE?, protože hledáme děj nebo stav podmětu. Otázka 'Kdo? Co?' patří k podmětu a 'Čí? Jaký?' k přívlastku.", hints: [
    ...
    "Ze čtyř nabízených možností postupně vyřaď tu, která se ptá přímo na osobu nebo věc — ta patří k podmětu — a pak i tu, která se ptá na vlastnost. Zbyde ti právě jedna.",
  ] },
...
const POOL_L2: QA[] = [
  ...
  { q: "Urči podmět ve větě: 'Přišel jsem pozdě.'", a: "já", opts: ["pozdě", "já", "jsem", "přišel"], e: "Podmět není vyslovený, ale 'přišel jsem' prozrazuje, že mluvčí mluví sám o sobě — tedy JÁ. 'Přišel jsem' je přísudek a 'pozdě' říká, jak přišel." },
  ...
  { q: "Věta 'Čteme potichu.' — jaký je podmět?", a: "my", opts: ["potichu", "my", "já", "čteme"], e: "Podmět není vyslovený, ale koncovka slovesa 'čteme' ukazuje na MY. Pro 'já' by bylo čtu. 'Čteme' je přísudek a 'potichu' říká, jak čteme." },
  ...
  { q: "Věta 'Pošli mi zprávu.' — jaký je podmět?", a: "ty", opts: ["pošli", "ty", "zprávu", "já"], e: "Rozkaz 'pošli' míří na jednu osobu, které něco přikazujeme — tedy TY, i když není vyslovené. 'Pošli' je přísudek a 'zprávu' to, co má poslat." },
  ...
  { q: "Věta 'Prší.' — jaký je podmět?", a: "podmět chybí", opts: ["nevyjádřený", "podmět chybí", "nebe", "déšť"], e: "Sloveso 'prší' je neosobní — neexistuje nikdo, kdo by děj konal, proto věta podmět vůbec nemá. Není to nevyjádřený podmět, ten by se dal doplnit (např. my), tady to nejde." },
  ...
  { q: "Základní skladební dvojice tvoří:", a: "podmět + přísudek", opts: ["podmět + přísudek", "podmět + předmět", "přísudek + příslovce", "přívlastek + podstatné jméno"], e: "Základní skladební dvojice je dvojice podmět a přísudek, na které stojí každá věta. Předmět ani příslovce do základní dvojice nepatří, jsou to jen rozvíjející členy.", hints: [
    ...
    "Tři z nabízených možností obsahují vždycky jen jeden z těch dvou hlavních členů a k němu nějaký rozvíjející — a jenom jediná z nich spojuje oba hlavní členy dohromady.",
  ] },
  ...
  { q: "Urči podmět ve větě: 'Pomáháme sousedce.'", a: "my", opts: ["já", "my", "sousedce", "pomáháme"], e: "Podmět není vyslovený, ale koncovka slovesa 'pomáháme' ukazuje na MY. 'Sousedce' je ten, komu pomáháme, tedy předmět, ne podmět." },
];

const POOL_L3: QA[] = [
  { q: "Věta 'Mrzí mě tvá chyba.' — jaký je podmět?", a: "chyba", opts: ["mě", "chyba", "tvá", "mrzí"], e: "Podmět nemusí stát na začátku věty. CO mě mrzí? — chyba, proto je chyba podmět. Slovo 'mě' je předmět (koho to mrzí) a 'mrzí' je přísudek." },
  ...
  { q: "Věta 'Bylo mu smutno.' — jaký je podmět?", a: "podmět chybí", opts: ["mu", "podmět chybí", "bylo", "smutno"], e: "Tato věta vyjadřuje stav a nemá nikoho, kdo by děj konal — je neosobní, proto podmět chybí. 'Mu' jen říká, komu bylo smutno, není to podmět." },
  ...
  { q: "Věta 'Nemám čas.' — jaký je podmět?", a: "já", opts: ["čas", "já", "nemám", "žádný"], e: "Podmět není vyslovený, ale koncovka slovesa 'nemám' ukazuje na JÁ. 'Čas' je to, co nemám, tedy předmět, ne podmět." },
  ...
  { q: "Věta 'Svítá.' — jaký je podmět?", a: "podmět chybí", opts: ["nevyjádřený", "podmět chybí", "slunce", "den"], e: "Sloveso 'svítá' je neosobní — nikdo děj nekoná, proto věta podmět vůbec nemá. Nedá se doplnit ani slovo slunce, věta funguje sama o sobě." },
  ...
  { q: "Věta 'Musíme odejít.' — jaký je podmět?", a: "my", opts: ["odejít", "my", "musíme", "nikdo"], e: "Podmět není vyslovený, ale koncovka slovesa 'musíme' ukazuje na MY. Pro 'já' by bylo musím. 'Musíme odejít' je přísudek." },
  ...
  { q: "Věta 'Zpívejte!' — jaký je podmět?", a: "vy", opts: ["my", "vy", "oni", "žádný"], e: "Rozkaz 'zpívejte' míří na víc osob, kterým něco přikazujeme — tedy VY, i když není vysloveno. Pro jednu osobu by rozkaz zněl zpívej." },
];
...
function gen(level: number): PracticeTask[] {
  ...
  return selected.map(({ q, a, opts, e, hints }) => ({
    ...
    hints: hints ?? [
      "Zeptej se: kdo nebo co ve větě něco dělá?",
      "Když na tu otázku žádné slovo ve větě neodpovídá, podívej se na koncovku slovesa — ta často prozradí osobu, i když ta osoba ve větě napsaná vůbec není.",
      "Pozor, u některých sloves neodpovídá vůbec nikdo a nic — děj tam prostě probíhá sám od sebe a věta nemá žádného původce, kterého by šlo pojmenovat slovem.",
    ],
    explanation: e,
  }));
}
