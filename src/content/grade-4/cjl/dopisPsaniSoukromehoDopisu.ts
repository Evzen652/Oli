...
const POOL_L1: QA[] = [
  ...
  { q: "Co píšeme v závěru dopisu?", a: "rozloučení a podpis", opts: ["datum a místo", "rozloučení a podpis", "oslovení adresáta", "téma dopisu"], e: "Závěr dopisu slouží k rozloučení a podpisu, abychom poznali, kdo dopis poslal. Datum a místo patří do záhlaví na začátku a oslovení přichází hned za záhlaví, ne na konec." },
  ...
  { q: "Datum v záhlaví se píše:", a: "V Praze dne 1. 6. 2025 / Praha, 1. 6. 2025", opts: ["1/6/2025 (jen čísla s lomítky)", "V Praze dne 1. 6. 2025 / Praha, 1. 6. 2025", "červen 2025 (bez dne a místa)", "dne 6. 1. (chybí rok i místo)"], e: "V záhlaví uvádíme místo i celé datum, například 'V Praze dne 1. 6. 2025'. Zápis s lomítky, jen měsíc s rokem nebo neúplné datum bez roku do dopisu nepatří." },
];
...
const POOL_L2: QA[] = [
  ...
  { q: "Dopis s žádostí o přijetí do sportovního kroužku píšeš:", a: "formálně — vykáte, velké V, Vážený pane...", opts: ["bez záhlaví — stačí jen text a podpis", "formálně — vykáte, velké V, Vážený pane...", "neformálně — tykáte, jako kamarádovi", "jen e-mailem, dopis se nepíše"], e: "Žádost je úřední dopis cizí osobě, proto ji píšeme formálně — vykáme, používáme velké V a oslovení 'Vážený pane'. Tykání ani vynechání záhlaví by v žádosti nebylo vhodné." },
  { q: "Který text patří do textu (těla) dopisu?", a: "Byl jsem na táboře. Bylo to skvělé...", opts: ["Praha, 15. 6. 2025 (záhlaví s datem)", "Byl jsem na táboře. Bylo to skvělé...", "Milý Petře, (oslovení na začátku)", "Tvůj Honza (podpis v závěru)"], e: "Tělo dopisu je to, co chceme sdělit, třeba vyprávění o táboře. 'Praha, 15. 6. 2025' je záhlaví, 'Milý Petře,' je oslovení a 'Tvůj Honza' je podpis v závěru." },
  ...
  { q: "Co je oslovení v dopisu?", a: "první řádek textu — kdo je adresát", opts: ["záhlaví s datem", "první řádek textu — kdo je adresát", "závěr dopisu", "podpis odesílatele"], e: "Oslovení je řádek, kterým dopis začínáme a obracíme se jím na adresáta, například 'Milý Petře,'. Záhlaví s datem, závěr i podpis jsou jiné části dopisu." },
  ...
  { q: "Slovo 'Ty' s velkým T v dopisu kamarádovi:", a: "správné — zdvořilejší forma oslovení blízkého", opts: ["chybné — v tykání se vždycky píše malé t", "správné — zdvořilejší forma oslovení blízkého", "chybné — velké písmeno patří jen do Vy", "chybné — platí to jen v dopisech rodičům, jinde ne"], e: "I při tykání můžeme v dopise psát 'Ty' s velkým T, abychom dali najevo úctu a vřelost — je to správné. Není to chyba ani to neplatí jen pro dopisy rodičům." },
];
 ...
 */
const POOL_L3: QA[] = [
  { q: "Který dopis je určen ŘEDITELI školy (formální styl)?", a: "Vážený pane řediteli, žádám Vás o možnost účastnit se soutěže. S pozdravem, Anna Nováková", opts: ["Zdravím Vás! Chtěla bych se přihlásit do kroužku. Anička.", "Vážený pane řediteli, žádám Vás o možnost účastnit se soutěže. S pozdravem, Anna Nováková", "Ahoj řediteli, jak se máš? Chci do kroužku. Tvoje Anna.", "Milý řediteli, moc rád bych se přihlásil. Tvoje Anna."], e: "Řediteli píšeme formálně: 'Vážený pane', vykání, 'S pozdravem'. Ostatní jsou příliš neformální nebo neúplné." },
  ...
  { q: "V dopise má být záhlaví, oslovení, text a závěr. Který dopis má VŠECHNY 4 části?", a: "'Praha, 1.6. Milá Evo, dnes ti píšu... Těším se, Tvůj Petr'", opts: ["'Milá Evo, jak se máš? Doufám, že dobře.'", "'Praha, 1.6. Milá Evo, dnes ti píšu... Těším se, Tvůj Petr'", "'Praha, 1.6. Milá Evo, těším se na tebe.'", "'Dnes ti píšu o výletě k moři. Petr'"], e: "První varianta má všechny 4 části: místo+datum, oslovení, text, závěr+podpis." },
  ...
  { q: "V dopise strýci píšeš: 'Chtěl jsem se zeptat, ...'. Jaký tvar zvolíš, když se ho ptáš na jeho novinky?", a: "tykáš — 'Jak se máš ty a jak se má rodina?'", opts: ["tykáš — 'Jak se máš ty a jak se má rodina?'", "vykáš — 'Jak se máte Vy a rodina?'", "tykáš, ale s velkým Ty — 'Jak se máš Ty?'", "žádné oslovení nedáváš"], e: "Strýci v soukromém dopise obvykle tykáme: 'Jak se máš ty a jak se má rodina?' (2. os. pro strýce, 3. os. pro rodinu). Vykání s velkým 'Vy' je vhodné, jen pokud v rodině strýci vykáte." },
...
function gen(level: number): PracticeTask[] {
  ...
  return selected.map(({ q, a, opts, e, hints }) => ({
    ...
    hints: hints ?? [
      ...
      "Soukromý dopis píšeme přátelsky lidem, které známe; formální dopis vyžaduje zdvořilé vykání s velkým V",
    ],
    explanation: e,
  }));
}
