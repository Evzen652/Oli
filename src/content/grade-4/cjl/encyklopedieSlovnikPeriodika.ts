...
const POOL_L3: QA[] = [
  { q: "Chceš zjistit, co znamená cizí slovo 'ekosystém', a zároveň se dozvědět zajímavá fakta o přírodě. Které dva zdroje použiješ?", a: "Slovník (význam slova) a encyklopedii (fakta o přírodě)", opts: ["Slovník (význam slova) a encyklopedii (fakta o přírodě)", "Jen slovník", "Jen encyklopedii", "Jen noviny"], e: "Slovník ti vysvětlí, co slovo 'ekosystém' znamená, encyklopedie ti k tomu doplní konkrétní fakta o přírodě — každý zdroj slouží k něčemu jinému." },
  { q: "Proč nehledáme dnešní počasí v encyklopedii?", a: "Encyklopedie obsahuje stálá fakta, ne denně se měnící aktuální zprávy", opts: ["Encyklopedie obsahuje stálá fakta, ne denně se měnící aktuální zprávy", "Encyklopedie počasí vůbec nezná", "Encyklopedie je moc malá", "Počasí není důležité téma"], e: "Encyklopedie shromažďuje fakta, která se dlouho nemění, kdežto počasí je aktuální informace, kterou přinášejí denně vycházející noviny." },
