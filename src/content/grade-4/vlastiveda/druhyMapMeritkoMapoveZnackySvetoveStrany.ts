...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Pěticípou hvězdičkou v rohu",
      "Růžicí světových stran nebo šipkou s N",
      "Kruhovou šipkou dokola",
      "Červeným křížem jako v lékárně",
    ],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Protože to nařizuje zákon o mapách",
      "Aby turisté rozlišili trasy a lépe se orientovali",
      "Aby mapa vypadala barevně a hezky",
