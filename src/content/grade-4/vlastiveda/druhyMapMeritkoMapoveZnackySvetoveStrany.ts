...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: ["Teploměr", "Kompas", "Dalekohled", "Metr"],
  ...
  },
  {
    ...
    options: ["Dole", "Vlevo", "Nahoře", "Vpravo"],
  ...
  },
  {
    ...
    correctAnswer: "Modrá",
    options: ["Zelená", "Hnědá", "Červená", "Modrá"],
  ...
  },
  {
    ...
    options: ["Velikost mapy v centimetrech", "Poměr vzdálenosti na mapě k reálné vzdálenosti", "Barvy použité na mapě", "Název mapy"],
  ...
  },
  {
    ...
    options: ["Politická mapa", "Turistická mapa", "Fyzická mapa", "Tematická mapa"],
  ...
  },
  {
    ...
    options: ["Fyzická mapa", "Turistická mapa", "Plán města", "Politická mapa"],
  ...
  },
  {
    ...
    options: [
      "Mapa celé České republiky",
      "Podrobná mapa zobrazující ulice a budovy města",
      "Letecký snímek volné přírody",
      "Turistická mapa horské oblasti",
    ],
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: ["1 cm na mapě = 50 m ve skutečnosti", "1 cm na mapě = 5 km ve skutečnosti", "1 cm na mapě = 500 m ve skutečnosti", "1 cm na mapě = 50 km ve skutečnosti"],
  ...
  },
  {
    ...
    options: ["1 cm na mapě = 200 m ve skutečnosti", "1 cm na mapě = 20 km ve skutečnosti", "1 cm na mapě = 200 km ve skutečnosti", "1 cm na mapě = 2 km ve skutečnosti"],
  ...
  },
  {
    ...
    correctAnswer: "Hnědá",
    options: ["Zelená", "Hnědá", "Modrá", "Červená"],
  ...
  },
  {
    ...
    options: ["Modrá", "Zelená", "Červená", "Žlutá"],
  ...
  },
  {
    ...
    options: ["Čáry označující hranice krajů", "Čáry zobrazující turistické stezky", "Čáry označující řeky", "Čáry spojující místa se stejnou nadmořskou výškou"],
  ...
  },
  {
    ...
    correctAnswer: "Růžicí světových stran nebo šipkou s N",
    options: ["Růžicí světových stran nebo šipkou s N", "Pěticípou hvězdičkou v rohu", "Kruhovou šipkou dokola", "Červeným křížem jako v lékárně"],
  ...
  },
  {
    ...
    options: ["Příběh o vzniku mapy", "Vysvětlivky mapových značek a barev", "Jméno autora mapy", "Měřítko mapy"],
  ...
  },
  {
    ...
    options: ["Fyzická mapa", "Turistická mapa", "Tematická mapa", "Plán města"],
  ...
  },
  {
    ...
    options: ["Vzdálenosti mezi městy", "Výšky vrcholů hor", "Barvy použité v legendě", "Čísla a písmena určující polohu bodu na mapě"],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    correctAnswer: "12 km",
    options: ["1,2 km", "12 km", "120 km", "6 km"],
  ...
  },
  {
    ...
    correctAnswer: "Aby turisté rozlišili trasy a lépe se orientovali",
    options: ["Protože to nařizuje zákon o mapách", "Aby mapa vypadala barevně a hezky", "Aby turisté rozlišili trasy a lépe se orientovali", "Kvůli barvoslepým turistům"],
  ...
  },
  {
    ...
    options: ["Vrstevnice jsou daleko od sebe", "Oblast je vyznačena modrou barvou", "Oblast je vyznačena zelenou barvou", "Vrstevnice jsou blízko u sebe"],
  ...
  },
  {
    ...
    options: ["Na jih", "Na sever", "Na západ", "Na východ"],
  ...
  },
  {
    ...
    options: ["Polárka je nejjasnější hvězda na obloze", "Polárka je nejblíže Zemi ze všech hvězd", "Polárka stojí téměř nad severním pólem a vždy ukazuje na sever", "Polárka svítí pouze v noci na severu"],
  ...
  },
  {
    ...
    correctAnswer: "5 km",
    options: ["500 m", "50 km", "0,5 km", "5 km"],
  ...
  },
  {
    ...
    options: ["Východní strana je strmá, západní je mírná", "Západní strana kopce je strmá, východní je mírná", "Kopec je symetrický", "Vrstevnice nezávisejí na sklonu svahu"],
