...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    correctAnswer: "Jak lidé v kraji pracují",
    options: ["Příroda a krajina kraje", "Historické památky kraje", "Jak lidé v kraji pracují", "Počet obyvatel kraje"],
  ...
  },
  {
    ...
    options: ["Průmysl", "Cestovní ruch", "Obchod", "Zemědělství"],
  ...
  },
  {
    ...
    correctAnswer: "Podnikání spojené s turisty",
    options: [
      "Stavba nových silnic",
      "Podnikání spojené s turisty",
      "Pěstování zeleniny na polích",
      "Výroba aut v továrně",
    ],
  ...
  },
  {
    ...
    correctAnswer: "Chráněná místa se vzácnou přírodou",
    options: ["Historické hrady a zámky", "Továrny a haly v kraji", "Chráněná místa se vzácnou přírodou", "Silnice a dálnice v kraji"],
    hints: ["Přírodní památky chrání vzácná místa v přírodě."],
    solutionSteps: ["Přírodní památky jsou chráněná místa se vzácnou faunou, flórou nebo geologickými útvary."],
  },
  {
    question: "Kde v kraji obvykle žije nejvíce lidí?",
    correctAnswer: "Ve městech",
    options: ["V horách", "V lesích", "Na polích", "Ve městech"],
  ...
  },
  {
    ...
    correctAnswer: "Výlety a návštěvy muzeí",
    options: [
      "Jen čtením knih doma",
      "Výlety a návštěvy muzeí",
      "Jen sledováním televize",
      "Jen hledáním na internetu",
    ],
    hints: ["Nejlepší způsob je osobní zkušenost."],
    solutionSteps: ["Kraj nejlépe poznáme výlety do přírody, návštěvami muzeí, hradů a zámků."],
  },
];
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: ["Horský terén", "Průmyslová oblast", "Nížina s úrodnou půdou", "Pobřeží moře"],
  ...
  },
  {
    ...
    options: ["Těžký průmysl", "Pěstování obilí", "Rybníkářství", "Cestovní ruch a lesnictví"],
  ...
  },
  {
    ...
    correctAnswer: "Hrady, zámky a kostely",
    options: ["Hrady, zámky a kostely", "Lesy a řeky v kraji", "Továrny a sklady", "Silnice a mosty"],
  ...
  },
  {
    ...
    options: ["Aby turisté platili vstupné", "Pro zachování zdravého prostředí pro lidi, zvířata i rostliny", "Kvůli zákonům Evropské unie", "Protože příroda nevydělává peníze"],
  ...
  },
  {
    ...
    correctAnswer: "Chráněné území se vzácnou přírodou",
    options: ["Park ve středu města", "Průmyslová zóna u města", "Chráněné území se vzácnou přírodou", "Sportovní hřiště v obci"],
  ...
  },
  {
    ...
    options: ["Kraj má velké lesy", "Kraj má hodně turistů", "V kraji je dobré zemědělství", "V kraji je hodně továren a pracovních míst v výrobě"],
  ...
  },
  {
    ...
    options: ["V supermarketu", "V krajském muzeu nebo informačním centru", "Na poště", "V autobusovém nádraží"],
  ...
  },
  {
    ...
    options: ["Území, kam lidé nesmí vstoupit", "Průmyslová zóna", "Území s chráněnou přírodou, kde se může bydlet i hospodařit", "Zemědělská oblast bez lesů"],
  ...
  },
  {
    ...
    correctAnswer: "Nerosty, půda, voda a lesy",
    options: ["Historické budovy kraje", "Silniční síť v kraji", "Počet obyvatel kraje", "Nerosty, půda, voda a lesy"],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    correctAnswer: "V nížinách je úrodná půda a tepleji",
    options: ["V nížinách je úrodná půda a tepleji", "Nížiny jsou blíže k moři", "Hory mají méně slunce", "V horách nejsou zásoby vody"],
  ...
  },
  {
    ...
    correctAnswer: "Utrácejí peníze u místních",
    options: [
      "Staví v kraji nové továrny",
      "Utrácejí peníze u místních",
  ...
  },
  {
    ...
    options: ["Příroda je vždy důležitější než průmysl", "Průmysl je vždy důležitější než příroda", "Průmysl přináší práci, ale může znečistit přírodu — je třeba obojí sladit", "Není třeba nic vyvažovat — průmysl a příroda si nepřekáží"],
  ...
  },
  {
    ...
    options: ["Přibývají nové druhy zvířat a rostlin", "Příroda se zlepšuje díky teplu", "Změna klimatu krajinu neovlivňuje", "Sucha, povodně, odumírání lesů, tání sněhu v horách"],
  ...
  },
  {
    ...
    correctAnswer: "Zvyky a řemesla předávané po generace",
    options: ["Zvyky a řemesla předávané po generace", "Nové technologie v kraji", "Moderní stavby a silnice", "Politické rozhodování v kraji"],
  ...
  },
  {
    ...
    options: ["Zemědělský kraj je větší", "Zemědělský kraj má pole a farmy; průmyslový má továrny a doly", "Průmyslový kraj má více lesů", "Zemědělský kraj leží vždy v nížině"],
  ...
  },
  {
    ...
    options: ["Zboží dovezené ze zahraničí", "Produkty velkých světových firem", "Výrobky typické pro daný kraj — jídlo, nápoje, řemesla", "Výrobky vyrobené ve velkých továrnách"],
  ...
  },
  {
    ...
    options: ["Vydělávají nejvíce peněz v kraji", "Jsou povinné ze zákona", "Slouží jako úřady státní správy", "Uchovávají historii a kulturu kraje pro budoucí generace"],
  ...
  },
  {
    ...
    correctAnswer: "Dává vodu, dopravu i energii",
    options: ["Dává vodu, dopravu i energii", "Řeka komplikuje dopravu", "Řeka jen způsobuje záplavy", "Řeka nemá na hospodářství vliv"],
  ...
  },
  {
    ...
    options: ["Hospodářství kraje se nemění", "Staré továrny zavírají, přicházejí nové technologie a služby", "Zemědělství vždy roste", "Průmysl je vždy nejdůležitější odvětví"],
