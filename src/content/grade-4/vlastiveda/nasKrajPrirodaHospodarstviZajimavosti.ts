...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Příroda a krajina kraje",
      "Jak lidé v kraji pracují",
      "Historické památky kraje",
  ...
  },
  {
    ...
    options: [
      "Historické hrady a zámky",
      "Chráněná místa se vzácnou přírodou",
      "Továrny a haly v kraji",
      "Silnice a dálnice v kraji",
    ],
...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "Chráněné území se vzácnou přírodou",
      "Průmyslová zóna u města",
      "Sportovní hřiště v obci",
    ],
  ...
  },
  {
    ...
    options: [
      "Historické budovy kraje",
      "Nerosty, půda, voda a lesy",
      "Silniční síť v kraji",
      "Počet obyvatel kraje",
    ],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: [
      ...
      "V nížinách je úrodná půda a tepleji",
      "Hory mají méně slunce",
      "V horách nejsou zásoby vody",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Zvyky a řemesla předávané po generace",
      "Moderní stavby a silnice",
  ...
  },
  {
    ...
    options: [
      ...
      "Dává vodu, dopravu i energii",
      "Řeka jen způsobuje záplavy",
      "Řeka nemá na hospodářství vliv",
    ],
