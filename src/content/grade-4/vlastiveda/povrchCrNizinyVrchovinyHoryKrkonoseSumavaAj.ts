...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: ["Na Šumavě", "V Krkonoších", "V Jeseníkách", "V Beskydech"],
  ...
  },
  {
    ...
    options: ["Horské oblasti nad 1000 m", "Oblasti s hlubokými údolími", "Rovné nízko položené oblasti", "Sopečné oblasti s krátery"],
  ...
  },
  {
    ...
    options: ["Jihomoravská nížina", "Ostravská pánev", "Pardubická kotlina", "Polabská nížina"],
  ...
  },
  {
    ...
    options: ["Drahanská vrchovina", "Českomoravská vrchovina", "Šumava", "Krušné hory"],
  ...
  },
  {
    ...
    options: ["Sněžka – 1603 m", "Lysá hora – 1323 m", "Praděd – 1492 m", "Plechý – 1378 m"],
  ...
  },
  {
    ...
    options: ["Na severovýchodě – u Polska", "Uprostřed Čech", "Na jihovýchodě – u Slovenska", "Na jihozápadě – u Německa a Rakouska"],
  ...
  },
  {
    ...
    options: ["1492 m n. m.", "1603 m n. m.", "1378 m n. m.", "2655 m n. m."],
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: ["Vrchovina je vyšší než hora", "Vrchovina je rovina, hora kopec", "Vrchovina je nižší a oblejší", "Rozdíl je jen v názvu"],
  ...
  },
  {
    ...
    options: ["V Jeseníkách", "V Krkonoších", "V Orlických horách", "V Beskydech"],
  ...
  },
  {
    ...
    options: ["Na severu Moravy u Polska", "Uprostřed Čech u Prahy", "Na severozápadě Čech", "Na jihu Moravy u Rakouska"],
  ...
  },
  {
    ...
    options: ["Morava je hornatější než Čechy", "Morava a Čechy mají stejný terén", "Čechy jsou rovnější než Morava", "Morava je celkově nižší a rovnější než Čechy"],
  ...
  },
  {
    ...
    options: ["Vrchovina na střední Moravě", "Pohoří na jihu Čech", "Nížina v Polabí u Labe", "Horský masiv v Jeseníkách"],
  ...
  },
  {
    ...
    options: ["V Jeseníkách", "V Krušných horách", "V Beskydech", "V Šumavě"],
  ...
  },
  {
    ...
    options: ["Nejvyšší hora Krkonoš", "Jezero na Šumavě", "Nejvyšší hora Šumavy – 1378 m", "Přehrada v jižních Čechách"],
  ...
  },
  {
    ...
    options: ["Leží v nadmořské výšce 0 m", "Čechy jsou velmi ploché", "Jsou to historické hranice", "Ze tří stran je lemují hory"],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: ["Sněžka, Praděd, Plechý, Lysá hora", "Praděd, Sněžka, Lysá hora, Plechý", "Sněžka, Plechý, Praděd, Lysá hora", "Lysá hora, Sněžka, Praděd, Plechý"],
  ...
  },
  {
    ...
    options: ["Jsou nejblíže Praze", "Jsou nejvyššími horami ČR s dostatkem sněhu pro lyžování", "Mají nejhezčí národní park ČR", "Jsou to nejstarší hory ČR"],
  ...
  },
  {
    ...
    options: ["Jsou to mladé hory podobné Alpám", "Vznikly sopečnou činností", "Jsou to staré hory – hercynského stáří — starší než Alpy", "Jsou stejně staré jako Himaláje"],
  ...
  },
  {
    ...
    options: ["Šumava leží blízko moře", "Šumava je sopečná oblast", "Na Šumavě je mnoho přehrad", "Leží na evropském rozvodí"],
  ...
  },
  {
    ...
    options: ["Kopce Beskyd, pastviny a salaše", "Ploché nížiny s obilím", "Průmyslová oblast s doly", "Rovina s velkými rybníky"],
  ...
  },
  {
    ...
    options: ["Je nejblíže ke středu Evropy", "Má největší přehrady v ČR", "Leží nejjižněji a má sprašovou půdu", "Leží přímo u řeky Dunaje"],
  ...
  },
  {
    ...
    options: ["Pohoří na střední Moravě", "Součást pohoří Šumava", "Pohoří v jižních Čechách u Rakouska", "Pohoří v severních Čechách"],
