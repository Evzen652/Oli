...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Sbírka pouze trestních zákonů státu",
      "Základní zákon státu, který určuje práva a povinnosti",
      "Nejnovější zákon schválený vládou",
      "Seznam všech zákonů seřazených podle data",
    ],
  ...
  },
  {
    ...
    options: ["Konstituční monarchie s dědičným králem", "Parlamentní republika", "Vojenská diktatura bez svobodných voleb", "Spolková federace samostatných zemí"],
...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Stát, kde má vláda právo měnit zákony podle potřeby",
      "Stát, kde platí zákony stejně pro všechny — i pro vládu a úředníky",
      "Stát, kde rozhodují soudci bez ohledu na psané zákony",
      "Stát, kde bohatí lidé mají víc práv než ostatní",
    ],
  ...
  },
  {
    ...
    options: [
      "Práva, která uděluje vláda a může je kdykoliv zrušit",
      "Práva, která má každý člověk od narození — nezávisle na státě",
      "Práva, která mají jen občané se stálým pobytem v ČR",
      "Práva, o kterých v každém případě rozhoduje soud",
    ],
  ...
  },
  {
    ...
    options: [
      "Soudy jsou podřízeny prezidentovi a musí plnit jeho pokyny",
      "Soudy rozhodují nezávisle na vládě — nikdo jim nemůže říkat, jak rozhodovat",
      "Soudy jsou součástí vlády a řídí je ministr spravedlnosti",
      "Parlament řídí soudy a schvaluje každý rozsudek",
    ],
  ...
  },
  {
    ...
    options: [
      "Zákon vydá přímo prezident bez hlasování parlamentu",
      "Zákon navrhne poslanec nebo vláda → sněmovna hlasuje → senát schválí → podepíše prezident",
      "Zákon navrhnou občané v referendu a rovnou platí",
      "Zákon vydávají soudy podle vlastního uvážení",
    ],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Zapojit se dá jen účastí ve volbách jednou za čtyři roky",
      "Referendum, petice, demonstrace, aktivní občanství v obcích",
      "Stačí platit daně, víc od občanů demokracie nevyžaduje",
      "Jedině podáním žaloby k soudu, jinak nic nezmůžou",
    ],
