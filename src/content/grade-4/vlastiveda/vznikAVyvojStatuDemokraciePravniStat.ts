...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Vláda krále, který zdědil trůn po předcích",
      "Vláda lidu – řecky demos = lid, kratos = vláda",
      "Vláda církve řízená nejvyšším knězem",
      "Vláda armády po vojenském převratu",
    ],
  ...
  },
  {
    ...
    options: ["Sbírka pouze trestních zákonů státu", "Nejnovější zákon schválený vládou", "Základní zákon státu, který určuje práva a povinnosti", "Seznam všech zákonů seřazených podle data"],
  ...
  },
  {
    ...
    options: ["V roce 1918", "V roce 1968", "V roce 1989", "V roce 1993"],
  ...
  },
  {
    ...
    options: ["Parlamentní republika", "Konstituční monarchie s dědičným králem", "Vojenská diktatura bez svobodných voleb", "Spolková federace samostatných zemí"],
  ...
  },
  {
    ...
    options: [
      "Vláda v čele s premiérem a ministry",
      "Parlament – Poslanecká sněmovna + Senát",
      "Prezident jako hlava státu",
      "Ministerstvo řízené jedním úředníkem",
    ],
  ...
  },
  {
    ...
    options: ["Premiér", "Předseda sněmovny", "Prezident", "Hejtman"],
  ...
  },
  {
    ...
    options: ["Prezident", "Ministr financí", "Předseda sněmovny", "Předseda vlády – premiér"],
  ...
  },
  {
    ...
    options: [
      "Volby, kde smí hlasovat jen bohatí a vzdělaní občané",
      "Volby, kde mohou hlasovat všichni dospělí občané tajně a dobrovolně",
      "Volby, kde je účast povinná a kontrolovaná úřady",
      "Volby, kde předem vyhrává jen jedna povolená strana",
    ],
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: ["Přímá = vláda rozhoduje, zastupitelská = prezident rozhoduje", "Jsou to totéž", "Přímá = lidé rozhodují sami – hlasování ; zastupitelská = volí zástupce, kteří rozhodují", "Přímá je starší forma demokracie v ČR"],
  ...
  },
  {
    ...
    options: ["Seznam povinností daňových poplatníků", "Zákon o volbách", "Zákon o státní symbolice", "Zákon zaručující práva každého člověka v ČR — součást ústavy"],
  ...
  },
  {
    ...
    options: ["Stát, kde platí zákony stejně pro všechny — i pro vládu a úředníky", "Stát, kde má vláda právo měnit zákony podle potřeby", "Stát, kde rozhodují soudci bez ohledu na psané zákony", "Stát, kde bohatí lidé mají víc práv než ostatní"],
  ...
  },
  {
    ...
    options: ["Práva, která uděluje vláda a může je kdykoliv zrušit", "Práva, která mají jen občané se stálým pobytem v ČR", "Práva, o kterých v každém případě rozhoduje soud", "Práva, která má každý člověk od narození — nezávisle na státě"],
  ...
  },
  {
    ...
    options: ["Soudy rozhodují nezávisle na vládě — nikdo jim nemůže říkat, jak rozhodovat", "Soudy jsou podřízeny prezidentovi a musí plnit jeho pokyny", "Soudy jsou součástí vlády a řídí je ministr spravedlnosti", "Parlament řídí soudy a schvaluje každý rozsudek"],
  ...
  },
  {
    ...
    options: [
      "Diskriminace je zakázaná jen na pracovišti, jinde platit nemusí",
      "Všichni lidé mají stejná práva bez ohledu na barvu pleti, pohlaví nebo náboženství",
      "Diskriminace je zakázaná jen ve školách, jinde je dovolená",
      "Zákaz diskriminace platí jen při volbách, jinde ne",
    ],
  ...
  },
  {
    ...
    options: ["Právo mluvit jen česky", "Právo kritizovat jen vládu", "Právo vyjadřovat své názory bez strachu z trestu", "Povinnost říkat pravdu"],
  ...
  },
  {
    ...
    options: ["Zákon vydá přímo prezident bez hlasování parlamentu", "Zákon navrhnou občané v referendu a rovnou platí", "Zákon vydávají soudy podle vlastního uvážení", "Zákon navrhne poslanec nebo vláda → sněmovna hlasuje → senát schválí → podepíše prezident"],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    options: ["Diktatura je rychlejší verze demokracie", "Demokracie = svobodné volby, práva občanů, dělba moci; diktatura = jedna osoba vládne bez kontroly", "V demokracii rozhoduje prezident, v diktatuře parlament", "Diktatury existovaly jen ve starověku"],
  ...
  },
  {
    ...
    options: ["Zapojit se dá jen účastí ve volbách jednou za čtyři roky", "Stačí platit daně, víc od občanů demokracie nevyžaduje", "Referendum, petice, demonstrace, aktivní občanství v obcích", "Jedině podáním žaloby k soudu, jinak nic nezmůžou"],
  ...
  },
  {
    ...
    options: ["Média jsou jen zábava", "Média slouží vládě", "Nezávislá média jsou nebezpečná pro demokracii", "Informují občany a kontrolují vládu — bez svobodných médií není demokracie"],
  ...
  },
  {
    ...
    options: [
      "Nejvyšší soud, který rozhoduje o trestech za nejtěžší zločiny",
      "Soud kontrolující, zda jsou zákony v souladu s ústavou — ochrana práv před nezákonnými zákony",
      "Soud, který řeší jen spory o výsledky voleb a jejich platnost",
      "Soud, který posuzuje spory České republiky s jinými státy",
    ],
  ...
  },
  {
    ...
    options: ["Zákony jsou vždy spravedlivé — nemá cenu je zpochybňovat", "Zákon lze ignorovat, pokud nám nesedí", "Bez dodržování zákonů by společnost nefungovala — změny jdou přes demokratický proces", "Zákony dodržují jen ti, co se bojí trestu"],
