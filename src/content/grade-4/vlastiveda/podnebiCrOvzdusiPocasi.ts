...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: ["Na východě ČR, protože je blíž horám", "Na západě ČR – návětrná strana", "Všude v ČR úplně stejně, žádný rozdíl", "Na jihu ČR, poblíž jižní Moravy"],
...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Letní vedro, které panuje jen v nížinách",
      "Jev, kdy je v kotlinách v zimě chladnější vzduch než na vrcholech hor",
      "Zcela neobvyklé sněžení uprostřed léta",
      "Oblast s mimořádně vysokým množstvím srážek",
    ],
  ...
  },
  {
    ...
    options: [
      "Hory jsou položené mnohem blíže k severu",
      "S rostoucí nadmořskou výškou klesá teplota vzduchu",
      "V horách svítí slunce mnohem méně často",
      "V horách žije mnohem méně lidí",
    ],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Les nemá na místní podnebí vůbec žádný vliv",
      "Les zadržuje vodu, ochlazuje okolí a zvyšuje vlhkost vzduchu",
      "Les naopak zvyšuje teplotu v celém okolí",
      "Les naopak způsobuje sucho v okolní krajině",
    ],
  ...
  },
  {
    ...
    options: [
      "Praha leží podstatně jižněji než celá okolní krajina",
      "Beton a asfalt ukládají teplo, průmysl a doprava produkují teplo — 'tepelný ostrov'",
      "Praha má nad sebou trvale méně oblačnosti než okolí",
      "Praha leží hluboko v nížině, daleko od hor",
    ],
  ...
  },
  {
    ...
    options: [
      "Přirozená kyselost obyčejné dešťové vody",
      "Průmyslové emise SO2 a NOx, které poškozují lesy, půdu a vodní toky",
      "Radioaktivní záření unikající z elektráren",
      "Vodní pára stoupající z teplých oceánů",
    ],
