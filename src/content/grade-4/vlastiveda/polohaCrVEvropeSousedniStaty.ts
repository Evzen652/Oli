...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "Má velký námořní přístav pro lodní dopravu",
      "Leží ve středu Evropy a protínají ji důležité dopravní trasy",
      "Je rozlohou úplně největší zemí celé Evropy",
      "Vyrábí ze všech zemí Evropy nejvíce automobilů",
    ],
  ...
  },
  {
    ...
    options: [
      "Jednoduše jen Český stát, žádný jiný název",
      "Československo – Česká a Slovenská Federativní Republika",
      "Království Čechy, jako za dob králů",
      "Moravsko-Česká republika, spojení Čech a Moravy",
    ],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: [
      "ČR má prý ze všech evropských zemí nejvyšší hory",
      "Většina řek odtéká od ČR do různých moří — ČR leží na hlavním evropském rozvodí",
      "ČR leží na geograficky nejvyšším místě celé Evropy",
      "Z vrcholků hor v ČR je vidět úplně celá Evropa",
    ],
  ...
  },
  {
    ...
    options: [
      "Velká Morava, starší raně středověký stát",
      "Českomoravské království v rámci Rakouska-Uherska",
      "Prosté Království Čechy, samostatné na Rakousku",
      "Přemyslovská dynastie, vládnoucí rod, ne stát",
    ],
  ...
  },
  {
    ...
    options: [
      "Mají prý úplně stejný jazyk bez rozdílu",
      "Po 75 let – 1918–1993 tvořily jeden stát — Československo",
      "Leží prý stále na úplně stejném území",
      "Sdílejí dodnes stejnou platnou měnu",
    ],
  ...
  },
  {
    ...
    options: [
      "Na Šumavě, poblíž městečka Železná Ruda",
      "Trojmezí – trojpomezí v oblasti Krušných hor / Jizerských hor",
      "Na Lysé hoře v Moravskoslezských Beskydech",
      "U města Opavy, na samém severu Moravy",
    ],
