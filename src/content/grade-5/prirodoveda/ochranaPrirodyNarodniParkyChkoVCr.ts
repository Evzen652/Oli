...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Co je CHKO?", correctAnswer: "Chráněná krajinná oblast – území s cennou přírodou, kde je povoleno bydlení a hospodaření s omezeními", options: ["Přísná přírodní rezervace, do které nesmí veřejnost vůbec vstoupit", "Chráněná krajinná oblast – území s cennou přírodou, kde je povoleno bydlení a hospodaření s omezeními", "Název používaný pro pralesy zcela bez lidského zásahu", "Vědecká stanice určená výhradně k výzkumu přírody"], hints: ["CHKO je méně přísná ochrana než národní park."] },
  ...
  { question: "Který národní park leží v Moravě na řece Dyji?", correctAnswer: "NP Podyjí", options: ["NP Podyjí", "NP Šumava", "NP Krkonoše", "NP České Švýcarsko"], hints: ["Přemýšlej, jak se řekne 'kraj kolem řeky Dyje' jedním slovem — národní parky se často jmenují podle místa, kde leží."] },
  ...
  { question: "Co je uhlíková stopa a jak ji snížit?", correctAnswer: "Množství CO₂ vyprodukované naší činností; snížíme ji MHD, méně masa, recyklací", options: ["Stopa zbylá po těžbě uhlí zanechaná v půdě", "Množství CO₂ vyprodukované naší činností; snížíme ji MHD, méně masa, recyklací", "Znečištění vody způsobené průmyslovými procesy továren", "Celkový počet automobilů jezdících po silnicích"], hints: ["Méně CO₂ = menší skleníkový efekt."] },
  ...
  { question: "Jak mohou děti přispět k ochraně přírody?", correctAnswer: "Třídit odpad, šetřit vodou a energií, nekupovat výrobky z ohrožených zvířat, jezdit MHD", options: ["Navštěvovat národní parky co nejčastěji, i vícekrát týdně", "Třídit odpad, šetřit vodou a energií, nekupovat výrobky z ohrožených zvířat, jezdit MHD", "Sázet výhradně exotické, dovezené druhy stromů", "Reportovat všechna zvířata, která uvidí, do záchranných stanic"], hints: ["Každý může přispět malými každodenními kroky."] },
];

const POOL_L2: PracticeTask[] = [
  { question: "Jaký je rozdíl mezi národním parkem a CHKO?", correctAnswer: "NP: přísná ochrana, omezené lidské aktivity, zaměření na přirozené procesy. CHKO: mírnější ochrana, povoleno hospodaření a bydlení s omezeními.", options: ["NP a CHKO jsou prý ve skutečnosti úplně totéž, liší se jen svým názvem", "NP: přísná ochrana, omezené lidské aktivity, zaměření na přirozené procesy. CHKO: mírnější ochrana, povoleno hospodaření a bydlení s omezeními.", "CHKO je prý mnohem přísnější než NP, protože turistům úplně zakazuje vstup", "NP se nacházejí jen v horách, CHKO jen u moře — liší se čistě geograficky"], hints: ["NP = příroda na prvním místě. CHKO = příroda a lidé v rovnováze."] },
...
const POOL_L3: PracticeTask[] = [
  ...
  { question: "Co je princip předběžné opatrnosti při ochraně přírody?", correctAnswer: "Pokud existuje riziko vážného poškození ekosystému, jednáme preventivně, i když vědecké důkazy nejsou zcela jisté – lépe být opatrní než litovat.", options: ["Jednáme jen tehdy, když je škoda už zcela jednoznačně prokázaná a nevratná", "Pokud existuje riziko vážného poškození ekosystému, jednáme preventivně, i když vědecké důkazy nejsou zcela jisté – lépe být opatrní než litovat.", "Princip prý říká, že přírodu necháme, ať se o sebe postará úplně sama bez nás", "Preventivní ochrana se prý aplikuje jen na ohrožené druhy, nikdy na celé ekosystémy"], hints: ["Pesticidy DDT: negativní efekty byly zpočátku neznámé – princip opatrnosti by chránil."] },
  { question: "Jak se liší ochrana in situ a ex situ?", correctAnswer: "In situ: ochrana druhů v jejich přirozeném prostředí (NP, CHKO). Ex situ: ochrana mimo přirozené prostředí – ZOO, botanické zahrady, genové banky .", options: ["In situ prý znamená mezinárodní ochranu, ex situ zase jen národní ochranu", "In situ: ochrana druhů v jejich přirozeném prostředí (NP, CHKO). Ex situ: ochrana mimo přirozené prostředí – ZOO, botanické zahrady, genové banky .", "In situ je prý méně efektivní, ex situ je modernější a mnohem účinnější", "Oba pojmy popisují ochranu jen v chráněných územích, liší se čistě velikostí"], hints: ["Zubr v ZOO (ex situ) → reintrodukce do přírody (in situ)."] },
  { question: "Proč je ochrana mokřadů klíčová pro klimatickou adaptaci?", correctAnswer: "Mokřady zadržují vodu v krajině, filtrují ji, ukládají CO₂ v rašelině a tlumí povodně. Jejich vysušení uvolňuje CO₂ a snižuje odolnost krajiny vůči suchu.", options: ["Mokřady jsou prý ekologicky zcela bezcenná území, vhodná spíš pro zemědělství", "Mokřady zadržují vodu v krajině, filtrují ji, ukládají CO₂ v rašelině a tlumí povodně. Jejich vysušení uvolňuje CO₂ a snižuje odolnost krajiny vůči suchu.", "Mokřady jsou prý důležité jen pro migrující ptáky, jinak jsou zcela bezvýznamné", "Klimatická adaptace prý na mokřadech vůbec nezávisí, závisí pouze a jen na lesích"], hints: ["Rašeliniště váže více CO₂ na plochu než tropický deštný les."] },
];
