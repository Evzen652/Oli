...
const POOL_L3: PracticeTask[] = [
  ...
  { question: "Co by se stalo, kdybychom přestali používat fosilní paliva zítra?", correctAnswer: "Průmysl i doprava by se zastavily, přechod musí být postupný", options: ["Nic dramatického – slunce a vítr by spotřebu pokryly hned.", "Průmysl i doprava by se zastavily, přechod musí být postupný", "Průmysl by přešel na jadernou energii během jednoho roku.", "Oxid uhličitý by ihned klesl a oteplování by se zastavilo."], hints: ["Zvaž, jestli by náhradní zdroje stihly nastoupit ze dne na den."] },
  { question: "Jak funguje vodíkový pohon jako alternativa k elektrickému autu?", correctAnswer: "V palivovém článku vzniká z vodíku a kyslíku elektřina a voda", options: ["Vodík hoří v motoru podobně jako benzín, ale bez CO₂.", "V palivovém článku vzniká z vodíku a kyslíku elektřina a voda", "Vodíkové auto pohání baterie, vodík slouží jen jako záloha.", "Vodík se skladuje jako kapalina a na elektřinu se mění zahřátím."], hints: ["Zamysli se, co vznikne, když se vodík spojí s kyslíkem."] },
