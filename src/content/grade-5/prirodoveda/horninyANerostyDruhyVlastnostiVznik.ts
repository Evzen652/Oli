...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Který nerost je nejměkčí na Mohsově stupnici?", correctAnswer: "Mastek – tvrdost 1", options: ["Mastek – tvrdost 1", "Diamant – tvrdost 10", "Křemen – tvrdost 7", "Apatit – tvrdost 5"], hints: ["Tento nerost je tak měkký, že ho poškrábeš nehtem."] },
  { question: "Jak se jmenuje nejrozšířenější hornina ve stavebnictví?", correctAnswer: "Žula – granit", options: ["Žula – granit", "Vápenec", "Pískovec", "Uhlí"], hints: ["Tahle nejrozšířenější stavební hornina je vyvřelá a tvrdá, ne usazená jako vápenec, pískovec nebo uhlí."] },
  ...
  { question: "Která hornina se používá k výrobě vápna a cementu?", correctAnswer: "Vápenec", options: ["Vápenec", "Žula", "Pískovec", "Rula"], hints: ["K výrobě vápna a cementu potřebujeme usazenou horninu bohatou na vápník, ne tvrdou vyvřelou horninu jako žula, ani pískovec či rula."] },
];

const POOL_L2: PracticeTask[] = [
  { question: "Jaký je rozdíl mezi horninou a nerostem?", correctAnswer: "Hornina je složena z více nerostů nebo z jednoho nerosta s příměsemi; nerost je chemicky homogenní pevná látka s určitým složením", options: ["Nerost je vždy fyzicky větší kus hmoty než jakákoli hornina, ze které pochází", "Hornina je složena z více nerostů nebo z jednoho nerosta s příměsemi; nerost je chemicky homogenní pevná látka s určitým složením", "Horniny jsou vždy geologicky starší než nerosty, ze kterých jsou složené", "Nerosty jsou vždy v kapalném skupenství, zatímco horniny jsou vždy pevné"], hints: ["Žula = hornina složená z křemene, živce a slídy."] },
  ...
  { question: "Jak vzniklo uhlí? Proč se mu říká fosilní palivo?", correctAnswer: "Uhlí vzniklo z odumřelých rostlin, které se po miliony let ukládaly, přikrývaly vrstvami sedimentů a přeměňovaly tlakem a teplem. Jde o uložené zásoby sluneční energie.", options: ["Uhlí vzniklo z krystalů minerálů, které se vysrážely přímo ze sopečné horniny během jejího tuhnutí", "Uhlí vzniklo z odumřelých rostlin, které se po miliony let ukládaly, přikrývaly vrstvami sedimentů a přeměňovaly tlakem a teplem. Jde o uložené zásoby sluneční energie.", "Fosilní znamená, že uhlí obsahuje zkamenělé kosti a schránky pravěkých zvířat, ne rostlin", "Uhlí se tvoří dodnes v bažinách a rašeliništích, celý proces trvá jen zhruba deset krátkých let"], hints: ["Fosilní = 'zkamenělé' zásoby energie z dávné minulosti."] },
  { question: "K čemu slouží nerosty jako křemen, živec a slída v hornině žule?", correctAnswer: "Křemen (šedý, tvrdý), živec (bílý/růžový) a slída – lesklé šupinky tvoří spolu s dalšími nerosty žulu – každý přispívá jiným chemickým složením", options: ["Všechny tři nerosty jsou ve skutečnosti totéž, liší se jen barevným odstínem žuly", "Křemen (šedý, tvrdý), živec (bílý/růžový) a slída – lesklé šupinky tvoří spolu s dalšími nerosty žulu – každý přispívá jiným chemickým složením", "Křemen je jediný důležitý nerost, živec a slída jsou jen bezvýznamné příměsi", "Slída je jediný z těch tří nerostů, který dává žule její typickou červenou barvu"], hints: ["Žula se tím pozná na povrchu – různobarevné krystalky."] },
...
const POOL_L3: PracticeTask[] = [
  { question: "Proč je geologický koloběh hornin důležitý pro Zemi?", correctAnswer: "Horniny se neustále přeměňují – vyvřelé erodují na usazené, ty se přeměňují tlakem, přeměněné se taví zpět na magma. Koloběh recykluje hmotu zemské kůry.", options: ["Geologický koloběh podle některých popisuje pouze sopečnou aktivitu a nic jiného", "Horniny se neustále přeměňují – vyvřelé erodují na usazené, ty se přeměňují tlakem, přeměněné se taví zpět na magma. Koloběh recykluje hmotu zemské kůry.", "Horniny jsou prý úplně trvalé a vůbec se nemění, geologický koloběh je jen teorie", "Koloběh hornin je podle některých rychlý proces, trvá vždy méně než sto let"], hints: ["Horolezec na vrcholu Himalájí stojí na mořských usazeninách."] },
  { question: "Jak se liší ropa a zemní plyn od uhlí, přestože jsou všechny fosilní paliva?", correctAnswer: "Uhlí vzniklo z pevných rostlin na souši. Ropa a zemní plyn vznikly z mikroorganismů v mořích – ropa je kapalná, plyn plynný – jiné podmínky vzniku, jiné skupenství.", options: ["Ropa vzniká přímo z uhlí, když se hluboko v Zemi po miliony let silně zahřeje a roztaví", "Uhlí vzniklo z pevných rostlin na souši. Ropa a zemní plyn vznikly z mikroorganismů v mořích – ropa je kapalná, plyn plynný – jiné podmínky vzniku, jiné skupenství.", "Zemní plyn je na rozdíl od uhlí a ropy plně obnovitelný zdroj, který rychle vzniká znovu", "Všechna tři fosilní paliva jsou ve skutečnosti naprosto totožná, liší se jen svou barvou"], hints: ["Skupenství závisí na podmínkách vzniku."] },
  { question: "Jak může jeden prvek (uhlík) tvořit jak nejměkčí grafit, tak nejtvrdší diamant?", correctAnswer: "Záleží na uspořádání atomů: v grafitu jsou atomy ve vrstvách, které po sobě kloužou (proto je měkký a píše). V diamantu jsou atomy pevně svázány do 3D sítě – proto je nejtvrdší .", options: ["Grafit obsahuje mnohem více atomů uhlíku v každém krystalu než diamant, proto je měkčí", "Záleží na uspořádání atomů: v grafitu jsou atomy ve vrstvách, které po sobě kloužou (proto je měkký a píše). V diamantu jsou atomy pevně svázány do 3D sítě – proto je nejtvrdší .", "Grafit a diamant spolu vůbec nesouvisí, jsou to prý dva úplně odlišné chemické prvky", "Diamant je tvrdší jen proto, že vzniká mnohem hlouběji v zemské kůře, ne kvůli uspořádání atomů"], hints: ["Oba jsou čistý uhlík – liší se jen strukturou."] },
  { question: "Proč jsou nerosty jako zlaté nebo stříbrné žíly v horninách?", correctAnswer: "Hydrotermální roztoky – horká voda s minerály pronikají trhlinami do hornin a při ochlazení minerály krystalizují a usazují se v žilách", options: ["Zlato vzniká přímou chemickou reakcí přímo uvnitř horniny bez jakéhokoli pohybu vody", "Hydrotermální roztoky – horká voda s minerály pronikají trhlinami do hornin a při ochlazení minerály krystalizují a usazují se v žilách", "Zlato a stříbro jsou vzácné, protože je do Země přinesly dopadající asteroidy", "Zlaté žíly jsou zbytky dávné sopečné horniny, která byla mimořádně bohatá na kovy"], hints: ["Voda zahřátá hluboko v zemi rozpouští kovy z okolních hornin a při ochlazování je zpět ukládá v podobě žil."] },
  { question: "Proč jsou přeměněné horniny (metamorfity) jiné od hornin, ze kterých vznikly?", correctAnswer: "Vysoký tlak a teplota (ale bez tavení) přeuspořádají atomy a minerály horniny – vznikají nové minerály a struktury – např. z vápence mramor, ze žuly rula .", options: ["Přeměněné horniny jsou jen tepelně zbarvené jinou barvou, jejich složení zůstává úplně stejné", "Vysoký tlak a teplota (ale bez tavení) přeuspořádají atomy a minerály horniny – vznikají nové minerály a struktury – např. z vápence mramor, ze žuly rula .", "Přeměna probíhá úplným tavením a opětovným tuhnutím, stejně jako u vyvřelých hornin", "Přeměněné horniny vznikají vždy jen na povrchu Země pomalým zvětráváním, ne v hloubce"], hints: ["'Metamorf' = změna formy. Vápenec → mramor: stejný CaCO₃, jiná struktura."] },
];
