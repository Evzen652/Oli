...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Proč klesá množství energie v každém článku potravního řetězce?", correctAnswer: "Každý organismus spotřebuje většinu energie sám pro sebe – dalšímu článku předá jen zlomek", options: ["Každý organismus spotřebuje většinu energie sám pro sebe – dalšímu článku předá dalšímu jen zlomek", "Sluneční energie se v každém článku zesiluje", "Energie se v potravním řetězci nemění – přechází plně", "Rozkladači odebírají část energie z každého článku"], hints: ["Proto jsou velcí dravci vzácní – potřebují velké území."] },
