...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Jak se hmyz množí?", correctAnswer: "Kladením vajíček – vajíčko → larva → kukla → dospělec", options: ["Rodí živá mláďata, podobně jako savci", "Kladením vajíček – vajíčko → larva → kukla → dospělec", "Množí se dělením celého těla na dvě části", "Množí se výtrusy, podobně jako houby"], hints: ["Proměna hmyzu = metamorfóza."] },
  { question: "Jakou funkci mají tykadla hmyzu?", correctAnswer: "Vnímání dotyku, vůní a prostředí kolem", options: ["Pomáhají hmyzu při létání", "Vnímání dotyku, vůní a prostředí kolem", "Trávení přijaté potravy", "Dýchání vzduchu do plic"], hints: ["Tykadla = smyslové orgány hmyzu."] },
  ...
  { question: "Který z těchto živočichů patří mezi měkkýše?", correctAnswer: "Slimák", options: ["Slimák", "Stonožka", "Mnohonožka", "Chrobák"], hints: ["Tento měkkýš je vlastně šnek, ale bez ulity na zádech."] },
...
const POOL_L2: PracticeTask[] = [
  ...
  { question: "Jak pavouci loví kořist bez pohyblivých nohou jako hmyz?", correctAnswer: "Tvoří pavučiny z hedvábí – bílkoviny – kořist se chytí, pavouk ji otráví jedovatými chelicerami a stráví tekutými trávicími šťávami", options: ["Pavouci loví kořist tak, že ji rychle uběhají díky osmi silným nohám", "Tvoří pavučiny z hedvábí – bílkoviny – kořist se chytí, pavouk ji otráví jedovatými chelicerami a stráví tekutými trávicími šťávami", "Pavouci loví jen již mrtvý hmyz a živou kořist vůbec ulovit nedokážou", "Pavouci tvoří pavučiny jenom pro ochranu vajíček, nikdy ne pro lov"], hints: ["Chelicery = kusadla s jedovými žlázami."] },
...
const POOL_L3: PracticeTask[] = [
  { question: "Proč by zmizení hmyzu mělo katastrofální dopad na Zemi?", correctAnswer: "Hmyz je základem potravních řetězců, opyluje 80 % rostlin, rozkládá organiku a je potravou pro ptáky, obojživelníky a savce. Bez hmyzu by se zhroutil ekosystém.", options: ["Zmizení hmyzu by bylo jen drobnou kosmetickou změnou, velcí savci by v klidu přežili", "Hmyz je základem potravních řetězců, opyluje 80 % rostlin, rozkládá organiku a je potravou pro ptáky, obojživelníky a savce. Bez hmyzu by se zhroutil ekosystém.", "Hmyz je prý jen škůdcem zemědělství, bez něj by rostliny naopak produkovaly víc", "Příroda by se prý bez hmyzu snadno přizpůsobila novým podmínkám během deseti let"], hints: ["Vědecké studie: světová biomasa hmyzu klesá o 2,5 % ročně."] },
  ...
  { question: "Proč je chitinový exoskelet hmyzu výhodou i nevýhodou zároveň?", correctAnswer: "Výhoda: ochrana, pevnost, voděodolnost. Nevýhoda: neumožňuje kontinuální růst – hmyz musí svlékat – ekdyze a v té době je zranitelný.", options: ["Exoskelet je podle některých pouze výhoda, chrání hmyz úplně bez nevýhod", "Výhoda: ochrana, pevnost, voděodolnost. Nevýhoda: neumožňuje kontinuální růst – hmyz musí svlékat – ekdyze a v té době je zranitelný.", "Exoskelet je podle některých jen nevýhoda, je těžký a omezuje pohyb hmyzu", "Chitin je prý toxický pro predátory, a proto je jen výhoda i nevýhoda zároveň"], hints: ["Svlékání = nebezpečné, tělo je měkké – proto se hmyz schovává."] },
