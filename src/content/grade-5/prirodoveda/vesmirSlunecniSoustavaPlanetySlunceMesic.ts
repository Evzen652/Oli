...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Jak daleko je Slunce od Země?", correctAnswer: "150 milionů km", options: ["1 500 km", "150 milionů km", "15 000 km", "1,5 milionu km"], hints: ["Světlo letí rychlostí 300 000 km/s."] },
...
const POOL_L2: PracticeTask[] = [
  ...
  { question: "Odkud bere Slunce energii?", correctAnswer: "Ze slučování vodíku na helium", options: ["Z hoření kyslíku v ohni", "Ze slučování vodíku na helium", "Z chemické reakce mezi plyny", "Z výbuchu způsobeného tlakem"], hints: ["Je to jiný proces než hoření – jde o přeměnu jader atomů."] },
  ...
  { question: "Jaký je rozdíl mezi asteroidem a kometou?", correctAnswer: "Kometě u Slunce roste ocas", options: ["Jsou to totéž, jen různá jména", "Kometě u Slunce roste ocas", "Kometa je vždy větší než asteroid", "Asteroid obíhá kolem Měsíce"], hints: ["Ocas komety vzniká sublimací ledu."] },
  ...
  { question: "Proč je Mars červený?", correctAnswer: "Jeho povrch obsahuje oxid železitý – rez", options: ["Jeho povrch obsahuje oxid železitý – rez", "Je pokryt lávou", "Odráží světlo červenou atmosférou", "Je pokryt červenými horninami bez oxidu"], hints: ["Rez, která vzniká na železe, má stejné chemické složení jako to, co barví povrch této planety."] },
  { question: "Co jsou fáze Měsíce?", correctAnswer: "Podoby Měsíce podle osvětlení Sluncem", options: ["Změny polohy Měsíce na obloze", "Podoby Měsíce podle osvětlení Sluncem", "Pohyb Měsíce blíž a dál od Země", "Otočení Měsíce kolem své osy"], hints: ["Nov → Couvající srpek → Čtvrť → Dorůstající → Úplněk."] },
];

const POOL_L3: PracticeTask[] = [
  { question: "Proč je sluneční energie obnovitelná?", correctAnswer: "Bude svítit ještě miliardy let", options: ["Slunce hoří jako dřevo, vydrží 1 000 let", "Bude svítit ještě miliardy let", "Energie vzniká v zemské atmosféře", "Slunce ji dostává od okolních hvězd"], hints: ["Slunce bude svítit ještě asi 5 miliard let."] },
  { question: "Proč ze Země vidíme vždy stejnou stranu Měsíce?", correctAnswer: "Otočí se kolem osy za stejnou dobu", options: ["Vůbec se kolem osy neotáčí", "Otočí se kolem osy za stejnou dobu", "Druhá strana je vždy ke Slunci", "Gravitace Země rotaci zastavila"], hints: ["Tomuto jevu se říká slapová brzda."] },
  ...
  { question: "Proč se Venuše považuje za 'sestru Země', ale přesto je tam život nemožný?", correctAnswer: "Má obrovský skleníkový efekt", options: ["Je moc daleko, a proto studená", "Má obrovský skleníkový efekt", "Nemá vůbec žádnou atmosféru", "Je moc malá, neudrží vodu"], hints: ["CO₂ v atmosféře zachytává teplo jako ve skleníku — jen o hodně silněji."] },
  { question: "Proč je Jupiter tak velký? Co by se stalo, kdyby byl ještě větší?", correctAnswer: "Je z plynů, chybí mu pevný povrch", options: ["Přitáhl do sebe všechny asteroidy", "Je z plynů, chybí mu pevný povrch", "Kdyby byl větší, byl by černá díra", "Je největší, protože je u Slunce"], hints: ["Hmotnost rozhoduje o tom, zda dojde k jaderné fúzi."] },
  ...
  { question: "Čím se liší Uran a Neptun od Jupitera a Saturnu?", correctAnswer: "Mají víc vody, čpavku a metanu", options: ["Jsou pokryti tuhou vrstvou ledu", "Mají víc vody, čpavku a metanu", "Neliší se, je to jen zvyk", "Jsou blíž ke Slunci než Jupiter"], hints: ["Modrá barva Uranu a Neptunu je způsobena metanem."] },
];
