...
const POOL_L1: PracticeTask[] = [
  {
    ...
    options: ["subjektivní popis", "objektivní popis", "pracovní postup", "vyprávění příběhu"],
  ...
  },
  {
    ...
    options: ["podmiňovacím způsobu", "rozkazovacím způsobu", "minulém čase", "budoucím čase"],
  ...
  },
  {
    ...
    options: ["jen čísla a míry", "hodnocení a přirovnání", "jen technické údaje", "jen kroky postupu"],
  ...
  },
  {
    ...
    options: ["v románu a povídce", "v encyklopedii a návodu", "v básni a písni", "v pohádce a bajce"],
  ...
  },
  {
    ...
    options: ["v technickém návodu", "v literatuře a recenzi", "v encyklopedii", "v zákoně a vyhlášce"],
  ...
  },
  {
    ...
    options: ["libovolné pořadí", "pořadí kroků", "emoce a hodnocení", "přirovnání a obrazy"],
  ...
  },
  {
    ...
    options: ["objektivního popisu", "subjektivního popisu", "pracovního postupu", "vyprávění příběhu"],
  ...
  },
  {
    ...
    options: ["objektivního popisu", "pracovního postupu", "subjektivního popisu", "novinové zprávy"],
  ...
  },
  {
    ...
    options: ["vyjadřují emoce autora", "označují pořadí kroků", "spojují věty v souvětí", "popisují barvy věcí"],
  ...
  },
  {
    ...
    options: ["podle minulého času", "podle rozkazů a pořadí", "podle dialogů postav", "podle popisu krajiny"],
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: [
      "Krásné auto, jezdí jako vítr!",
      "délka, výkon, počet sedadel",
      "Popsal bych ho básní.",
  ...
  },
  {
    ...
    options: [
      "Slunce je hvězda.",
      "Zlatá záře zalévala oblohu.",
      "Západ nastává v 19:45.",
      "Slunce se pohybuje rychle.",
    ],
  ...
  },
  {
    ...
    options: ["čistě technický popis", "fakta i trocha zabarvení", "jen pracovní postup", "jen básně o hradu"],
  ...
  },
  {
    ...
    options: ["objektivní", "subjektivní", "pracovní postup", "zpravodajský"],
  ...
  },
  {
    ...
    options: ["subjektivní", "objektivní", "pracovní postup", "poetický"],
  ...
  },
  {
    ...
    options: [
      "jen výškou a barvou vlasů",
      "hodnotícími slovy a obdivem",
      "postupem, jak se hraje",
      "seznamem jeho filmů",
    ],
  ...
  },
  {
    ...
    correctAnswer: "subjektivní popis",
    options: ["objektivní popis", "pracovní postup", "subjektivní popis", "návod k použití"],
  ...
  },
  {
    ...
    correctAnswer: "objektivní popis",
    options: ["subjektivní popis", "objektivní popis", "pracovní postup", "báseň o výrobku"],
  ...
  },
  {
    ...
    options: [
      ...
      "nejprve, poté, nakonec",
      "bylo, stalo se, tehdy",
      "kdyby, pokud, jestliže",
    ],
  ...
  },
  {
    ...
    options: [
      "Moře má hloubku 3 800 m.",
      "Moře se třpytí v barvě safíru.",
      "Moře je plocha slané vody.",
      "Moře je modré i zelené.",
    ],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: [
      "Bábovka se peče v troubě.",
      "Vložte bábovku do trouby.",
      "Bábovka byla v troubě.",
      "Trouba měla 180 stupňů.",
    ],
  ...
  },
  {
    ...
    options: [
      "dynamický zachycuje klid",
      "statický zachycuje klid",
      "statický je vždy delší",
      "obojí znamená totéž",
    ],
  ...
  },
  {
    ...
    options: [
      "lidé jednají jako věci",
      "věci jednají jako lidé",
      "srovnání se slovem jako",
      "objektivní popis osoby",
    ],
  ...
  },
  {
    ...
    options: ["personifikace", "synestezie", "přirovnání", "metafora"],
  ...
  },
  {
    ...
    options: [
      "přesnost nerozhoduje",
      "chyba zkazí výsledek",
      "záleží jen na čtenáři",
      "platí to jen v kuchyni",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Les má plochu 5 ha, rostou tu buky.",
      "Les stojí tiše a tajemně.",
