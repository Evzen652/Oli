...
const POOL_L1: PracticeTask[] = [
  {
    ...
    options: [
      "jen datum napsání dopisu",
      "adresa odesílatele i adresáta",
      "jen podpis odesílatele",
      "jen vlastní text dopisu",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "úřední dopis s prosbou",
      "pozvánka na oslavu",
      "dopis jen s pozdravem",
    ],
  ...
  },
  {
    ...
    options: [
      "hned za označením Věc:",
      "v záhlaví pod adresou",
  ...
  },
  {
    ...
    options: [
      "přikazuje to zákon",
      "čte ji úřad, který rozhoduje",
      "neformální žádost je zakázaná",
      "formální text je vždy kratší",
    ],
...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "napíšeme Ahoj všichni",
      "oslovíme funkci nebo instituci",
      "napíšeme Dobrý den, neznámý",
      "oslovení úplně vynecháme",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "dokument připojený k dopisu",
      "seznam všech adresátů",
  ...
  },
  {
    ...
    options: [
      "aby byl text delší",
      "aby adresát mohl rozhodnout",
      "důvod se vůbec neuvádí",
      "aby dopis vypadal lépe",
    ],
  ...
  },
  {
    ...
    options: [
      "text, podpis, záhlaví",
      "záhlaví, Věc, oslovení, text, závěr",
      "podpis, záhlaví, text",
      "závěr, oslovení, záhlaví",
    ],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: [
      "nářeční forma češtiny",
      "zdvořilé oslovení dospělého",
  ...
  },
  {
    ...
    options: [
      "Čau a měj se hezky!",
      "Děkuji za vyřízení. S úctou",
      "Nashle, ať to vyjde!",
      "Prosím pozdravujte doma.",
    ],
  ...
  },
  {
    ...
    options: [
      "úřední dopis s prosbou",
      "přehled osobních a pracovních údajů",
      "formulář s otázkami",
      "pohlednice z dovolené",
    ],
  ...
  },
  {
    ...
    options: [
      "je to zbytečný prvek",
      "adresát hned pozná téma",
      "nahrazuje pozdrav",
      "nahrazuje podpis",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Dovoluji si vás požádat o snížení...",
      "Potřebuju míň platit.",
      "Prosím, snižte mi to.",
    ],
  ...
  },
  {
    ...
    options: [
      "volná žádost má hotová políčka",
      "tiskopis má hotová políčka",
      "tiskopis nemá podpis",
