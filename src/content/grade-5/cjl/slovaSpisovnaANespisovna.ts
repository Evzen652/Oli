...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "slova, kterými mezi sebou mluví jen mládež",
      "místní varianty jazyka typické pro určitý region",
      "odborná pojmenování používaná ve vědě",
      "slova, která se dnes už běžně nepoužívají",
    ],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "zastarávání a mizení starých slov",
      "přejímání slov / přejaté slovo",
      "tvoření nových slov odvozováním",
      "zhrubění výrazu, tedy vulgarizace",
    ],
  ...
  },
  {
    ...
    options: [
      "zcela nespisovné, ve škole zakázané",
      "hovorové/obecně české, ale přijatelné v mluvené řeči",
      "odborný termín z jazykovědy",
      "nářeční podoba z jižních Čech",
    ],
