...
const VERNOST: Vernost[] = [
  ...
  { text: "Vlak do Brna odjíždí v 8 hodin z třetí koleje.", verne: "Vlak do Brna vyjíždí v 8 hodin ze třetí koleje.", zmena: "Vlak do Brna odjíždí v 9 hodin z třetí koleje.", pridano: "Vlak do Brna odjíždí v 8 hodin z třetí koleje a má jídelní vůz.", opak: "Vlak do Brna dnes nejede.", naCo: "v kolik a odkud souprava vyjíždí" },
  ...
  { text: "Lucka vyhrála závod, protože hodně trénovala.", verne: "Lucka zvítězila v závodě díky poctivému tréninku.", zmena: "Lucka vyhrála závod, protože měla štěstí.", pridano: "Lucka vyhrála závod a dostala zlatý pohár a kolo.", opak: "Lucka závod prohrála, i když trénovala.", naCo: "jak soutěž dopadla a čemu za to vděčí" },
  { text: "Knihovna je v pondělí zavřená, v ostatní dny je otevřená od 9 do 17 hodin.", verne: "Knihovna má zavřeno v pondělí, ostatní dny otvírá v 9 a zavírá v 17 hodin.", zmena: "Knihovna je v neděli zavřená, jinak je otevřená od 9 do 17 hodin.", pridano: "Knihovna je v pondělí zavřená, jinak je otevřená od 9 do 17 hodin a půjčuje i hry.", opak: "Knihovna je otevřená jen v pondělí.", naCo: "který den se nechodí a jaká je otevírací doba" },
  ...
  { text: "Sova loví v noci, ve dne spí v dutině stromu.", verne: "Sova přes den odpočívá ve stromové dutině a na lov vyráží v noci.", zmena: "Sova loví ve dne a v noci spí v dutině stromu.", pridano: "Sova loví v noci myši i zajíce a ve dne spí v dutině stromu.", opak: "Sova v noci spí a vůbec neloví.", naCo: "kdy pták loví a kde tráví den" },
