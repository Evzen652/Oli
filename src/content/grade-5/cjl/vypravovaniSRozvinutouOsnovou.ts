...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "klidný začátek děje",
      "nejnapínavější okamžik",
      "úvod s popisem místa",
      "rozuzlení konfliktu",
    ],
  ...
  },
  {
    ...
    options: [
      "je vždy kratší než jiná",
      "dělí části na podčásti",
      "vynechává celý závěr",
      "má jen holé body bez popisu",
    ],
  ...
  },
  {
    ...
    options: [
      "odborné termíny v textu",
      "citovaná slova v uvozovkách",
      "mnoho přídavných jmen",
      "vědecká fakta a čísla",
    ],
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: [
      "I. Pes, II. Rodina, III. Konec",
      "I. Úvod, II.A Zmizení, II.B Hledání",
      "I. Popis psa, II. Dialog",
      "jen seznam událostí",
    ],
  ...
  },
  {
    ...
    options: [
      "každý bod je jedno slovo",
      "každý bod je stručná věta",
      "jsou to jen přídavná jména",
      "body se vůbec nepíšou",
    ],
  ...
  },
  {
    ...
    options: [
      "až ve vyvrcholení",
      "v úvodu a začátku zápletky",
      "výhradně v závěru",
      "ve všech částech stejně",
    ],
  ...
  },
  {
    ...
    options: [
      "přímá řeč je zakázaná",
      "osnova je jen plán",
      "osnova ji nemá nikdy",
  ...
  },
  {
    ...
    options: [
      "napětí hned od začátku klesá",
      "napětí roste a pak klesá",
      "vyvrcholení je na začátku",
      "napětí je stále stejné",
    ],
  ...
  },
  {
    ...
    options: [
      "odděluje je prázdný řádek",
      "napětí se stupňuje postupně",
      "vyvrcholení je vždy kratší",
      "mezi nimi je vždy dialog",
    ],
  ...
  },
  {
    ...
    options: [
      "začneme popisem počasí",
      "čtenáře vhodíme do akce",
      "začneme až rozuzlením",
      "vynecháme celý závěr",
    ],
  ...
  },
  {
    ...
    options: [
      "popis má děj, vyprávění ne",
      "vyprávění má děj, popis ne",
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: [
      "druh úvodní zápletky",
      "kratší příběh uvnitř většího",
      "zvláštní typ osnovy",
      "závěrečné poučení díla",
    ],
  ...
  },
  {
    ...
    options: [
      "text má správnou délku",
      "děj roste a logicky se uzavře",
      "je v něm hodně přídavných jmen",
      "postavy mají jména",
    ],
  ...
  },
  {
    ...
    options: [
      "vrchol napětí příběhu",
      "úvod s postavami a místem",
      "doslov po hlavním ději",
  ...
  },
  {
    ...
    options: [
      "text je tím delší",
      "udrží čtenáře v napětí",
      "je to autorova chyba",
      "zkrátí se tím závěr",
    ],
  ...
  },
  {
    ...
    options: [
      "I. Výlet, II. Třída, III. Autobus",
      "I. Přípravy, II.A Cesta, II.B Příjezd",
      "jen seznam událostí za sebou",
      "jen datum a cíl výletu",
    ],
