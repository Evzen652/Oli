...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "1 – jen chodil bych, ostatní nepočítá",
      "2 – chodil bych, měl bych – ale 'kdybych' obsahuje by",
      "3 – počítá i sloveso mít v jiném tvaru",
      "0 – ve větě prý žádný podmiňovací tvar není",
    ],
  ...
  },
  {
    ...
    options: ["je – jako v oznamovacím způsobu", "byl by / byla by / bylo by", "buď – jako v rozkazovacím způsobu", "bývá by – špatně utvořený tvar"],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: [
      "rozkazovací, protože 'ať' je vždy rozkaz",
      "oznamovací – zde jako přací/neosobní konstrukce s 'ať'",
      "podmiňovací, protože ve větě je přání",
      "neurčitek – slovesný tvar bez osoby",
    ],
  ...
  },
  {
    ...
    options: [
      "rozkazovací způsob, i když chybí vykřičník",
      "oznamovací způsob – otázka s oznamovacím tvarem – zdvořilá prosba",
      "podmiňovací způsob, protože je to zdvořilé",
      "neurčitek, protože věta je v otázce",
    ],
  ...
  },
  {
    ...
    options: [
      "bez- + tvar rozkazovacího způsobu",
      "ne- + tvar rozkazovacího způsobu – nepiš, nečti, nepij",
      "un- + tvar, jako v angličtině",
      "záporný rozkazovací způsob neumíme vůbec vytvořit",
    ],
  ...
  },
  {
    ...
    options: [
      "jen šel bych je podmínka, kdybych věděl je důsledek",
      "kdybych věděl = podmínka; šel bych = důsledek; oboje podmiňovací způsob",
      "kdybych věděl = oznamovací, šel bych = podmiňovací",
      "jen kdybych je podmiňovací, věděl a šel jsou oznamovací",
    ],
  ...
  },
  {
    ...
    options: [
      "liší se jen délkou věty, významově jsou stejné",
      "přítomný = podmínka platná nyní/v budoucnu; minulý = podmínka, která nenastala",
      "minulý způsob je jen zdvořilejší varianta přítomného",
      "přítomný způsob se prý vždy tvoří se slovem 'bys'",
    ],
  ...
  },
  {
    ...
    options: [
      "oznamovací způsob, ten prý čas nevyjadřuje",
      "rozkazovací způsob – vztahuje se k okamžiku příkazu",
      "podmiňovací způsob, ten prý čas nevyjadřuje",
      "neurčitek – infinitiv, například 'dělat'",
    ],
