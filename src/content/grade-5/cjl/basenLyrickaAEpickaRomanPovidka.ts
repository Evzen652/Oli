...
const POOL_L1: PracticeTask[] = [
  {
    ...
    options: [
      "báseň s příběhem a postavami",
      "báseň o pocitech a náladách, bez děje",
      "báseň o historické události",
      "báseň určená jen dětem",
    ],
  ...
  },
  {
    ...
    options: [
      "báseň bez děje, jen o pocitech",
      "báseň jen o přírodě a krajině",
      "báseň s příběhem a dějem",
      "báseň psaná z pohledu zvířete",
    ],
  ...
  },
  {
    ...
    options: [
      "kratší próza s jedním příběhem",
      "delší próza s více postavami",
      "báseň psaná v próze",
      "hra určená pro divadlo",
    ],
  ...
  },
  {
    ...
    options: [
      "delší próza s více příběhy",
      "kratší próza s jedním příběhem",
      "báseň s pravidelným rýmem",
      "hra určená pro divadlo",
    ],
  ...
  },
  {
    ...
    options: [
      "povídka je delší a složitější",
      "román je delší a složitější",
      "povídka je vždy jen o dětech",
      "román musí být sci-fi",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "epická báseň s tragickým dějem",
      "veselá báseň pro děti",
      "pohádka psaná ve verších",
    ],
  ...
  },
  {
    ...
    options: [
      "epické básně o hrdinech",
      "lyrické básně o lásce",
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: [
      "báseň jen s pocity, bez děje",
      "báseň jen s dějem, bez pocitů",
      "báseň s pocity i s dějem",
      "pohádka psaná ve verších",
    ],
  ...
  },
  {
    ...
    options: [
      "dílo o skutečné historii",
      "dílo s fantastickými prvky",
      "text popisující vědecký pokus",
      "hra určená pro divadlo",
    ],
  ...
  },
  {
    ...
    options: [
      "próza o dávné historii",
      "próza o budoucnosti a technice",
      "báseň o vesmírné krajině",
      "pohádka o kouzelnících",
    ],
  ...
  },
  {
    ...
    options: [
      "balada je próza, povídka báseň",
      "povídka je próza, balada báseň",
      "obojí je psáno ve verších",
      "liší se jen svou délkou",
    ],
  ...
  },
  {
    ...
    options: [
      "próza ze skutečné minulosti",
      "próza ze smyšleného světa s magií",
      "pohádka jen pro malé děti",
      "veršovaný hrdinský příběh",
    ],
  ...
  },
  {
    ...
    options: [
      "vyprávění o jiné osobě",
      "vyprávění autora o sobě",
      "smyšlený životní příběh",
      "báseň o vlastních pocitech",
    ],
  ...
  },
  {
    ...
    options: [
      "je psaná souvislou prózou",
      "její básně vyprávějí příběh",
      "obsahuje jen popisy přírody",
      "je určená pro divadlo",
    ],
  ...
  },
  {
    ...
    options: [
      "žánr o skutečné historii",
      "žánr zaměřený na strach a napětí",
      "poezie o přírodních náladách",
      "vyprávění s veselým koncem",
    ],
  ...
  },
  {
    ...
    options: [
      "více postav a složitější děj",
      "méně postav a jednodušší děj",
      "vždy veršovanou podobu",
      "povinně tragický konec",
    ],
  ...
  },
  {
    ...
    options: [
      "dlouhý román o historii",
      "vtipný článek v novinách",
      "báseň otištěná v novinách",
      "vědecká studie v časopise",
    ],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: [
      "epika je bez děje, lyrika s dějem",
      "lyrika je bez děje, epika s dějem",
      "obojí vždy vypráví příběh",
      "liší se jen svou délkou",
    ],
  ...
  },
  {
    ...
    options: [
      "dílo určené jen ke čtení",
      "dílo určené pro divadlo",
      "báseň přednášená zpaměti",
      "vyprávění v próze",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "texty psané běžnými větami",
      "texty s pravidelným rýmem",
      "texty určené jen k recitaci",
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "to, co chtěl autor sdělit",
      "počet kapitol v knize",
