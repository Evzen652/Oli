...
const POOL_L1: PracticeTask[] = [
  {
    ...
    options: ["text pro estetický zážitek", "text s přesnými fakty", "návod k použití přístroje", "zpráva o dnešním počasí"],
  ...
  },
  {
    ...
    correctAnswer: "věcný",
    options: ["umělecký", "poetický", "beletristický", "věcný"],
  ...
  },
  {
    ...
    options: ["věcný odborný", "umělecký", "poetický", "beletristický"],
  ...
  },
  {
    ...
    options: ["umělecký", "poetický", "věcný publicistický", "beletristický"],
  ...
  },
  {
    ...
    correctAnswer: "umělecký",
    options: ["věcný", "odborný", "publicistický", "umělecký"],
  ...
  },
  {
    ...
    correctAnswer: "věcný",
    options: ["věcný", "umělecký", "poetický", "beletristický"],
  ...
  },
  {
    ...
    correctAnswer: "věcný odborný",
    options: ["umělecký", "poetický", "beletristický", "věcný odborný"],
  ...
  },
  {
    ...
    options: ["umělecký je obrazný, věcný přesný", "umělecký je přesný, věcný obrazný", "věcný je vždy kratší", "obojí je zcela stejné"],
  ...
  },
  {
    ...
    options: ["odborný vědecký text", "novinové zpravodajství", "umělecká próza", "sbírka básní"],
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: ["text o dávné minulosti", "báseň otištěná v novinách", "návod k domácímu spotřebiči", "text o aktuálních událostech"],
  ...
  },
  {
    ...
    options: ["text s přesnou terminologií", "text bez odborných pojmů", "text psaný obrazným jazykem", "text určený malým dětem"],
  ...
  },
  {
    ...
    options: ["úvaha psaná u stolu doma", "vymyšlený příběh o události", "zpráva přímo z místa události", "seznam údajů v tabulce"],
  ...
  },
  {
    ...
    options: ["krátká novinová zpráva", "odborný výzkumný článek", "vyprávění smyšleného děje", "úvaha autora nad tématem"],
  ...
  },
  {
    ...
    options: ["podle obrazného jazyka", "podle délky textu", "podle počtu čísel", "podle jména autora"],
  ...
  },
  {
    ...
    options: ["umělecká povídka o vaření", "báseň o jídle", "věcný text s postupem", "odborná studie o výživě"],
  ...
  },
  {
    ...
    options: ["vědecká studie o minulosti", "vymyšlený příběh o hrdinovi", "sbírka dopisů cizích lidí", "vzpomínky autora na svůj život"],
  ...
  },
  {
    ...
    options: ["věda vysvětlená srozumitelně", "věda psaná jen pro odborníky", "vymyšlený příběh o vědcích", "báseň o vědeckém objevu"],
  ...
  },
  {
    ...
    options: ["neutrální a přesný", "odborný s termíny", "obrazný a citový", "strohý a úřední"],
  ...
  },
  {
    ...
    options: ["ne, téma určuje typ textu", "ano, rozhoduje délka textu", "ne, obojí je vždy umělecké", "ano, rozhoduje účel textu"],
  ...
  },
  {
    ...
    options: ["věcný text hodnotící dílo", "umělecká povídka o autorovi", "báseň napsaná o knize", "vymyšlený rozhovor s autorem"],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: ["je od stejného autora", "má stejný počet stran", "cituje ho nebo na něj naráží", "vyšel ve stejném roce"],
  ...
  },
  {
    ...
    options: ["liší se jen délka", "liší se jen nadpis", "nijak se to neliší", "liší se účel a jazyk"],
  ...
  },
  {
    ...
    options: ["text přesvědčující o názoru", "text popisující fakta", "text bavící čtenáře", "text s návodem k práci"],
  ...
  },
  {
    ...
    options: ["chvála pomocí humoru", "věcný popis bez hodnocení", "kritika pomocí humoru", "vyprávění pro nejmenší"],
  ...
  },
  {
    ...
    options: ["liší se pravdivostí", "liší se jen délkou", "vůbec se od sebe neliší", "liší se srozumitelností"],
  ...
  },
  {
    ...
    options: ["vymyšlené příběhy a světy", "pravdivý záznam událostí", "sbírka ověřených faktů", "návod k použití věci"],
  ...
  },
  {
    ...
    options: ["text psaný ve verších", "text bez jakéhokoli humoru", "text s opačným smyslem", "text s přesnými fakty"],
  ...
  },
  {
    ...
    options: ["jen informuje o produktu", "jen baví obrazným jazykem", "nedělá ani jedno z toho", "informuje i přesvědčuje"],
  ...
  },
  {
    ...
    options: ["příběh o špatné budoucnosti", "příběh o krásné budoucnosti", "příběh o dávné minulosti", "příběh bez jakéhokoli děje"],
