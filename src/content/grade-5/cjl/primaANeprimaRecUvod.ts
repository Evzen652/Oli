...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "věta, která je celá v uvozovkách",
      "věta, která uvádí přímou řeč (říká, kdo mluví)",
      "vždy jen první věta celého odstavce",
      "věta, ve které chybí sloveso",
    ],
  ...
  },
  {
    ...
    options: [
      "já zůstane úplně stejné jako v přímé řeči",
  ...
  },
  {
    ...
    options: [
      "hned za uvozovkami, mimo přímou řeč",
      "uvnitř uvozovek, před uvozovací větou",
      "až za slovem babička na konci věty",
      "nikde, v té větě žádná čárka není",
    ],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "není to vůbec pravda, časování se nikdy nemění",
      "protože přímá řeč je z pohledu mluvčího (já), nepřímá z pohledu vypravěče (on/ona)",
      "protože nepřímá řeč zní prostě zdvořileji",
      "záleží jen na tom, jaké je použité sloveso",
    ],
  ...
  },
  {
    ...
    options: [
      "vykřičník tam zůstane úplně beze změny",
      "vykřičník mizí, obsah se vyjádří opisem (že, aby, jak...)",
      "vykřičník se vždy změní na otazník",
      "vykřičník jednoduše nahradí tečku",
    ],
