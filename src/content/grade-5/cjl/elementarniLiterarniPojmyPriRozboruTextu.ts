...
const POOL_L1: PracticeTask[] = [
  {
    ...
    options: ["hlavní myšlenka díla", "název díla na obálce", "jméno autora knihy", "počet stran knihy"],
  ...
  },
  {
    ...
    options: ["místo, kde se děj odehrává", "hlavní myšlenka díla", "ten, kdo v příběhu jedná", "shoda zvuků na konci veršů"],
  ...
  },
  {
    ...
    options: ["hlavní myšlenka díla", "ten, kdo příběh vypráví", "počet postav v ději", "místo a čas děje"],
  ...
  },
  {
    ...
    options: ["sled událostí v příběhu", "hlavní myšlenka díla", "místo a čas příběhu", "jméno autora knihy"],
  ...
  },
  {
    ...
    options: ["celá báseň dohromady", "skupina řádků básně", "jeden řádek básně", "dvě rýmující se slova"],
  ...
  },
  {
    ...
    options: ["jeden řádek básně", "celá báseň dohromady", "dvě rýmující se slova", "skupina veršů"],
  ...
  },
  {
    ...
    options: ["shoda zvuků na konci veršů", "počet slabik ve verši", "hlavní téma básně", "délka jednoho verše"],
  ...
  },
  {
    ...
    options: ["první verš básně", "poslední verš básně", "opakující se verš", "verš s nejdelším rýmem"],
  ...
  },
  {
    ...
    options: ["1. osobě – já", "2. osobě – ty", "1. osobě množného čísla", "3. osobě – on/ona/oni"],
  ...
  },
  {
    ...
    options: ["vypravěč je postava a mluví jako já", "vypravěč stojí mimo příběh", "vypravěč mluví o jiné osobě", "vypravěč oslovuje čtenáře"],
  ...
  },
  {
    ...
    options: ["hlavní kladná postava", "vedlejší veselá postava", "postava stojící proti hrdinovi", "vypravěč celého příběhu"],
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: ["vždy sám autor básně", "hlavní postava příběhu", "čtenář, který báseň čte", "hlas, který v básni mluví"],
  ...
  },
  {
    ...
    options: ["popis vlastností a chování", "jméno a věk postavy", "seznam činů postavy", "místo, kde postava žije"],
  ...
  },
  {
    ...
    options: ["autor vlastnosti přímo pojmenuje", "postava si dává přezdívky", "čtenář si je odvodí z chování", "vlastnosti určí jiná postava"],
  ...
  },
  {
    ...
    options: ["hlavní myšlenka díla", "jazyk, kterým je psáno", "počet postav v díle", "uspořádání částí díla"],
  ...
  },
  {
    ...
    options: ["příběh se skrytým významem", "příběh bez skrytého významu", "opakování hlásky na začátku", "shoda zvuků na konci veršů"],
  ...
  },
  {
    ...
    options: ["opakování stejného prvku", "pravidelné střídání přízvuků", "postavení protikladů vedle sebe", "zjemnění nepříjemné zprávy"],
  ...
  },
  {
    ...
    options: ["přenesené pojmenování bez jako", "opakování slova na začátku", "záměrné přehánění skutečnosti", "srovnání pomocí slova jako"],
  ...
  },
  {
    ...
    options: ["přenesené pojmenování bez jako", "srovnání pomocí slova jako", "opakování slova na konci", "zjemnění nepříjemné zprávy"],
  ...
  },
  {
    ...
    options: ["záměrné zmenšování", "srovnání pomocí jako", "záměrné přehánění", "zjemnění nepříjemné zprávy"],
  ...
  },
  {
    ...
    options: ["záměrné přehánění skutečnosti", "opakování slova na začátku", "spojení protikladných slov", "zjemnění nepříjemné zprávy"],
  ...
  },
  {
    ...
    options: ["opakování slova na začátku veršů", "opakování slova na konci veršů", "shoda zvuků na konci veršů", "pravidelné střídání přízvuků"],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: ["srovnání pomocí slova jako", "přenesené pojmenování", "výrok s opačným smyslem", "záměrné přehánění"],
  ...
  },
  {
    ...
    options: ["mírná, laskavá ironie", "srovnání pomocí jako", "spojení protikladných slov", "ostrá, zraňující ironie"],
  ...
  },
  {
    ...
    options: ["opakování slova na konci veršů", "opakování slova na začátku veršů", "opakování hlásky na začátku slov", "shoda zvuků na konci veršů"],
  ...
  },
  {
    ...
    options: ["prolínání různých smyslů", "srovnání pomocí slova jako", "spojení protikladných slov", "opakování slova na začátku"],
  ...
  },
  {
    ...
    options: ["příběh bez jakéhokoli poučení", "báseň s tragickým koncem", "vyprávění o vlastním životě", "příběh s poučením"],
  ...
  },
  {
    ...
    options: ["opakující se motiv v díle", "jednorázový nápad autora", "shoda zvuků na konci veršů", "srovnání pomocí slova jako"],
  ...
  },
  {
    ...
    options: ["citové otupení diváka", "poučení na konci díla", "citová očista diváka", "shrnutí děje pro diváka"],
  ...
  },
  {
    ...
    options: ["děj se vrací do minulosti", "děj začíná až závěrem", "děj nemá žádné pořadí", "děj postupuje podle času"],
  ...
  },
  {
    ...
    options: ["děj se vrací do minulosti", "děj postupuje podle času", "děj je zcela bez pořadí", "děj se odehrává v budoucnu"],
