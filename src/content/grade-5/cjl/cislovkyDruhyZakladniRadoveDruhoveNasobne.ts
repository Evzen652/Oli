...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "tři = počet sad, troje = počet kusů",
      "tři = počet kusů, troje = počet sad",
      "tři i troje znamenají totéž",
      "tři je číslovka, troje je příslovce",
    ],
  ...
  },
  {
    ...
    correctAnswer: "pěti",
    options: ["pátých", "pětkrát", "pěti", "patery"],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "tři je vždy nespisovný tvar",
      "rukavice se počítají po sadách",
      "záleží na nářečí",
      "obojí lze zaměnit",
    ],
