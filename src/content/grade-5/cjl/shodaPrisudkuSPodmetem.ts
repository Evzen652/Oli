...
const POOL_L1: FillItem[] = [
  ...
  { sentence: "Bratři ___ na výlet.", blank: "šli", options: ["šli", "šly", "šla", "šlo"], hint: "Bratři = mužský životný → -i." },
  { sentence: "Sestry ___ na výlet.", blank: "šly", options: ["šly", "šli", "šla", "šlo"], hint: "Sestry = ženský rod → -y." },
...
const POOL_L2: FillItem[] = [
  ...
  { sentence: "Lucie a Pavel ___ do kina.", blank: "šli", options: ["šli", "šly", "šla", "šlo"], hint: "Pavel = mužský životný → skupina -i." },
  ...
  { sentence: "Babička a dědeček ___ na zahradu.", blank: "šli", options: ["šli", "šly", "šla", "šlo"], hint: "Dědeček = mužský životný → skupina -i." },
  { sentence: "Paní a páni ___ do kina.", blank: "šli", options: ["šli", "šly", "šla", "šlo"], hint: "Páni = mužský životný → -i." },
  ...
  { sentence: "Jana a Honza ___ do obchodu.", blank: "šli", options: ["šli", "šly", "šla", "šlo"], hint: "Honza = mužský životný → skupina -i." },
