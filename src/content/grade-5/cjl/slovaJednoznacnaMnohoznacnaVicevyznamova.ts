...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "má jen jeden jediný možný význam – stromy",
      "vícero stromů pohromadě, ale i typ šachové figurky – věž v nářečí",
      "znamená vždy jen houby rostoucí v lese",
      "znamená vždy jen přírodu jako celek",
    ],
  ...
  },
  {
    ...
    options: [
      "jen jeden jediný – vždy jen část těla",
      "více – část těla, ale i způsob označení v kartách apod.",
      "žádný, protože to vůbec není slovo",
      "přesně tři významy, ani víc, ani míň",
    ],
  ...
  },
  {
    ...
    options: [
      "jen ozdobu na hlavě panovníka",
      "českou měnu i ozdobu na hlavě panovníka",
      "jen českou peněžní měnu",
      "vždy jen druh stromu",
    ],
...
const POOL_L2: PracticeTask[] = [
  {
    ...
    options: [
      "fotbalová branka na hřišti",
      "velká vchodová závora nebo vstup",
      "brána do nebeského ráje",
  ...
  },
  {
    ...
    options: [
      "vzácný druh drahého kamene",
      "starou délkovou míru – palec = cca 2,54 cm",
      "zvláštní způsob psaní na stroji",
      "konkrétní typ zimního oblečení",
    ],
...
const POOL_L3: PracticeTask[] = [
  ...
  },
  {
    ...
    options: [
      "právě umytou hlavu vlasů",
      "bez předsudků, se svěžím myšlením",
      "úplně holou hlavu bez vlasů",
      "hlavu s pěkně upraveným účesem",
    ],
  ...
  },
  {
    ...
    options: [
      "tvrdou zubní sklovinu",
      "ničivé působení času – přenesený smysl",
      "ozubené kolo ve stroji",
      "určitý typ řezných nástrojů",
    ],
  ...
  },
  {
    ...
    options: [
      "jednoznačné má naopak vždy víc výkladů",
      "vícevýznamové má více číslovaných výkladů, jednoznačné jen jeden",
      "ve slovníku mezi nimi nejsou vůbec žádné rozdíly",
      "záleží to jen na délce daného slova",
    ],
