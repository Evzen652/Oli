...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    correctAnswer: "já",
    options: ["já", "ty", "čtu", "věta nemá podmět"],
  ...
  },
  {
    ...
    correctAnswer: "já",
    options: ["já a ty", "zpívám", "já", "tancuji"],
  ...
  },
  {
    ...
    options: ["babička", "děda", "babička a děda", "lavička"],
  ...
  },
  {
    ...
    options: [
      ...
      "vždy je to 'já'",
      "věta bez napsaného podmětu žádný podmět nemá",
    ],
  ...
  },
  {
    ...
    correctAnswer: "vy",
    options: ["já", "vy", "mlčte", "věta nemá podmět"],
  ...
  },
  {
    ...
    options: ["Lucie", "Tomáš a Ondřej", "Lucie, Tomáš a Ondřej", "voda"],
...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    correctAnswer: "žádný",
    options: ["vítr a sníh", "žádný", "ono", "počasí"],
  ...
  },
  {
    ...
    correctAnswer: "já",
    options: ["já a ty", "já", "přijdu", "pomůžu"],
  ...
  },
  {
    ...
    options: [
      "maminka je hlavní podmět",
      "mezi podměty je tatínek – mužský rod",
      "podměty jsou dva",
  ...
  },
  {
    ...
    options: [
      ...
      "podmět je několikanásobný, tedy množné číslo",
  ...
  },
  {
    ...
    options: [
      "věta, která má podmět skrytý v koncovce slovesa",
      "věta, která nemá podmět vyjádřený ani nevyjádřený",
      "věta, která nemá přísudek, jen podmět",
      "věta, která vyjadřuje příkaz nebo zákaz",
    ],
  ...
  },
  {
    ...
    options: [
      "protože jsou tři podměty",
      "Pavel je mužský rod životný",
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: [
      "oba podměty jsou ženského rodu",
      "podmětem je jen sestra",
      "podmětem je jen 'ona'",
      "rozhoduje sloveso, ne podmět",
    ],
  ...
  },
  {
    ...
    options: ["to – ukazovací zájmeno", "udělal – sloveso", "kdo – tázací zájmeno", "věta podmět nemá"],
  ...
  },
  {
    ...
    options: ["nepřišel – sloveso", "nikdo – záporné zájmeno", "nevyjádřený podmět 'já'", "věta podmět nemá"],
  ...
  },
  {
    ...
    options: ["zdravé – přídavné jméno", "je – sloveso", "zpívat – infinitiv", "věta podmět nemá"],
  ...
  },
  {
    ...
    options: [
      "protože je tam nejvíc koček",
      "mezi podměty je pes – mužský rod životný",
      "'utekli' je jediný možný tvar",
      "protože křeček stojí poslední",
    ],
  ...
  },
  {
    ...
    options: [
      "délku podmětu ve slabikách",
      "shodu přísudku s podmětem",
      "pořadí podmětu ve větě",
  ...
  },
  {
    ...
    correctAnswer: "ty",
    options: ["co", "nového", "ty", "věta podmět nemá"],
  ...
  },
  {
    ...
    options: [
      ...
      "ano, oba jsou životní",
      "ne, oba jsou neživotní",
      "životný je jen tatínek",
    ],
