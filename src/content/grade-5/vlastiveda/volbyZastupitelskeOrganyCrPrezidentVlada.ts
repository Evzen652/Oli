...
const POOL_L1: PracticeTask[] = [
  ...
  },
  {
    ...
    options: ["6 let", "5 let", "2 roky", "4 roky"],
  ...
  },
  {
    ...
    correctAnswer: "5 let",
    options: ["5 let", "4 roky", "6 let", "7 let"],
  ...
  },
  {
    ...
    options: ["Parlament – Sněmovna a Senát", "Přímo občané v přímé volbě", "Vláda", "Jmenuje ho EU"],
  ...
  },
  {
    ...
    options: ["16 let", "21 let", "18 let", "15 let"],
  ...
  },
  {
    ...
    options: ["Vydávat nové zákony místo parlamentu", "Rozhodovat sama o vyhlášení války nebo míru", "Volit prezidenta místo občanů v přímé volbě", "Řídit stát — vykonávat zákony a spravovat jednotlivá ministerstva"],
  ...
  },
  {
    ...
    options: ["Prezidentovi", "Poslanecké sněmovně", "Senátu", "Ústavnímu soudu"],
  ...
  },
  {
    ...
    options: ["Veřejné hlasování zdvižením ruky", "Online hlasování", "Tajné hlasování", "Ústní hlasování"],
  ...
  },
  {
    ...
    options: ["Nejvyšší soud, který rozhoduje jen o nejtěžších trestných činech", "Správní soud, který řeší jen spory o daních a poplatcích", "Soud, který řeší jen stížnosti na výsledky voleb", "Soud, který dohlíží na dodržování Ústavy a chrání základní práva"],
...
const POOL_L2: PracticeTask[] = [
  ...
  },
  {
    ...
    options: ["Parlament není schopný vybrat prezidenta", "Přímá volba dává prezidentovi silnější demokratický mandát od lidu", "Je to levnější než parlamentní volba", "EU nařídila přímou volbu prezidenta"],
  ...
  },
  {
    ...
    options: ["Jsou to v podstatě totéž — oba společně přímo řídí celou vládu", "Premiér je nadřazen prezidentovi a jmenuje ho do funkce", "Prezident = hlava státu (ceremoniální + jmenovací role); premiér = šéf vlády – výkonná moc", "Prezident osobně řídí jednotlivá ministerstva místo premiéra"],
  ...
  },
  {
    ...
    options: ["Je to jen dlouholetá tradice, která nemá žádný praktický účel", "Usnadňuje a urychluje sčítání odevzdaných hlasů", "Je to jedna z povinných podmínek pro vstup do EU", "Chrání voliče před tlakem nebo odvetou za svobodné hlasování"],
  ...
  },
  {
    ...
    options: ["Senátoři jsou starší, takže potřebují víc času", "Senát má být stabilnější a méně ovlivnitelný krátkodobými politickými náladami", "Je to historický omyl", "EU nařídila 6letý mandát"],
  ...
  },
  {
    ...
    options: ["Veškerá moc ve státě patří jen prezidentovi jako hlavě státu", "Vláda rozhoduje úplně o všem bez kontroly parlamentu i soudů", "Moc je rozdělena mezi zákonodárnou (parlament), výkonnou (vláda) a soudní – soudy", "Soud může sám vydávat nové zákony místo parlamentu"],
  ...
  },
  {
    ...
    options: ["Je to jen tradice", "Politici sami chtějí být pravidelně voleni", "EU nařídila pravidelné volby", "Pravidelné volby umožňují lidu zhodnotit politiky a vyměnit je, pokud selhali"],
...
const POOL_L3: PracticeTask[] = [
  {
    ...
    options: ["Dělba moci způsobuje chaos", "Demokracie funguje lépe se silným vůdcem", "Žádná skupina nemá všechnu moc — navzájem se kontrolují a brzdí", "Dělba moci je jen formální — ve skutečnosti vládne president"],
  ...
  },
  {
    ...
    options: ["Obě volby jsou totožné", "Prezidenta volí Senát, poslance prezident", "Prezident není volený", "Poslanci: stranické listiny; prezident: přímá osobní volba občany"],
  ...
  },
  {
    ...
    options: ["Jen prezidentská volba má smysl", "Všechny jsou důležité — volba stran i prezidenta ovlivňuje stát různými způsoby", "Jen volby do Sněmovny jsou důležité", "Volby jsou zbytečné — politici dělají, co chtějí"],
