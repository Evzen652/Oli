...
const POOL_L2: PracticeTask[] = [
  ...
  { question: "Lze sestrojit trojúhelník se stranami 1 cm, 2 cm, 10 cm?", correctAnswer: "Ne", options: ["Ano", "Ne", "Záleží", "Jen velký"], explanation: "Součet dvou kratších stran musí být větší než třetí. Tady 1 + 2 = 3, a to je méně než 10." },
...
const POOL_L3: PracticeTask[] = [
  ...
  { question: "Lze sestrojit trojúhelník se dvěma pravými úhly?", correctAnswer: "Ne", options: ["Ano", "Ne", "Záleží na velikosti", "Jen velký"], explanation: "Dva pravé úhly dají dohromady 180°, takže na třetí úhel už nic nezbývá." },
