...
const POOL_L1: PracticeTask[] = [
  ...
  { question: "Je lidský obličej přesně osově souměrný?", correctAnswer: "Přibližně – v přírodě nejsou dokonalé", options: ["Ano, je to dokonale přesné zrcadlení", "Přibližně – v přírodě nejsou dokonalé", "Ne vůbec, obličej nemá žádnou souměrnost", "Záleží na tom, o kterého člověka jde"] },
  ...
  { question: "Má písmeno H osu souměrnosti?", correctAnswer: "Ano – svislou i vodorovnou — 2 osy", options: ["Ne, písmeno H nemá žádnou osu souměrnosti", "Ano – svislou i vodorovnou — 2 osy", "Jen svislou, vodorovnou nemá", "Jen vodorovnou, svislou nemá"] },
  ...
  { question: "Je zrcadlový obraz souměrný s originálem?", correctAnswer: "Ano, jsou osově souměrné – osou je zrcadlo", options: ["Ne, zrcadlový obraz je úplně jiný tvar", "Ano, jsou osově souměrné – osou je zrcadlo", "Záleží na tom, jak je zrcadlo nakloněné", "Jen přibližně, nikdy ne přesně stejné"] },
  ...
  { question: "Má číslo 8 osu souměrnosti?", correctAnswer: "Ano – svislou i vodorovnou — 2 osy", options: ["Ne, číslo 8 nemá žádnou osu souměrnosti", "Ano – svislou i vodorovnou — 2 osy", "Jen svislou, vodorovnou nemá", "Jen vodorovnou, svislou nemá"] },
...
const POOL_L2: PracticeTask[] = [
  ...
  { question: "Osa souměrnosti je svislá přímka. Bod P [3; 2]. Kde leží P'?", correctAnswer: "P' leží na opačné straně ve stejné vzdálenosti od osy", options: ["P' = [3; −2] (jen otočený znak u druhé souřadnice)", "P' leží na opačné straně ve stejné vzdálenosti od osy", "P' = [−3; −2] (otočené znaménko u obou souřadnic)", "P' = [0; 2] (bod na samotné ose souměrnosti)"] },
  ...
  { question: "Kolik os souměrnosti má pravidelný čtyřúhelník (čtverec)?", correctAnswer: "4 – 2 osy přes strany, 2 přes rohy", options: ["2 – jen úhlopříčky, zapomíná na strany", "4 – 2 osy přes strany, 2 přes rohy", "1 – jen jedna, ne všechny 4 osy", "0 – čtverec žádnou osu souměrnosti nemá"] },
];
...
const POOL_L3: PracticeTask[] = [
  ...
  { question: "Když dva osově souměrné obrazce přiložíme podél osy, co dostaneme?", correctAnswer: "Větší obrazec, který může být souměrný", options: ["Stejný obrazec jako každý z těch dvou", "Větší obrazec, který může být souměrný", "Vždy nesouměrný, nepravidelný tvar", "Vždy přesný kruh nebo elipsu"] },
  { question: "Platí: obrazy dvou různých bodů na ose souměrnosti jsou totožné s originálem?", correctAnswer: "Ano – body na ose se zobrazí samy na sebe", options: ["Ne, obraz bodu na ose je vždy jinde", "Ano – body na ose se zobrazí samy na sebe", "Záleží na tom, kde přesně osa leží", "Záleží na tom, jak daleko body jsou"] },
];
