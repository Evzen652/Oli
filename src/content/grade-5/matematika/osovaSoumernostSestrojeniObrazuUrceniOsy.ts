...
//
// Počty os základních útvarů (čtverec, obdélník, kruh, oba trojúhelníky) dřív
// stály v L1 jako pevné otázky. Patří ale mezi aplikaci pravidla, ne mezi jeho
// rozpoznání, takže jsou teď v bance L2 vedle ostatních obrazců.
...
const L1: PracticeTask[] = [
  ...
  choice("Který z nabízených tvarů je osově souměrný?", "srdce", [
    ...
    { value: "velké tiskací písmeno Z", why: "Z vypadá stejně až po otočení, ale otočení není překlopení podle osy." },
  ], {
    hints: [
  ...
  choice("Která z těchto věcí kolem nás je osově souměrná?", "sněhová vločka", [
    { value: "pravá rukavice", why: "Palec má rukavice jen na jedné straně, takže se po přeložení nekryje." },
  ...
  choice("Kolik os souměrnosti může mít obrazec?", "žádnou, jednu i několik", [
    { value: "vždycky právě jednu", why: "Čtverec se dá přeložit čtyřmi způsoby, písmeno Z ani jedním — počet os se obrazec od obrazce liší." },
    { value: "vždycky aspoň jednu", why: "Spousta obrazců nemá osu žádnou, třeba kosodélník nebo různostranný trojúhelník." },
    { value: "nanejvýš dvě", why: "Rovnostranný trojúhelník má tři osy a čtverec čtyři, takže strop u dvou neplatí." },
  ], {
    hints: [
      "Projdi si v duchu pár obrazců: kruh, čtverec, obyčejnou klikatou čáru. Vyjde ti u všech stejný počet přeložení?",
      "Počet os není u všech obrazců stejný, protože závisí na tom, kolik různých přeložení obrazec složí přesně na sebe. U některých tvarů nevyjde ani jedno, u pravidelných jich bývá tolik, kolik mají stran, a u kruhu je jich dokonce bezpočet.",
    ],
    explanation: "Počet os souměrnosti je vlastnost konkrétního obrazce, ne pevné číslo — proto se u každého tvaru zjišťuje znovu.",
  }),
  choice("Kudy vede od bodu k jeho obrazu spojnice v osové souměrnosti?", "kolmo k ose", [
    { value: "rovnoběžně s osou", why: "Rovnoběžka osu nikdy neprotne, takže by se bod na druhou stranu vůbec nedostal." },
    { value: "šikmo, u každého bodu jinak", why: "Kdyby spojnice mířila šikmo, po přeložení by bod na svůj obraz nedosedl." },
    { value: "po ose samotné", why: "Po ose leží jen ty body, které se překlopením nehýbou." },
  ], {
    hints: [
      "Přilož si na osu zrcátko a dívej se, kterým směrem od skla odraz odskočí.",
      "Při překlopení papíru cestuje každý bod tou nejkratší možnou cestou na druhou stranu ohybu. Zkus si to na čtverečkovaném papíře: nakresli osu, vyber bod a hledej, jaký směr spojnice zaručí, že bod po přeložení dosedne přesně na svůj obraz. Šikmé ani rovnoběžné vedení tímhle testem neprojde.",
    ],
    explanation: "Bod a jeho obraz leží na společné kolmici k ose a osa tuhle spojnici půlí.",
  }),
  choice("Papírový obrázek přeložíme přesně podle jeho osy souměrnosti. Co uvidíme?", "jen jednu polovinu, druhá je schovaná přesně pod ní", [
    { value: "obě poloviny vedle sebe", why: "Vedle sebe zůstanou poloviny jen tehdy, když se papír nepřeloží." },
    { value: "polovinu a kousek té druhé, který přečnívá", why: "Přečnívat by musela u nesouměrného obrázku. Podle osy souměrnosti se poloviny kryjí beze zbytku." },
    { value: "úplně jiný obrázek, než byl původně", why: "Nový tvar nevzniká — přeložením se jen jedna polovina schová za druhou." },
  ], {
    hints: [
      "Zkus si přeložit papír, na kterém je namalované srdce, přesně uprostřed. Co z něj po ohnutí zůstane vidět?",
      "Přeložení podle osy souměrnosti položí obě části obrázku přesně na sebe. Mají stejný tvar i stejnou velikost, takže ta vrchní tu spodní úplně zakryje a nic z ní nevykoukne ani po jedné straně. Podívej se proto, kolik toho na papíře po ohnutí vlastně zbude vidět.",
    ],
    explanation: "Osa je přesně ta čára, podle které se poloviny obrázku kryjí beze zbytku.",
  }),
  choice("K čemu se osová souměrnost hodí při vystřihování papírových ozdob?", "papír se přeloží a vystřihne se jen půlka vzoru", [
    { value: "papír se musí předem rozstříhat na proužky", why: "Rozstříhaný papír už se nedá přeložit tak, aby vznikl souměrný vzor." },
    { value: "vzor se musí nakreslit dvakrát, zvlášť na každou polovinu", why: "Právě tohle přeložení ušetří: druhá polovina vznikne sama." },
    { value: "ozdoba musí být kulatá, jinak to nefunguje", why: "Přeložit a vystřihnout se dá vzor jakéhokoli tvaru, nejen kulatý." },
  ], {
    hints: [
      "Vzpomeň si, jak se vystřihují papírové vločky nebo srdíčka. Kreslí se na celý list, nebo jen na jeho část?",
      "Když je papír přeložený, nůžky projdou oběma vrstvami naráz a vystřihnou dva stejné tvary současně. Práce se tím zkrátí na polovinu a obě půlky vyjdou zaručeně shodné — přesně to dělá osová souměrnost.",
    ],
    explanation: "Přeložený papír vyrobí druhou polovinu vzoru sám, protože nůžky stříhají obě vrstvy naráz.",
  }),
];
...
function pismeno(): PracticeTask | null {
  ...
  // Sponu je nutné ohnout podle počtu: „písmeno S má žádnou osu" je nevěta.
  const ma = n === 0 ? "nemá" : "má";
  // Možnost „4" nesmí tvrdit, že některé přeložení selhalo: u H, I, O a X
  // vyjdou obě, a věta by si odporovala s „má svislou i vodorovnou osu".
  const chyby = ["0", "1", "2", "4"].filter((v) => v !== String(n)).map((v) => ({
    value: v,
    why: Number(v) > n
      ? Number(v) > 2
        ? `Víc os tiskací písmeno mít nemůže: přeložení jsou jen dvě, svislé a vodorovné. Písmeno ${p} ${ma} ${popis}.`
        : `Tolik os písmeno ${p} nemá: ${n === 0 ? "ani po svislém, ani po vodorovném přeložení se jeho půlky nekryjí" : "u některého z obou přeložení se půlky rozejdou"}. Ve skutečnosti ${ma} ${popis}.`
      : `Některé přeložení zůstalo nevyzkoušené: písmeno ${p} ${ma} ${popis}.`,
  }));
...
const OBRAZCE: [string, string, [string, string][], string][] = [
  // Základní útvary RVP (čtverec, obdélník, kruh, trojúhelníky) patří sem, ne
  // do L1: počet os se u nich nepamatuje, ale odvozuje zkoušením přeložení.
  ["čtverec", "4", [
    ["2", "Dvě osy vedou středy protějších stran, další dvě ale leží v úhlopříčkách."],
    ["1", "Čtvercový papír se dá přeložit víc způsoby než jedním."],
    ["8", "Každá osa spojuje dva protilehlé body, takže se nepočítá dvakrát."],
  ], "Čtverec má všechny strany stejné i všechny úhly pravé, takže se dá přeložit podle obou čar spojujících středy protějších stran i podle obou úhlopříček."],
  ["obdélník, který není čtverec", "2", [
    ["4", "Úhlopříčky obdélníku osami nejsou: po přeložení podle nich se poloviny minou, protože sousední strany jsou různě dlouhé."],
    ["1", "Obdélník se dá přeložit podél i napříč, tedy dvakrát."],
    ["0", "Obdélník souměrný je, přeložit ho lze středy protějších stran."],
  ], "Obdélník má protější strany stejné, sousední různé. Přeložit ho proto jde jen podle dvou čar spojujících středy protějších stran; úhlopříčky mu osami nejsou."],
  ["kruh", "nekonečně mnoho os", [
    ["jen jednu osu", "Kruh se dá přeložit podle kteréhokoli průměru a průměrů je bezpočet."],
    ["dvě osy", "Průměrů, podle kterých se kruh složí na sebe, je mnohem víc než dva."],
    ["čtyři osy", "Čtyři osy má čtverec. U kruhu je každý směr stejný, takže se osy nedají spočítat."],
  ], "Kruh vypadá ze středu ve všech směrech stejně, takže každá přímka procházející jeho středem ho rozdělí na dvě shodné poloviny."],
  ["rovnostranný trojúhelník", "3", [
    ["1", "Jedna osa vede každým z vrcholů a vrcholy jsou tři."],
    ["2", "Dvě osy by jeden vrchol vynechaly. Rovnostranný trojúhelník má všechny strany stejné, takže osa vede každým ze tří vrcholů."],
    ["6", "Každá osa vede vrcholem a zároveň středem protější strany, takže se nepočítá dvakrát."],
  ], "Rovnostranný trojúhelník má všechny strany stejně dlouhé, takže se dá přeložit podle čáry vedoucí kterýmkoli vrcholem a středem protější strany."],
  ["rovnoramenný trojúhelník, který není rovnostranný", "1", [
    ["3", "Tři osy má jen rovnostranný trojúhelník, tedy ten se všemi stranami stejnými."],
    ["2", "Druhá osa by potřebovala další dvojici stejně dlouhých stran, tu ale rovnoramenný trojúhelník nemá."],
    ["0", "Rovnoramenný trojúhelník souměrný je, ramena má stejně dlouhá."],
  ], "Rovnoramenný trojúhelník má dvě stejně dlouhá ramena a základnu jinou. Osa proto vede jen vrcholem mezi rameny a středem základny."],
...
function obrazec(): PracticeTask | null {
  ...
  return overeno(ciselnaUloha(
    ...
    [
      `Nakresli si, jak vypadá ${nazev}, a hledej všechny čáry, podle kterých ho lze přeložit tak, aby se poloviny přesně kryly. Zkoušej přitom čáry vedené svisle, vodorovně i šikmo.`,
      `${pravidlo} Postupuj proto systematicky a ber jednu čáru po druhé: u každé se zeptej, jestli se po přeložení podle ní obě poloviny opravdu kryjí. Čára, která obrazec jen rozdělí na dva stejně velké kusy, osou ještě není.`,
    ],
...
function osaMezi(): PracticeTask | null {
  ...
  return overeno(ciselnaUloha(
    ...
    [
      ...
      { value: String(m + 1), why: `O sloupec vedle: od sloupce ${p} by k ose ${wasCount(d + 1, "SLOUPEC")}, ale od ní k obrazu ve sloupci ${q} už jen ${pad(d - 1, "SLOUPEC")}. Osa musí mít na obě strany stejně.` },
    ...
    [
      ...
      `Bod a jeho obraz leží od osy ve stejné vzdálenosti, takže osa rozdělí úsek mezi nimi přesně napůl. Spočítej proto, o kolik sloupců se čísla ${p} a ${q} liší, rozdíl rozpul a tuhle polovinu přičti k menšímu z obou čísel. Hledá se číslo sloupce, ne vzdálenost — samotná polovina proto odpovědí ještě není.`,
    ],
    [
...
function zOdstupu(): PracticeTask | null {
  ...
  return overeno(ciselnaUloha(
    ...
    [
      ...
      { value: 4 * a, why: "Vzdálenost se zdvojnásobila, místo aby se rozpůlila. Od bodu C k ose je to kratší cesta než od bodu C k jeho obrazu, ne delší." },
    ...
    [
      ...
      `Bod a jeho obraz mají od osy stejnou vzdálenost, proto osa dělí úsek mezi nimi přesně napůl. Z celé vzdálenosti ${pad(2 * a, "ČTVEREČEK")} tedy hledáš polovinu — a tu najdeš dělením dvěma. Zdvojnásobení by vedlo opačným směrem: to je cesta od vzdálenosti bodu k celému úseku, ne zpátky.`,
    ],
    [
...
function gen(level: number): PracticeTask[] {
  ...
  if (level === 2) return sada(30, (i) => (i % 2 ? obrazec() : pismeno()));
