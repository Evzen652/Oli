...
export function AssignmentList({ childId = "", refreshKey, mockAssignments, onMockDelete, highlightSkillId }: Props) {
  ...
  const fetchAssignments = async (cancelled: { v: boolean }) => {
...
function AssignmentCard({
  ...
  return (
    <div className={`rounded-2xl border ${cardClasses} p-3 flex items-center gap-3.5 shadow-soft-1 transition-all duration-500`}>
