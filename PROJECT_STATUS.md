...
- ⏭️ **Další ve Fázi 1:** (1) doplnit adversariální judge na téma 3 (prameny); (2) z pilotu (fyzika 6/6 + dějepis select_one/drag_order/categorize) odvodit `TEMPLATE_STUPEN2.ts`; (3) navigace+displayNames grade-6 (fyzika+dějepis).
