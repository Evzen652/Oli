...
- ⏭️ **Zbývá ve Fázi 0:** ilustrace 6 předmětů (vyžaduje admin pipeline + běžící app) · per-grade slovník 12–15 let · ověření `optionFeedback` s reálným obsahem pilotu (až bude grade-6 obsah).
