...
- ⏭️ **Další ve Fázi 1:** **hustota** (ρ=m/V — vrchol, staví na hmotnosti+objemu, + `formula_builder`), pak teplota/čas, pak Dějepis g6 (faktický vzor). Z pilotu odvodit `TEMPLATE_STUPEN2.ts`.
