...
- ⏭️ **Zbývá ve Fázi 0:** ilustrace 6 předmětů · vizuální smoke test (UI↔validátor v prohlížeči, vč. ověření `optionFeedback` s reálným obsahem pilotu) · per-grade slovník.
