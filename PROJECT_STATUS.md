...
- ⏭️ **ZBÝVÁ (systemove-dluhy-zadani.md, obrovský rozsah — desítky dalších souborů)**: Balík 1B (čtení s porozuměním, rozšířit na 6-8 textů), 1C (geometrie/tabulky — parametrizovat), 2A (doplnit L3 u ~40 topics: čeština-čtení, celý g2-prv-* cluster, g3-prvouka-*, přírodověda/vlastivěda 4.-5. tř. dějiny), 1D/1E (doladění nízké priority). Doporučené pořadí zachováno v TaskList (tasky #43-49).
