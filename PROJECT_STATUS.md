...
- ⏭️ **Další ve Fázi 1:** Dějepis g6 — **categorize** (historické prameny: hmotné/písemné/obrazové = práce se zdrojem), čímž se ověří i poslední klíčový faktický typ. Pak z pilotu (fyzika 6/6 + dějepis select_one/drag_order/categorize) odvodit `TEMPLATE_STUPEN2.ts`.
