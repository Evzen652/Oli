...
- ⏭️ **Zbývá dle handoffu:** další geometrie/přír/vlast s L3=0 (dle audit worklistu), PED-4 (víc formátů: text_input, fill_blank u pravopisu/tvarosloví), invariant `prefix_words_are_valid`.
