...
- ⏭️ **Další ve Fázi 1:** Dějepis g6 pokračování — **drag_order** (chronologie epoch pravěku) + **categorize** (historické prameny: hmotné/písemné/obrazové), čímž se ověří i ty typy dle plánu. Pak z pilotu (fyzika 6/6 + dějepis více typů) odvodit `TEMPLATE_STUPEN2.ts`.
