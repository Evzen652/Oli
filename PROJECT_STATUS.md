...
- 📋 **Plán „spustitelná s ročníky 2–4"** dohodnut. Další v pořadí: Fáze 0.3 rozšířit audit o prvouku g2/g3 + g4 přír/vlast → worklist Fáze 1 (zbytek 2A stejným balíkovým modelem). Blockery: 🔴 SMTP schránka noreply@ (akce Evžen) → zapojit Supabase; 🔴 child re-login PIN; 🟠 deploy anon-progress (akce Evžen: supabase login); 🟠 boundary rules migrace na grade-N ID; 🟠 rotace Groq klíče (akce Evžen); 🟡 messaging „Odemkni registrací". Pak ilustrace chybějících témat, zelené testy, E2E přes ročníky 2/3/4.
