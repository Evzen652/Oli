...
| dávky | stav | kde |
|---|---|---|
| `g2mat-a…d`, `g2cjl-a…d`, `g3mat-a…c` (11) | ✅ autor i kritik, **SLOUČENO do `main`** | v produkci |
| `g2prv-a`, `g2prv-b`, `g3prv-a`, `g3prv-b`, `g3prv-c`, `g3cjl-a`, `g3cjl-b`, `g3cjl-c` (8) | 🟠 autor hotov, **kritik chybí** | `origin/content-fix/*` |
