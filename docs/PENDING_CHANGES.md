...
- [ ] **Vizuální smoke test odborných typů** — UI↔validátor v prohlížeči (ANSWER z ChemicalBalanceInput/TimelineInput/FormulaBuilderInput sedí na validátor?). **Spike chemie** tady — než grade-8.
