...
- 📊 **Postup:** `hint_leak` 804 → **203** (−75 %), témat 91 → **69** (číslo kolísá run-to-run kvůli shuffle v pool generátorech — každé opravené téma ověřeno izolovaně na 0). Zbývá manuální práce téma po tématu dle žebříčku v `PROJECT_STATUS.md` §6.
