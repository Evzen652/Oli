...
- 📊 **Postup:** `hint_leak` 804 → **186** (−77 %), témat 91 → **67** (číslo kolísá run-to-run kvůli shuffle v pool generátorech — každé opravené téma ověřeno izolovaně na 0). Zbývá manuální práce téma po tématu dle žebříčku v `PROJECT_STATUS.md` §6.
