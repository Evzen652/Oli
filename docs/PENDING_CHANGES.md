...
- [ ] Dějepis g6 — **categorize** (historické prameny hmotné/písemné/obrazové = práce se zdrojem) → poslední klíčový faktický typ.
...
- ⚠️ Grade 6 je „má obsah" → odemčen v onboardingu (6 fyzikálních + 2 dějepisná témata).
